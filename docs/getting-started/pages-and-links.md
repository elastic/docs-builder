...
See [navigation configuration](../documentation/configure/content-set/navigation.md) for the complete reference.
...
This tells {{dbuild}} to fetch the [link index](../architecture/link-index.md) for each listed repository so it can validate your cross-links at build time — even during local development.
