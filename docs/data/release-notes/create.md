...
Refer to [](/data/release-notes/configure.md).
...
For more information about these changelog configuration settings, refer to [](/data/release-notes/configure-ref.md#rules-create).
