...
1. Review the settings and update them based on your preferences.
   For descriptions of all the settings, refer to [](/data/release-notes/configure-ref.md).
   For example:
     - To limit the acceptable values, update [lifecycles](/data/release-notes/configure-ref.md#lifecycles) and [products](/data/release-notes/configure-ref.md#products).
...
1. Start [creating changelog files](/data/release-notes/create.md).
1. You might need to make further changes to your configuration file after you've performed a few tests. Likewise you might need to add bundle settings or profiles when you're ready to [create release bundles](/data/release-notes/bundle.md).
