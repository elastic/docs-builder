...
manifests (`bundle/{product}/registry.json`, `changelog/{org}/{repo}/{branch}/registry.json`)
are produced exclusively by the scrubber Lambda, reconciled from public bucket state on the S3
events each upload emits. See
