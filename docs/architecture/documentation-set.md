...
The `docset.yml` file controls how the documentation set is structured and built. See [Content Set Configuration](../documentation/configure/content-set/index.md) for complete configuration details.
