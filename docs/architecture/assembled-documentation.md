...
2. Reads the [configuration files](../documentation/configure/site/index.md) and builds [a global navigation](../documentation/configure/site/navigation.md).
...
* [assembler.yml](../documentation/configure/site/index.md): Which repositories to include and [their branching strategy](../documentation/how-to/branching-strategy.md).
* [navigation.yml](../documentation/configure/site/index.md): Navigation and url prefixes for TOC's.
* [versions.yml](../documentation/configure/site/versions.md): Defines the various versioning schemes of products/solutions being documented.
* [products.yml](../documentation/configure/site/products.md): Defines the product catalog (id, name) and ties it to a specific versioning scheme.

Refer to [Site Configuration](../documentation/configure/site/index.md) for details on configuring assembled documentation.
