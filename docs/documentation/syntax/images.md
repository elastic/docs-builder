...
If a page uses an image that exists outside the folder that contains the `toc.yml` file or `docset.yml` file that contains that page, the image will fail to render and will generate warnings. Likewise, if a snippet in a [file inclusion](/documentation/syntax/file_inclusion.md) includes an image and is used in pages that exist in different `toc.yml`, the images will break.
:::

## Block-level images

```markdown
![APM](/documentation/syntax/images/apm.png)
```
...
```markdown
:::{image} /documentation/syntax/images/observability.png
:alt: Elasticsearch
:width: 250px
:::
```
...
```markdown
:::{image} /documentation/syntax/images/apm.png
:alt: APM Logo
:width: 400px
:::
```
...
```markdown
Here is the same image used inline ![Elasticsearch](/documentation/syntax/images/observability.png "elasticsearch =50%x50%")
```
...
```markdown
![Elasticsearch](/documentation/syntax/images/observability.png)
```
...
```markdown
![Elasticsearch](/documentation/syntax/images/observability.png "Different title")
```

![Elasticsearch](/documentation/syntax/images/observability.png "Different title =50%x50%")
...
```markdown
![Elasticsearch](/documentation/syntax/images/alerts.svg)
```
...
```markdown
![Elasticsearch](/documentation/syntax/images/timeslider.gif)
```
