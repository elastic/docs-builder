...
Links are validated against the [link index](../architecture/link-index.md), ensuring references between repositories stay correct even though each repo builds independently.
