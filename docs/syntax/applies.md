...
Starting with Elastic Stack 9.0, ECE 4.0, and ECK 3.0, documentation follows a [cumulative approach](https://www.elastic.co/docs/contribute-docs/contribute/how-to/cumulative-docs): instead of creating separate pages for each product and release, we update a single page with product- and version-specific details over time.
...
:::{note}
For detailed guidance, refer to [Write cumulative documentation](https://www.elastic.co/docs/contribute-docs/contribute/how-to/cumulative-docs).
:::
