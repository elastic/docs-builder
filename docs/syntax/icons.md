...
| `` {icon}`ai` ``                                |                 {icon}`ai`                |
| `` {icon}`align_bottom` ``                      |            {icon}`align_bottom`           |
| `` {icon}`align_bottom_left` ``                 |         {icon}`align_bottom_left`         |
| `` {icon}`align_bottom_right` ``                |         {icon}`align_bottom_right`        |
| `` {icon}`align_center_horizontal` ``           |      {icon}`align_center_horizontal`      |
| `` {icon}`align_center_vertical` ``             |       {icon}`align_center_vertical`       |
| `` {icon}`align_left` ``                        |             {icon}`align_left`            |
| `` {icon}`align_right` ``                       |            {icon}`align_right`            |
| `` {icon}`align_top` ``                         |             {icon}`align_top`             |
| `` {icon}`align_top_left` ``                    |           {icon}`align_top_left`          |
| `` {icon}`align_top_right` ``                   |          {icon}`align_top_right`          |
| `` {icon}`analyze_event` ``                     |           {icon}`analyze_event`           |
...
| `` {icon}`at` ``                                |                 {icon}`at`                |
| `` {icon}`axis_x` ``                            |               {icon}`axis_x`              |
| `` {icon}`axis_y_left` ``                       |            {icon}`axis_y_left`            |
| `` {icon}`axis_y_right` ``                      |            {icon}`axis_y_right`           |
| `` {icon}`background_task` ``                   |          {icon}`background_task`          |
| `` {icon}`bell` ``                              |                {icon}`bell`               |
| `` {icon}`bell_slash` ``                        |             {icon}`bell_slash`            |
| `` {icon}`beta` ``                              |                {icon}`beta`               |
| `` {icon}`bolt` ``                              |                {icon}`bolt`               |
| `` {icon}`boxes_horizontal` ``                  |          {icon}`boxes_horizontal`         |
| `` {icon}`boxes_vertical` ``                    |           {icon}`boxes_vertical`          |
| `` {icon}`branch` ``                            |               {icon}`branch`              |
| `` {icon}`branch_user` ``                       |            {icon}`branch_user`            |
...
| `` {icon}`chart_anomaly` ``                     |           {icon}`chart_anomaly`           |
| `` {icon}`chart_area` ``                        |             {icon}`chart_area`            |
| `` {icon}`chart_area_stack` ``                  |          {icon}`chart_area_stack`         |
| `` {icon}`chart_bar_horizontal` ``              |        {icon}`chart_bar_horizontal`       |
| `` {icon}`chart_bar_horizontal_stack` ``        |     {icon}`chart_bar_horizontal_stack`    |
| `` {icon}`chart_bar_vertical` ``                |         {icon}`chart_bar_vertical`        |
| `` {icon}`chart_bar_vertical_stack` ``          |      {icon}`chart_bar_vertical_stack`     |
| `` {icon}`chart_change_point` ``                |         {icon}`chart_change_point`        |
| `` {icon}`chart_gauge` ``                       |            {icon}`chart_gauge`            |
| `` {icon}`chart_heatmap` ``                     |           {icon}`chart_heatmap`           |
| `` {icon}`chart_line` ``                        |             {icon}`chart_line`            |
| `` {icon}`chart_metric` ``                      |            {icon}`chart_metric`           |
| `` {icon}`chart_pie` ``                         |             {icon}`chart_pie`             |
| `` {icon}`chart_tag_cloud` ``                   |          {icon}`chart_tag_cloud`          |
| `` {icon}`chart_threshold` ``                   |          {icon}`chart_threshold`          |
| `` {icon}`chart_waterfall` ``                   |          {icon}`chart_waterfall`          |
| `` {icon}`check` ``                             |               {icon}`check`               |
| `` {icon}`check_circle` ``                      |            {icon}`check_circle`           |
| `` {icon}`check_circle_fill` ``                 |         {icon}`check_circle_fill`         |
| `` {icon}`cheer` ``                             |               {icon}`cheer`               |
| `` {icon}`chevron_double_left` ``               |        {icon}`chevron_double_left`        |
| `` {icon}`chevron_double_right` ``              |        {icon}`chevron_double_right`       |
| `` {icon}`chevron_limit_left` ``                |         {icon}`chevron_limit_left`        |
| `` {icon}`chevron_limit_right` ``               |        {icon}`chevron_limit_right`        |
| `` {icon}`chevron_single_down` ``               |        {icon}`chevron_single_down`        |
| `` {icon}`chevron_single_left` ``               |        {icon}`chevron_single_left`        |
| `` {icon}`chevron_single_right` ``              |        {icon}`chevron_single_right`       |
| `` {icon}`chevron_single_up` ``                 |         {icon}`chevron_single_up`         |
| `` {icon}`click_left` ``                        |             {icon}`click_left`            |
| `` {icon}`click_right` ``                       |            {icon}`click_right`            |
| `` {icon}`clock` ``                             |               {icon}`clock`               |
| `` {icon}`clock_control` ``                     |           {icon}`clock_control`           |
| `` {icon}`clock_counter` ``                     |           {icon}`clock_counter`           |
| `` {icon}`cloud` ``                             |               {icon}`cloud`               |
| `` {icon}`cloud_drizzle` ``                     |           {icon}`cloud_drizzle`           |
| `` {icon}`cloud_stormy` ``                      |            {icon}`cloud_stormy`           |
| `` {icon}`cloud_sunny` ``                       |            {icon}`cloud_sunny`            |
| `` {icon}`cluster` ``                           |              {icon}`cluster`              |
| `` {icon}`code` ``                              |                {icon}`code`               |
| `` {icon}`color` ``                             |               {icon}`color`               |
| `` {icon}`command_line` ``                      |            {icon}`command_line`           |
| `` {icon}`comment` ``                           |              {icon}`comment`              |
| `` {icon}`compare` ``                           |              {icon}`compare`              |
| `` {icon}`compute` ``                           |              {icon}`compute`              |
| `` {icon}`console` ``                           |              {icon}`console`              |
| `` {icon}`container` ``                         |             {icon}`container`             |
| `` {icon}`continuity_above` ``                  |          {icon}`continuity_above`         |
| `` {icon}`continuity_above_below` ``            |       {icon}`continuity_above_below`      |
| `` {icon}`continuity_below` ``                  |          {icon}`continuity_below`         |
| `` {icon}`continuity_within` ``                 |         {icon}`continuity_within`         |
| `` {icon}`contrast` ``                          |              {icon}`contrast`             |
| `` {icon}`contrast_fill` ``                     |           {icon}`contrast_fill`           |
| `` {icon}`controls` ``                          |              {icon}`controls`             |
| `` {icon}`copy` ``                              |                {icon}`copy`               |
| `` {icon}`copy_clipboard` ``                    |           {icon}`copy_clipboard`          |
| `` {icon}`cross` ``                             |               {icon}`cross`               |
| `` {icon}`cross_circle` ``                      |            {icon}`cross_circle`           |
...
| `` {icon}`cut` ``                               |                {icon}`cut`                |
| `` {icon}`dashed_circle` ``                     |           {icon}`dashed_circle`           |
| `` {icon}`database` ``                          |              {icon}`database`             |
| `` {icon}`desktop` ``                           |              {icon}`desktop`              |
| `` {icon}`diff` ``                              |                {icon}`diff`               |
| `` {icon}`display` ``                           |              {icon}`display`              |
| `` {icon}`distribute_horizontal` ``             |       {icon}`distribute_horizontal`       |
| `` {icon}`distribute_vertical` ``               |        {icon}`distribute_vertical`        |
| `` {icon}`document` ``                          |              {icon}`document`             |
| `` {icon}`document_edit` ``                     |           {icon}`document_edit`           |
| `` {icon}`documentation` ``                     |           {icon}`documentation`           |
| `` {icon}`documents` ``                         |             {icon}`documents`             |
| `` {icon}`dot` ``                               |                {icon}`dot`                |
| `` {icon}`dot_in_circle` ``                     |           {icon}`dot_in_circle`           |
| `` {icon}`download` ``                          |              {icon}`download`             |
| `` {icon}`drag` ``                              |                {icon}`drag`               |
| `` {icon}`drag_horizontal` ``                   |          {icon}`drag_horizontal`          |
| `` {icon}`drag_vertical` ``                     |           {icon}`drag_vertical`           |
...
| `` {icon}`editor_distribute_horizontal` ``      |    {icon}`editor_distribute_horizontal`   |
| `` {icon}`editor_distribute_vertical` ``        |     {icon}`editor_distribute_vertical`    |
| `` {icon}`editor_heading` ``                    |           {icon}`editor_heading`          |
| `` {icon}`editor_italic` ``                     |           {icon}`editor_italic`           |
| `` {icon}`editor_item_align_bottom` ``          |      {icon}`editor_item_align_bottom`     |
| `` {icon}`editor_item_align_center` ``          |      {icon}`editor_item_align_center`     |
| `` {icon}`editor_item_align_left` ``            |       {icon}`editor_item_align_left`      |
| `` {icon}`editor_item_align_middle` ``          |      {icon}`editor_item_align_middle`     |
| `` {icon}`editor_item_align_right` ``           |      {icon}`editor_item_align_right`      |
| `` {icon}`editor_item_align_top` ``             |       {icon}`editor_item_align_top`       |
| `` {icon}`editor_link` ``                       |            {icon}`editor_link`            |
| `` {icon}`editor_ordered_list` ``               |        {icon}`editor_ordered_list`        |
| `` {icon}`editor_position_bottom_left` ``       |    {icon}`editor_position_bottom_left`    |
| `` {icon}`editor_position_bottom_right` ``      |    {icon}`editor_position_bottom_right`   |
| `` {icon}`editor_position_top_left` ``          |      {icon}`editor_position_top_left`     |
| `` {icon}`editor_position_top_right` ``         |     {icon}`editor_position_top_right`     |
...
| `` {icon}`error_fill` ``                        |             {icon}`error_fill`            |
| `` {icon}`esql_vis` ``                          |              {icon}`esql_vis`             |
| `` {icon}`exit` ``                              |                {icon}`exit`               |
| `` {icon}`expand` ``                            |               {icon}`expand`              |
| `` {icon}`external` ``                          |              {icon}`external`             |
| `` {icon}`eye` ``                               |                {icon}`eye`                |
| `` {icon}`eye_closed` ``                        |             {icon}`eye_closed`            |
| `` {icon}`eye_slash` ``                         |             {icon}`eye_slash`             |
...
| `` {icon}`filter_exclude` ``                    |           {icon}`filter_exclude`          |
| `` {icon}`filter_ignore` ``                     |           {icon}`filter_ignore`           |
| `` {icon}`filter_in_circle` ``                  |          {icon}`filter_in_circle`         |
| `` {icon}`filter_include` ``                    |           {icon}`filter_include`          |
| `` {icon}`flag` ``                              |                {icon}`flag`               |
| `` {icon}`flask` ``                             |               {icon}`flask`               |
| `` {icon}`fold` ``                              |                {icon}`fold`               |
| `` {icon}`folder_check` ``                      |            {icon}`folder_check`           |
| `` {icon}`folder_close` ``                      |            {icon}`folder_close`           |
| `` {icon}`folder_exclamation` ``                |         {icon}`folder_exclamation`        |
| `` {icon}`folder_open` ``                       |            {icon}`folder_open`            |
| `` {icon}`frame_next` ``                        |             {icon}`frame_next`            |
| `` {icon}`frame_previous` ``                    |           {icon}`frame_previous`          |
| `` {icon}`full_screen` ``                       |            {icon}`full_screen`            |
| `` {icon}`full_screen_exit` ``                  |          {icon}`full_screen_exit`         |
| `` {icon}`function` ``                          |              {icon}`function`             |
| `` {icon}`gear` ``                              |                {icon}`gear`               |
| `` {icon}`globe` ``                             |               {icon}`globe`               |
| `` {icon}`grab` ``                              |                {icon}`grab`               |
| `` {icon}`grab_horizontal` ``                   |          {icon}`grab_horizontal`          |
| `` {icon}`grab_omnidirectional` ``              |        {icon}`grab_omnidirectional`       |
...
| `` {icon}`info` ``                              |                {icon}`info`               |
| `` {icon}`input_output` ``                      |            {icon}`input_output`           |
...
| `` {icon}`kubernetes_node` ``                   |          {icon}`kubernetes_node`          |
| `` {icon}`kubernetes_pod` ``                    |           {icon}`kubernetes_pod`          |
| `` {icon}`launch` ``                            |               {icon}`launch`              |
| `` {icon}`layers` ``                            |               {icon}`layers`              |
| `` {icon}`lettering` ``                         |             {icon}`lettering`             |
| `` {icon}`line_break` ``                        |             {icon}`line_break`            |
| `` {icon}`line_break_slash` ``                  |          {icon}`line_break_slash`         |
| `` {icon}`line_dash` ``                         |             {icon}`line_dash`             |
| `` {icon}`line_dot` ``                          |              {icon}`line_dot`             |
| `` {icon}`line_solid` ``                        |             {icon}`line_solid`            |
| `` {icon}`link` ``                              |                {icon}`link`               |
| `` {icon}`link_slash` ``                        |             {icon}`link_slash`            |
| `` {icon}`list` ``                              |                {icon}`list`               |
| `` {icon}`list_add` ``                          |              {icon}`list_add`             |
| `` {icon}`list_bullet` ``                       |            {icon}`list_bullet`            |
| `` {icon}`list_check` ``                        |             {icon}`list_check`            |
| `` {icon}`list_number` ``                       |            {icon}`list_number`            |
| `` {icon}`lock` ``                              |                {icon}`lock`               |
| `` {icon}`lock_open` ``                         |             {icon}`lock_open`             |
| `` {icon}`log_out` ``                           |              {icon}`log_out`              |
...
| `` {icon}`menu` ``                              |                {icon}`menu`               |
| `` {icon}`menu_down` ``                         |             {icon}`menu_down`             |
| `` {icon}`menu_left` ``                         |             {icon}`menu_left`             |
| `` {icon}`menu_right` ``                        |             {icon}`menu_right`            |
| `` {icon}`menu_up` ``                           |              {icon}`menu_up`              |
| `` {icon}`merge` ``                             |               {icon}`merge`               |
| `` {icon}`minimize` ``                          |              {icon}`minimize`             |
| `` {icon}`minus` ``                             |               {icon}`minus`               |
| `` {icon}`minus_circle` ``                      |            {icon}`minus_circle`           |
| `` {icon}`minus_square` ``                      |            {icon}`minus_square`           |
...
| `` {icon}`page_select` ``                       |            {icon}`page_select`            |
| `` {icon}`pages_select` ``                      |            {icon}`pages_select`           |
| `` {icon}`paint` ``                             |               {icon}`paint`               |
| `` {icon}`paint_bucket` ``                      |            {icon}`paint_bucket`           |
...
| `` {icon}`pin` ``                               |                {icon}`pin`                |
| `` {icon}`pin_fill` ``                          |              {icon}`pin_fill`             |
| `` {icon}`pivot` ``                             |               {icon}`pivot`               |
| `` {icon}`play` ``                              |                {icon}`play`               |
| `` {icon}`play_filled` ``                       |            {icon}`play_filled`            |
| `` {icon}`plugs` ``                             |               {icon}`plugs`               |
| `` {icon}`plus` ``                              |                {icon}`plus`               |
| `` {icon}`plus_circle` ``                       |            {icon}`plus_circle`            |
| `` {icon}`plus_in_circle_filled` ``             |       {icon}`plus_in_circle_filled`       |
| `` {icon}`plus_square` ``                       |            {icon}`plus_square`            |
| `` {icon}`popout` ``                            |               {icon}`popout`              |
| `` {icon}`popper` ``                            |               {icon}`popper`              |
| `` {icon}`presentation` ``                      |            {icon}`presentation`           |
| `` {icon}`processor` ``                         |             {icon}`processor`             |
| `` {icon}`product_agent` ``                     |           {icon}`product_agent`           |
| `` {icon}`product_cloud_infra` ``               |        {icon}`product_cloud_infra`        |
| `` {icon}`product_dashboard` ``                 |         {icon}`product_dashboard`         |
| `` {icon}`product_discover` ``                  |          {icon}`product_discover`         |
| `` {icon}`product_ml` ``                        |             {icon}`product_ml`            |
| `` {icon}`product_streams_classic` ``           |      {icon}`product_streams_classic`      |
| `` {icon}`product_streams_wired` ``             |       {icon}`product_streams_wired`       |
| `` {icon}`push` ``                              |                {icon}`push`               |
| `` {icon}`query` ``                             |               {icon}`query`               |
| `` {icon}`query_field` ``                       |            {icon}`query_field`            |
| `` {icon}`query_operand` ``                     |           {icon}`query_operand`           |
| `` {icon}`query_selector` ``                    |           {icon}`query_selector`          |
| `` {icon}`query_value` ``                       |            {icon}`query_value`            |
| `` {icon}`question` ``                          |              {icon}`question`             |
| `` {icon}`queue` ``                             |               {icon}`queue`               |
| `` {icon}`quote` ``                             |               {icon}`quote`               |
| `` {icon}`radar` ``                             |               {icon}`radar`               |
| `` {icon}`read_only` ``                         |             {icon}`read_only`             |
| `` {icon}`redo` ``                              |                {icon}`redo`               |
| `` {icon}`refresh` ``                           |              {icon}`refresh`              |
| `` {icon}`refresh_time` ``                      |            {icon}`refresh_time`           |
...
| `` {icon}`security_signal` ``                   |          {icon}`security_signal`          |
| `` {icon}`security_signal_detected` ``          |      {icon}`security_signal_detected`     |
| `` {icon}`security_signal_resolved` ``          |      {icon}`security_signal_resolved`     |
| `` {icon}`send` ``                              |                {icon}`send`               |
| `` {icon}`server` ``                            |               {icon}`server`              |
| `` {icon}`session_viewer` ``                    |           {icon}`session_viewer`          |
| `` {icon}`shard` ``                             |               {icon}`shard`               |
| `` {icon}`share` ``                             |               {icon}`share`               |
| `` {icon}`significant_events` ``                |         {icon}`significant_events`        |
| `` {icon}`single_metric_viewer` ``              |        {icon}`single_metric_viewer`       |
| `` {icon}`snowflake` ``                         |             {icon}`snowflake`             |
| `` {icon}`sort_ascending` ``                    |           {icon}`sort_ascending`          |
| `` {icon}`sort_descending` ``                   |          {icon}`sort_descending`          |
| `` {icon}`sort_down` ``                         |             {icon}`sort_down`             |
| `` {icon}`sort_left` ``                         |             {icon}`sort_left`             |
| `` {icon}`sort_right` ``                        |             {icon}`sort_right`            |
...
| `` {icon}`star_fill` ``                         |             {icon}`star_fill`             |
| `` {icon}`star_fill_space` ``                   |          {icon}`star_fill_space`          |
| `` {icon}`star_minus_empty` ``                  |          {icon}`star_minus_empty`         |
| `` {icon}`star_minus_fill` ``                   |          {icon}`star_minus_fill`          |
| `` {icon}`star_plus_empty` ``                   |          {icon}`star_plus_empty`          |
| `` {icon}`star_plus_fill` ``                    |           {icon}`star_plus_fill`          |
| `` {icon}`stats` ``                             |               {icon}`stats`               |
| `` {icon}`stop` ``                              |                {icon}`stop`               |
| `` {icon}`stop_fill` ``                         |             {icon}`stop_fill`             |
...
| `` {icon}`table_density_high` ``                |         {icon}`table_density_high`        |
| `` {icon}`table_density_low` ``                 |         {icon}`table_density_low`         |
| `` {icon}`table_density_normal` ``              |        {icon}`table_density_normal`       |
| `` {icon}`table_info` ``                        |             {icon}`table_info`            |
| `` {icon}`table_of_contents` ``                 |         {icon}`table_of_contents`         |
| `` {icon}`table_time` ``                        |             {icon}`table_time`            |
| `` {icon}`tag` ``                               |                {icon}`tag`                |
| `` {icon}`tear` ``                              |                {icon}`tear`               |
| `` {icon}`temperature` ``                       |            {icon}`temperature`            |
| `` {icon}`text` ``                              |                {icon}`text`               |
| `` {icon}`text_align_center` ``                 |         {icon}`text_align_center`         |
| `` {icon}`text_align_left` ``                   |          {icon}`text_align_left`          |
| `` {icon}`text_align_right` ``                  |          {icon}`text_align_right`         |
| `` {icon}`text_bold` ``                         |             {icon}`text_bold`             |
| `` {icon}`text_heading` ``                      |            {icon}`text_heading`           |
| `` {icon}`text_italic` ``                       |            {icon}`text_italic`            |
| `` {icon}`text_strike` ``                       |            {icon}`text_strike`            |
| `` {icon}`text_underline` ``                    |           {icon}`text_underline`          |
| `` {icon}`thermometer` ``                       |            {icon}`thermometer`            |
| `` {icon}`thumb_down` ``                        |             {icon}`thumb_down`            |
| `` {icon}`thumb_up` ``                          |              {icon}`thumb_up`             |
| `` {icon}`timeline` ``                          |              {icon}`timeline`             |
| `` {icon}`timeline_with_arrow` ``               |        {icon}`timeline_with_arrow`        |
...
| `` {icon}`transition_left_in` ``                |         {icon}`transition_left_in`        |
| `` {icon}`transition_left_out` ``               |        {icon}`transition_left_out`        |
| `` {icon}`transition_top_in` ``                 |         {icon}`transition_top_in`         |
| `` {icon}`transition_top_out` ``                |         {icon}`transition_top_out`        |
...
| `` {icon}`vector_square` ``                     |           {icon}`vector_square`           |
| `` {icon}`vector_triangle` ``                   |          {icon}`vector_triangle`          |
| `` {icon}`video_player` ``                      |            {icon}`video_player`           |
...
| `` {icon}`warning_fill` ``                      |            {icon}`warning_fill`           |
| `` {icon}`waypoint` ``                          |              {icon}`waypoint`             |
| `` {icon}`web` ``                               |                {icon}`web`                |
| `` {icon}`wifi` ``                              |                {icon}`wifi`               |
| `` {icon}`wifi_slash` ``                        |             {icon}`wifi_slash`            |
| `` {icon}`word_wrap` ``                         |             {icon}`word_wrap`             |
| `` {icon}`word_wrap_disabled` ``                |         {icon}`word_wrap_disabled`        |
