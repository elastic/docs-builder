...
:::{note}
The `product` key and its subkeys are used to indicate feature availability and applicability. The similarly named [`products` frontmatter field](/documentation/syntax/frontmatter.md#products) is used to drive elastic.co search filters.
:::
