...
It then places `changelog.yml` in the docs folder and creates `changelog` and `releases` subdirectories. Alternatively, you can create the file and folders manually.
