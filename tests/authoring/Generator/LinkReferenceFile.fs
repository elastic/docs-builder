    ...
    let ``validate index.md HTML`` () =
        generator |> converts "index.md" |> toHtml """
             ...
             <div class="heading-wrapper" id="this-anchor-is-autogenerated">
 	            <h2>
		            <a class="headerlink" href="#this-anchor-is-autogenerated">This anchor is autogenerated<span class="headerlink-marker" aria-hidden="true">#</span></a>
 	            </h2>
             </div>
             <div class="heading-wrapper" id="and-anchored">
 	            <h3>
		            <a class="headerlink" href="#and-anchored">Several pages can be created<span class="headerlink-marker" aria-hidden="true">#</span></a>
 	            </h3>
             </div>
