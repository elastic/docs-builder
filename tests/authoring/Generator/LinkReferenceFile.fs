...
"""
    ...
    let ``validate index.md HTML`` () =
        generator |> converts "index.md" |> toHtml """
            <p><em>Welcome</em>to this documentation</p>
            <section id="this-anchor-is-autogenerated">
                <h2>This anchor is autogenerated
                    <a class="headerlink" href="#this-anchor-is-autogenerated" title="Link to this heading">¶</a>
                </h2>
            </section>
            <section id="and-anchored">
                <h3>Several pages can be created
                    <a class="headerlink" href="#and-anchored" title="Link to this heading">¶</a>
                </h3>
            </section>
            <p>Through various means<a id="including-this-inline-syntax"></a></p>
        """
