...
public class AdmonitionWithAppliesTo : MarkdownTest
{
	protected override string Markdown =>
		"""
		:::{note}
...
public class NestedAdmonitionInList : MarkdownTest
{
	protected override string Markdown =>
		"""
		:::{note}
...
public class NestedAdmonitionInListWithHeading : MarkdownTest
{
	protected override string Markdown =>
		"""
		# heading
...
public class NestedAdmonitionInListWithHeadingInsideAdmonition : MarkdownTest
{
	protected override string Markdown =>
		"""
		# heading
