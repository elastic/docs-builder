...
public class VersionLifecycleInferenceTests
{
	[Test]
	[Arguments("9.2.0", "ga")]
	[Arguments("9.2.0-beta.1", "beta")]
	[Arguments("9.2.0-preview.1", "preview")]
	[Arguments("9.2.0-alpha.1", "preview")]
	[Arguments("9.2.0-rc.1", "ga")]
	[Arguments("2026-07-21", "ga")]
	[Arguments("2025-06-01", "ga")]
