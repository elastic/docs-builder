...
})({"7xi4h":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "67c78acc4ca9e4f2";
"use strict";
...
},{}],"4JB8Y":[function(require,module,exports,__globalThis) {
...
var edgeCount = 0;
var drawEdge = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, path, relation, conf, diagObj) {
    ...
    let labelPosition = (0, _chunkI7ZFS43CMjs.utils_default).calcLabelPosition(path.points);
    x = labelPosition.x;
    y = labelPosition.y;
    let p1_card_x, p1_card_y;
    let p2_card_x, p2_card_y;
    if (l % 2 !== 0 && l > 1) {
        let cardinality_1_point = (0, _chunkI7ZFS43CMjs.utils_default).calcCardinalityPosition(relation.relation.type1 !== "none", path.points, path.points[0]);
        let cardinality_2_point = (0, _chunkI7ZFS43CMjs.utils_default).calcCardinalityPosition(relation.relation.type2 !== "none", path.points, path.points[l - 1]);
        (0, _chunkDD37ZF33Mjs.log).debug("cardinality_1_point " + JSON.stringify(cardinality_1_point));
        (0, _chunkDD37ZF33Mjs.log).debug("cardinality_2_point " + JSON.stringify(cardinality_2_point));
    ...
    (0, _chunkDD37ZF33Mjs.log).info("Rendering relation " + JSON.stringify(relation));
...
var drawClass = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, classDef, conf, diagObj) {
    (0, _chunkDD37ZF33Mjs.log).debug("Rendering class ", classDef, conf);
...
var getClassTitleString = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(classDef) {
    let classTitleString = classDef.id;
    if (classDef.type) classTitleString += "<" + (0, _chunkDD37ZF33Mjs.parseGenericTypes)(classDef.type) + ">";
    return classTitleString;
}, "getClassTitleString");
var drawNote = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, note, conf, _diagObj) {
    (0, _chunkDD37ZF33Mjs.log).debug("Rendering note ", note, conf);
    const id = note.id;
    const noteInfo = {
        id,
        text: note.text,
    ...
    lines.forEach(function(line) {
        (0, _chunkDD37ZF33Mjs.log).debug(`Adding line: ${line}`);
...
var addTspan = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(textEl, member, isFirst, conf) {
...
var idCache = {};
var padding = 20;
var getGraphId = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(label) {
...
var draw = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(text, id, _version, diagObj) {
    const conf = (0, _chunkDD37ZF33Mjs.getConfig2)().class;
    idCache = {};
    (0, _chunkDD37ZF33Mjs.log).info("Rendering diagram " + text);
    ...
    for (const key of keys){
        ...
        (0, _chunkDD37ZF33Mjs.log).info("Org height: " + node.height);
    }
    const relations = diagObj.db.getRelations();
    relations.forEach(function(relation) {
        (0, _chunkDD37ZF33Mjs.log).info(// cspell:ignore tjoho
    ...
    notes.forEach(function(note) {
        (0, _chunkDD37ZF33Mjs.log).debug(`Adding note: ${JSON.stringify(note)}`);
        const node = svgDraw_default.drawNote(diagram2, note, conf, diagObj);
        idCache[node.id] = node;
        g.setNode(node.id, node);
        if (note.class && classes.has(note.class)) g.setEdge(note.id, getGraphId(note.class), {
            relation: {
                id1: note.id,
                id2: note.class,
                relation: {
    ...
    g.nodes().forEach(function(v) {
        if (v !== void 0 && g.node(v) !== void 0) {
            (0, _chunkDD37ZF33Mjs.log).debug("Node " + v + ": " + JSON.stringify(g.node(v)));
    ...
    g.edges().forEach(function(e) {
        if (e !== void 0 && g.edge(e) !== void 0) {
            (0, _chunkDD37ZF33Mjs.log).debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(g.edge(e)));
    ...
    (0, _chunkDD37ZF33Mjs.log).debug(`viewBox ${vBox}`);
...
},{"./chunk-TZBO7MLI.mjs":"fY3tK","./chunk-GRZAG2UZ.mjs":"d1pnj","./chunk-HD3LK5B5.mjs":"lpo2u","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}]},["7xi4h"], null, "parcelRequire6955", {})

//# sourceMappingURL=classDiagram-CXGEL3SQ.4ca9e4f2.js.map
