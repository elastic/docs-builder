...
})({"a4nou":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d5dc96dcaf7588a6";
"use strict";
...
},{}],"cjcsw":[function(require,module,exports,__globalThis) {
...
var require_isoWeek = (0, _chunkDLQEHMXDMjs.__commonJS)({
    "../../node_modules/.pnpm/dayjs@1.11.12/node_modules/dayjs/plugin/isoWeek.js" (exports, module) {
        ...
        !function(e, t) {
            ...
            return function(t, i, s) {
                var a = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t2) {
...
var require_customParseFormat = (0, _chunkDLQEHMXDMjs.__commonJS)({
    "../../node_modules/.pnpm/dayjs@1.11.12/node_modules/dayjs/plugin/customParseFormat.js" (exports, module) {
        ...
        !function(e, t) {
            ...
            }, t = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, n = /\d\d/, r = /\d\d?/, i = /\d*[^-_:/,()\s\d]+/, o = {}, s = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(e2) {
                return (e2 = +e2) + (e2 > 68 ? 1900 : 2e3);
            }, "s");
            var a = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(e2) {
                return function(t2) {
                    this[e2] = +t2;
                };
            }, "a"), f = [
            ...
            ], h = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(e2) {
                var t2 = o[e2];
                return t2 && (t2.indexOf ? t2 : t2.s.concat(t2.f));
            }, "h"), u = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(e2, t2) {
                        ...
                        h2 && (d2 = s2[2]), o = this.$locale(), !f2 && d2 && (o = n2.Ls[d2]), this.$d = function(e4, t4, n3) {
                            try {
                                if ([
                                    "x",
                                    "X"
                                ].indexOf(t4) > -1) return new Date(("X" === t4 ? 1e3 : 1) * e4);
...
var require_advancedFormat = (0, _chunkDLQEHMXDMjs.__commonJS)({
...
var import_dayjs = (0, _chunkDLQEHMXDMjs.__toESM)((0, _chunkDD37ZF33Mjs.require_dayjs_min)(), 1);
var import_isoWeek = (0, _chunkDLQEHMXDMjs.__toESM)(require_isoWeek(), 1);
var import_customParseFormat = (0, _chunkDLQEHMXDMjs.__toESM)(require_customParseFormat(), 1);
var import_advancedFormat = (0, _chunkDLQEHMXDMjs.__toESM)(require_advancedFormat(), 1);
...
var setAxisFormat = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(txt) {
    axisFormat = txt;
}, "setAxisFormat");
var getAxisFormat = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return axisFormat;
}, "getAxisFormat");
var setTickInterval = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(txt) {
    tickInterval = txt;
}, "setTickInterval");
var getTickInterval = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return tickInterval;
}, "getTickInterval");
var setTodayMarker = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(txt) {
    todayMarker = txt;
}, "setTodayMarker");
var getTodayMarker = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return todayMarker;
}, "getTodayMarker");
var setDateFormat = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(txt) {
    dateFormat = txt;
}, "setDateFormat");
var enableInclusiveEndDates = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    inclusiveEndDates = true;
}, "enableInclusiveEndDates");
var endDatesAreInclusive = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return inclusiveEndDates;
}, "endDatesAreInclusive");
var enableTopAxis = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    topAxis = true;
}, "enableTopAxis");
var topAxisEnabled = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return topAxis;
}, "topAxisEnabled");
var setDisplayMode = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(txt) {
    displayMode = txt;
}, "setDisplayMode");
var getDisplayMode = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return displayMode;
}, "getDisplayMode");
var getDateFormat = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return dateFormat;
}, "getDateFormat");
var setIncludes = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(txt) {
    includes = txt.toLowerCase().split(/[\s,]+/);
}, "setIncludes");
var getIncludes = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return includes;
}, "getIncludes");
var setExcludes = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(txt) {
    excludes = txt.toLowerCase().split(/[\s,]+/);
}, "setExcludes");
var getExcludes = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return excludes;
}, "getExcludes");
var getLinks = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return links;
}, "getLinks");
...
var isInvalidDate = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(date, dateFormat2, excludes2, includes2) {
...
var setWeekday = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(txt) {
    weekday = txt;
}, "setWeekday");
var getWeekday = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return weekday;
}, "getWeekday");
var setWeekend = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(startDay) {
    weekend = startDay;
}, "setWeekend");
var checkTaskDates = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(task, dateFormat2, excludes2, includes2) {
    if (!excludes2.length || task.manualEndTime) return;
    let startTime;
    if (task.startTime instanceof Date) startTime = (0, import_dayjs.default)(task.startTime);
    else startTime = (0, import_dayjs.default)(task.startTime, dateFormat2, true);
    startTime = startTime.add(1, "d");
    let originalEndTime;
    if (task.endTime instanceof Date) originalEndTime = (0, import_dayjs.default)(task.endTime);
    else originalEndTime = (0, import_dayjs.default)(task.endTime, dateFormat2, true);
    const [fixedEndTime, renderEndTime] = fixTaskDates(startTime, originalEndTime, dateFormat2, excludes2, includes2);
    task.endTime = fixedEndTime.toDate();
    task.renderEndTime = renderEndTime;
}, "checkTaskDates");
var fixTaskDates = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(startTime, endTime, dateFormat2, excludes2, includes2) {
    let invalid = false;
...
var getStartDate = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(prevTime, dateFormat2, str) {
    str = str.trim();
    ...
    if (mDate.isValid()) return mDate.toDate();
        ...
        (0, _chunkDD37ZF33Mjs.log).debug("Invalid date:" + str);
        (0, _chunkDD37ZF33Mjs.log).debug("With date format:" + dateFormat2.trim());
...
var parseDuration = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(str) {
...
var getEndDate = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(prevTime, dateFormat2, str, inclusive = false) {
    str = str.trim();
...
var taskCnt = 0;
var parseId = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(idStr) {
    if (idStr === void 0) {
        taskCnt = taskCnt + 1;
        return "task" + taskCnt;
    }
...
var compileData = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(prevTask, dataStr) {
    let ds;
...
var parseData = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(prevTaskId, dataStr) {
    let ds;
    if (dataStr.substr(0, 1) === ":") ds = dataStr.substr(1, dataStr.length);
    else ds = dataStr;
    const data = ds.split(",");
...
var rawTasks = [];
var taskDb = {};
var addTask = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(descr, data) {
    const rawTask = {
...
var findTaskById = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(id) {
    const pos = taskDb[id];
    return rawTasks[pos];
}, "findTaskById");
var addTaskOrg = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(descr, data) {
    const newTask = {
        section: currentSection,
        type: currentSection,
        description: descr,
...
var setLink = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(ids, _linkStr) {
    let linkStr = _linkStr;
    if ((0, _chunkDD37ZF33Mjs.getConfig2)().securityLevel !== "loose") linkStr = (0, import_sanitize_url.sanitizeUrl)(_linkStr);
...
var setClass = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(ids, className) {
    ids.split(",").forEach(function(id) {
        let rawTask = findTaskById(id);
        if (rawTask !== void 0) rawTask.classes.push(className);
    });
}, "setClass");
var setClickFun = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(id, functionName, functionArgs) {
    if ((0, _chunkDD37ZF33Mjs.getConfig2)().securityLevel !== "loose") return;
    ...
    if (rawTask !== void 0) pushFun(id, ()=>{
        (0, _chunkI7ZFS43CMjs.utils_default).runFunc(functionName, ...argList);
    });
}, "setClickFun");
var pushFun = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(id, callbackFunction) {
    funs.push(function() {
...
var setClickEvent = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(ids, functionName, functionArgs) {
    ids.split(",").forEach(function(id) {
        setClickFun(id, functionName, functionArgs);
    });
    setClass(ids, "clickable");
}, "setClickEvent");
var bindFunctions = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(element) {
    funs.forEach(function(fun) {
        fun(element);
    });
}, "bindFunctions");
var ganttDb_default = {
    getConfig: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>(0, _chunkDD37ZF33Mjs.getConfig2)().gantt, "getConfig"),
    clear: clear2,
    setDateFormat,
    getDateFormat,
    enableInclusiveEndDates,
...
(0, _chunkDLQEHMXDMjs.__name)(getTaskTags, "getTaskTags");
// src/diagrams/gantt/ganttRenderer.js
var import_dayjs2 = (0, _chunkDLQEHMXDMjs.__toESM)((0, _chunkDD37ZF33Mjs.require_dayjs_min)(), 1);
var setConf = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    (0, _chunkDD37ZF33Mjs.log).debug("Something is calling, setConf, remove the call");
}, "setConf");
var mapWeekdayToTimeFunction = {
    monday: (0, _chunkDD37ZF33Mjs.timeMonday),
    tuesday: (0, _chunkDD37ZF33Mjs.timeTuesday),
    wednesday: (0, _chunkDD37ZF33Mjs.timeWednesday),
    thursday: (0, _chunkDD37ZF33Mjs.timeThursday),
    friday: (0, _chunkDD37ZF33Mjs.timeFriday),
    saturday: (0, _chunkDD37ZF33Mjs.timeSaturday),
    sunday: (0, _chunkDD37ZF33Mjs.timeSunday)
};
var getMaxIntersections = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((tasks2, orderOffset)=>{
    let timeline = [
        ...tasks2
    ].map(()=>-Infinity);
    let sorted = [
...
var draw = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(text, id, version, diagObj) {
    const conf = (0, _chunkDD37ZF33Mjs.getConfig2)().gantt;
    ...
    const timeScale = (0, _chunkDD37ZF33Mjs.time)().domain([
        (0, _chunkDD37ZF33Mjs.min)(taskArray, function(d) {
            return d.startTime;
        }),
        (0, _chunkDD37ZF33Mjs.max)(taskArray, function(d) {
            return d.endTime;
        })
    ]).rangeRound([
        0,
    ...
    (0, _chunkDLQEHMXDMjs.__name)(taskCompare, "taskCompare");
    taskArray.sort(taskCompare);
    makeGantt(taskArray, w, h);
    (0, _chunkDD37ZF33Mjs.configureSvgSize)(svg, h, w, conf.useMaxWidth);
    ...
    function makeGantt(tasks2, pageWidth, pageHeight) {
        ...
        const colorScale = (0, _chunkDD37ZF33Mjs.linear)().domain([
            0,
            categories.length
        ]).range([
            "#00B9FA",
            "#F95002"
        ]).interpolate((0, _chunkDD37ZF33Mjs.hcl_default));
    ...
    (0, _chunkDLQEHMXDMjs.__name)(makeGantt, "makeGantt");
    function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
        ...
        const securityLevel2 = (0, _chunkDD37ZF33Mjs.getConfig2)().securityLevel;
        if (securityLevel2 === "sandbox") {
            let sandboxElement2;
            sandboxElement2 = (0, _chunkDD37ZF33Mjs.select_default)("#i" + id);
    ...
    (0, _chunkDLQEHMXDMjs.__name)(drawRects, "drawRects");
    function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
        ...
        if ((0, import_dayjs2.default)(maxTime).diff((0, import_dayjs2.default)(minTime), "year") > 5) {
            (0, _chunkDD37ZF33Mjs.log).warn("The difference between the min and max time is more than 5 years. This will cause performance issues. Skipping drawing exclude days.");
            return;
        }
    ...
    (0, _chunkDLQEHMXDMjs.__name)(drawExcludeDays, "drawExcludeDays");
    function makeGrid(theSidePad, theTopPad, w2, h2) {
        let bottomXAxis = (0, _chunkDD37ZF33Mjs.axisBottom)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0, _chunkDD37ZF33Mjs.timeFormat)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
        ...
        if (resultTickInterval !== null) {
            ...
            switch(interval){
                case "millisecond":
                    bottomXAxis.ticks((0, _chunkDD37ZF33Mjs.millisecond).every(every));
                    break;
                case "second":
                    bottomXAxis.ticks((0, _chunkDD37ZF33Mjs.second).every(every));
                    break;
                case "minute":
                    bottomXAxis.ticks((0, _chunkDD37ZF33Mjs.timeMinute).every(every));
                    break;
                case "hour":
                    bottomXAxis.ticks((0, _chunkDD37ZF33Mjs.timeHour).every(every));
                    break;
                case "day":
                    bottomXAxis.ticks((0, _chunkDD37ZF33Mjs.timeDay).every(every));
                    break;
                case "week":
                    bottomXAxis.ticks(mapWeekdayToTimeFunction[weekday2].every(every));
                    break;
                case "month":
                    bottomXAxis.ticks((0, _chunkDD37ZF33Mjs.timeMonth).every(every));
                    break;
            }
        }
        svg.append("g").attr("class", "grid").attr("transform", "translate(" + theSidePad + ", " + (h2 - 50) + ")").call(bottomXAxis).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em");
        if (diagObj.db.topAxisEnabled() || conf.topAxis) {
            let topXAxis = (0, _chunkDD37ZF33Mjs.axisTop)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0, _chunkDD37ZF33Mjs.timeFormat)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
            if (resultTickInterval !== null) {
                const every = resultTickInterval[1];
                const interval = resultTickInterval[2];
                const weekday2 = diagObj.db.getWeekday() || conf.weekday;
                switch(interval){
                    case "millisecond":
                        topXAxis.ticks((0, _chunkDD37ZF33Mjs.millisecond).every(every));
                        break;
                    case "second":
                        topXAxis.ticks((0, _chunkDD37ZF33Mjs.second).every(every));
                        break;
                    case "minute":
                        topXAxis.ticks((0, _chunkDD37ZF33Mjs.timeMinute).every(every));
                        break;
                    case "hour":
                        topXAxis.ticks((0, _chunkDD37ZF33Mjs.timeHour).every(every));
                        break;
                    case "day":
                        topXAxis.ticks((0, _chunkDD37ZF33Mjs.timeDay).every(every));
                        break;
                    case "week":
                        topXAxis.ticks(mapWeekdayToTimeFunction[weekday2].every(every));
                        break;
                    case "month":
                        topXAxis.ticks((0, _chunkDD37ZF33Mjs.timeMonth).every(every));
                        break;
                }
            }
    ...
    (0, _chunkDLQEHMXDMjs.__name)(makeGrid, "makeGrid");
    function vertLabels(theGap, theTopPad) {
        ...
        svg.append("g").selectAll("text").data(numOccurrences).enter().append(function(d) {
            const rows = d[0].split((0, _chunkDD37ZF33Mjs.common_default).lineBreakRegex);
    ...
    (0, _chunkDLQEHMXDMjs.__name)(vertLabels, "vertLabels");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(drawToday, "drawToday");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(checkUnique, "checkUnique");
}, "draw");
...
},{"./chunk-I7ZFS43C.mjs":"huUtc","./chunk-GKOISANM.mjs":"5yZtl","./chunk-DD37ZF33.mjs":"f4pI5","./chunk-HD3LK5B5.mjs":"lpo2u","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}]},["a4nou"], null, "parcelRequire6955", {})

//# sourceMappingURL=ganttDiagram-B2ZMZPXB.af7588a6.js.map
