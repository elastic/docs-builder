...
})({"7bMw6":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d841c5c32be95e84";
"use strict";
...
},{}],"3Xksa":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "diagram", ()=>Dt);
...
var T = {
    packet: []
}, D = structuredClone(T), q = (0, _chunkNQURTBEVMjs.s).packet, V = (0, _chunkGTKDMUJJMjs.a)(()=>{
    let t = (0, _chunkAC3VT7B7Mjs.l)({
        ...q,
        ...(0, _chunkNQURTBEVMjs.A)().packet
    });
    return t.showBits && (t.paddingY += 10), t;
}, "getConfig"), L = (0, _chunkGTKDMUJJMjs.a)(()=>D.packet, "getPacket"), N = (0, _chunkGTKDMUJJMjs.a)((t)=>{
    t.length > 0 && D.packet.push(t);
}, "pushWord"), I = (0, _chunkGTKDMUJJMjs.a)(()=>{
    (0, _chunkNQURTBEVMjs.P)(), D = structuredClone(T);
}, "clear"), d = {
    pushWord: N,
    getPacket: L,
    getConfig: V,
...
var M = 1e4, Y = (0, _chunkGTKDMUJJMjs.a)((t)=>{
    (0, _chunk4KE642EDMjs.a)(t, d);
    let e = -1, i = [], s = 1, { bitsPerRow: c } = d.getConfig();
    for (let { start: r, end: o, label: m } of t.blocks){
        ...
        for(e = o ?? r, (0, _chunkNQURTBEVMjs.b).debug(`Packet block ${r} - ${e} with label ${m}`); i.length <= c + 1 && d.getPacket().length < M;){
            let [y, l] = U({
                start: r,
                end: o,
                label: m
            }, s, c);
            if (i.push(y), y.end + 1 === s * c && (d.pushWord(i), i = [], s++), !l) break;
            ({ start: r, end: o, label: m } = l);
        }
    }
    d.pushWord(i);
}, "populate"), U = (0, _chunkGTKDMUJJMjs.a)((t, e, i)=>{
    ...
    parse: (0, _chunkGTKDMUJJMjs.a)(async (t)=>{
        let e = await (0, _chunkYFFLADYNMjs.a)("packet", t);
        (0, _chunkNQURTBEVMjs.b).debug(e), Y(e);
    }, "parse")
};
var H = (0, _chunkGTKDMUJJMjs.a)((t, e, i, s)=>{
    let c = s.db, r = c.getConfig(), { rowHeight: o, paddingY: m, bitWidth: y, bitsPerRow: l } = r, P = c.getPacket(), n = c.getDiagramTitle(), f = o + m, p = f * (P.length + 1) - (n ? 0 : o), k = y * l + 2, g = (0, _chunkWVHPJQMPMjs.a)(e);
    g.attr("viewbox", `0 0 ${k} ${p}`), (0, _chunkNQURTBEVMjs.M)(g, p, k, r.useMaxWidth);
...
}, "draw"), K = (0, _chunkGTKDMUJJMjs.a)((t, e, i, { rowHeight: s, paddingX: c, paddingY: r, bitWidth: o, bitsPerRow: m, showBits: y })=>{
...
}, R = (0, _chunkGTKDMUJJMjs.a)(({ packet: t } = {})=>{
    let e = (0, _chunkAC3VT7B7Mjs.l)(X, t);
    return `
	.packetByte {
...
},{"./chunk-GTKDMUJJ.mjs":"fruhx","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}]},["7bMw6"], null, "parcelRequire6955", {})

//# sourceMappingURL=diagram-V25JEYTC.2be95e84.js.map
