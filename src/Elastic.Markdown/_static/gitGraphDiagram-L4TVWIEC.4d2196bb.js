...
})({"3jzL3":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "07bee5074d2196bb";
"use strict";
...
},{}],"brg65":[function(require,module,exports,__globalThis) {
...
var parsers = {};
var initializers = {
    info: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(async ()=>{
        const { createInfoServices: createInfoServices2 } = await require("f4f8a6a6f8a543d1");
        const parser = createInfoServices2().Info.parser.LangiumParser;
        parsers.info = parser;
    }, "info"),
    packet: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(async ()=>{
        const { createPacketServices: createPacketServices2 } = await require("96963034545c4942");
        const parser = createPacketServices2().Packet.parser.LangiumParser;
        parsers.packet = parser;
    }, "packet"),
    pie: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(async ()=>{
        const { createPieServices: createPieServices2 } = await require("1a31cb43e306873e");
        const parser = createPieServices2().Pie.parser.LangiumParser;
        parsers.pie = parser;
    }, "pie"),
    gitGraph: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(async ()=>{
        const { createGitGraphServices: createGitGraphServices2 } = await require("fc2c71e6b44fdd61");
...
(0, _chunkHBGMPAD7Mjs.__name)(parse, "parse");
var MermaidParseError = class extends Error {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "MermaidParseError");
    constructor(result){
    ...
    static #_2 = (0, _chunkHBGMPAD7Mjs.__name)(this, "MermaidParseError");
};

},{"./chunk-HBGMPAD7.mjs":"i5fzF","./chunk-DLQEHMXD.mjs":"h5YRf","f4f8a6a6f8a543d1":"6Rhiy","96963034545c4942":"4kIpd","1a31cb43e306873e":"gDbnA","fc2c71e6b44fdd61":"dVsea","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}],"i5fzF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createDefaultCoreModule", ()=>createDefaultCoreModule);
parcelHelpers.export(exports, "createDefaultSharedCoreModule", ()=>createDefaultSharedCoreModule);
parcelHelpers.export(exports, "inject", ()=>inject);
parcelHelpers.export(exports, "EmptyFileSystem", ()=>EmptyFileSystem);
parcelHelpers.export(exports, "lib_exports", ()=>lib_exports);
parcelHelpers.export(exports, "__name", ()=>__name2);
parcelHelpers.export(exports, "MermaidGeneratedSharedModule", ()=>MermaidGeneratedSharedModule);
parcelHelpers.export(exports, "InfoGeneratedModule", ()=>InfoGeneratedModule);
parcelHelpers.export(exports, "PacketGeneratedModule", ()=>PacketGeneratedModule);
parcelHelpers.export(exports, "PieGeneratedModule", ()=>PieGeneratedModule);
parcelHelpers.export(exports, "GitGraphGeneratedModule", ()=>GitGraphGeneratedModule);
parcelHelpers.export(exports, "AbstractMermaidValueConverter", ()=>AbstractMermaidValueConverter);
parcelHelpers.export(exports, "CommonValueConverter", ()=>CommonValueConverter);
parcelHelpers.export(exports, "AbstractMermaidTokenBuilder", ()=>AbstractMermaidTokenBuilder);
...
var require_ral = (0, _chunkDLQEHMXDMjs.__commonJS)({
    "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/ral.js" (exports) {
        ...
        (0, _chunkDLQEHMXDMjs.__name)(RAL, "RAL");
        (function(RAL2) {
            function install(ral) {
                if (ral === void 0) throw new Error(`No runtime abstraction layer provided`);
                _ral = ral;
            }
            (0, _chunkDLQEHMXDMjs.__name)(install, "install");
...
var require_is = (0, _chunkDLQEHMXDMjs.__commonJS)({
    "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/is.js" (exports) {
        ...
        (0, _chunkDLQEHMXDMjs.__name)(boolean, "boolean");
        exports.boolean = boolean;
        function string(value) {
            return typeof value === "string" || value instanceof String;
        }
        (0, _chunkDLQEHMXDMjs.__name)(string, "string");
        exports.string = string;
        function number(value) {
            return typeof value === "number" || value instanceof Number;
        }
        (0, _chunkDLQEHMXDMjs.__name)(number, "number");
        exports.number = number;
        function error(value) {
            return value instanceof Error;
        }
        (0, _chunkDLQEHMXDMjs.__name)(error, "error");
        exports.error = error;
        function func(value) {
            return typeof value === "function";
        }
        (0, _chunkDLQEHMXDMjs.__name)(func, "func");
        exports.func = func;
        function array(value) {
            return Array.isArray(value);
        }
        (0, _chunkDLQEHMXDMjs.__name)(array, "array");
        exports.array = array;
        function stringArray(value) {
            return array(value) && value.every((elem)=>string(elem));
        }
        (0, _chunkDLQEHMXDMjs.__name)(stringArray, "stringArray");
        exports.stringArray = stringArray;
    }
});
// ../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/events.js
var require_events = (0, _chunkDLQEHMXDMjs.__commonJS)({
    "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/events.js" (exports) {
        ...
        var CallbackList = class {
            static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "CallbackList");
            add(callback, context = null, bucket) {
                ...
                if (Array.isArray(bucket)) bucket.push({
                    dispose: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>this.remove(callback, context), "dispose")
                });
            }
        ...
        var Emitter2 = class _Emitter {
            static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Emitter");
       ...
       */ get event() {
                if (!this._event) this._event = (listener, thisArgs, disposables)=>{
                    ...
                    const result = {
                        dispose: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
                            if (!this._callbacks) return;
...
var require_cancellation = (0, _chunkDLQEHMXDMjs.__commonJS)({
    "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/cancellation.js" (exports) {
        ...
        (function(CancellationToken12) {
            ...
            (0, _chunkDLQEHMXDMjs.__name)(is, "is");
        ...
        var MutableToken = class {
            static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "MutableToken");
            constructor(){
        ...
        var CancellationTokenSource3 = class {
            static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "CancellationTokenSource");
            get token() {
...
var lib_exports = {};
(0, _chunkDLQEHMXDMjs.__export)(lib_exports, {
...
(0, _chunkDLQEHMXDMjs.__export)(cst_utils_exports, {
...
(0, _chunkDLQEHMXDMjs.__name)(isAstNode, "isAstNode");
function isReference(obj) {
    return typeof obj === "object" && obj !== null && typeof obj.$refText === "string";
}
(0, _chunkDLQEHMXDMjs.__name)(isReference, "isReference");
...
(0, _chunkDLQEHMXDMjs.__name)(isAstNodeDescription, "isAstNodeDescription");
...
(0, _chunkDLQEHMXDMjs.__name)(isLinkingError, "isLinkingError");
var AbstractAstReflection = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractAstReflection");
    constructor(){
        this.subtypes = {};
        this.allSubtypes = {};
    }
...
(0, _chunkDLQEHMXDMjs.__name)(isCompositeCstNode, "isCompositeCstNode");
function isLeafCstNode(node) {
    return typeof node === "object" && node !== null && typeof node.tokenType === "object";
}
(0, _chunkDLQEHMXDMjs.__name)(isLeafCstNode, "isLeafCstNode");
function isRootCstNode(node) {
    return isCompositeCstNode(node) && typeof node.fullText === "string";
}
(0, _chunkDLQEHMXDMjs.__name)(isRootCstNode, "isRootCstNode");
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/utils/stream.js
var StreamImpl = class _StreamImpl {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "StreamImpl");
    ...
    iterator() {
        const iterator = {
            state: this.startFn(),
            next: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>this.nextFn(iterator.state), "next"),
...
(0, _chunkDLQEHMXDMjs.__name)(toString, "toString");
function isIterable(obj) {
    return !!obj && typeof obj[Symbol.iterator] === "function";
}
(0, _chunkDLQEHMXDMjs.__name)(isIterable, "isIterable");
...
function stream(...collections) {
    if (collections.length === 1) {
        ...
        if (typeof collection.length === "number") return new StreamImpl(()=>({
                index: 0
            }), (state)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(stream, "stream");
var TreeStreamImpl = class extends StreamImpl {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "TreeStreamImpl");
    ...
    iterator() {
        const iterator = {
            state: this.startFn(),
            next: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>this.nextFn(iterator.state), "next"),
            prune: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
...
(function(Reduction2) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(product, "product");
...
(0, _chunkDLQEHMXDMjs.__name)(streamCst, "streamCst");
function flattenCst(node) {
    return streamCst(node).filter(isLeafCstNode);
}
(0, _chunkDLQEHMXDMjs.__name)(flattenCst, "flattenCst");
...
(0, _chunkDLQEHMXDMjs.__name)(isChildNode, "isChildNode");
...
(0, _chunkDLQEHMXDMjs.__name)(tokenToRange, "tokenToRange");
...
(0, _chunkDLQEHMXDMjs.__name)(toDocumentSegment, "toDocumentSegment");
var RangeComparison;
...
function compareRange(range, to) {
    if (range.end.line < to.start.line || range.end.line === to.start.line && range.end.character < range.start.character) return RangeComparison.Before;
    ...
    else return RangeComparison.OverlapFront;
}
(0, _chunkDLQEHMXDMjs.__name)(compareRange, "compareRange");
function inRange(range, to) {
    const comparison = compareRange(range, to);
    return comparison > RangeComparison.After;
}
(0, _chunkDLQEHMXDMjs.__name)(inRange, "inRange");
...
(0, _chunkDLQEHMXDMjs.__name)(findDeclarationNodeAtOffset, "findDeclarationNodeAtOffset");
...
(0, _chunkDLQEHMXDMjs.__name)(findCommentNode, "findCommentNode");
function isCommentNode(cstNode, commentNames) {
    return isLeafCstNode(cstNode) && commentNames.includes(cstNode.tokenType.name);
}
(0, _chunkDLQEHMXDMjs.__name)(isCommentNode, "isCommentNode");
...
(0, _chunkDLQEHMXDMjs.__name)(findLeafNodeAtOffset, "findLeafNodeAtOffset");
...
(0, _chunkDLQEHMXDMjs.__name)(findLeafNodeBeforeOffset, "findLeafNodeBeforeOffset");
...
(0, _chunkDLQEHMXDMjs.__name)(binarySearch, "binarySearch");
...
(0, _chunkDLQEHMXDMjs.__name)(getPreviousNode, "getPreviousNode");
...
(0, _chunkDLQEHMXDMjs.__name)(getNextNode, "getNextNode");
...
(0, _chunkDLQEHMXDMjs.__name)(getStartlineNode, "getStartlineNode");
function getInteriorNodes(start, end) {
    const commonParent = getCommonParent(start, end);
    if (!commonParent) return [];
    return commonParent.parent.content.slice(commonParent.a + 1, commonParent.b);
}
(0, _chunkDLQEHMXDMjs.__name)(getInteriorNodes, "getInteriorNodes");
...
(0, _chunkDLQEHMXDMjs.__name)(getCommonParent, "getCommonParent");
...
(0, _chunkDLQEHMXDMjs.__name)(getParentChain, "getParentChain");
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/utils/grammar-utils.js
var grammar_utils_exports = {};
(0, _chunkDLQEHMXDMjs.__export)(grammar_utils_exports, {
...
var ErrorWithLocation = class extends Error {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ErrorWithLocation");
...
(0, _chunkDLQEHMXDMjs.__name)(assertUnreachable, "assertUnreachable");
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/languages/generated/ast.js
var ast_exports = {};
(0, _chunkDLQEHMXDMjs.__export)(ast_exports, {
...
(0, _chunkDLQEHMXDMjs.__name)(isAbstractRule, "isAbstractRule");
var AbstractType = "AbstractType";
function isAbstractType(item) {
    return reflection.isInstance(item, AbstractType);
}
(0, _chunkDLQEHMXDMjs.__name)(isAbstractType, "isAbstractType");
var Condition = "Condition";
function isCondition(item) {
    return reflection.isInstance(item, Condition);
}
(0, _chunkDLQEHMXDMjs.__name)(isCondition, "isCondition");
function isFeatureName(item) {
    return isPrimitiveType(item) || item === "current" || item === "entry" || item === "extends" || item === "false" || item === "fragment" || item === "grammar" || item === "hidden" || item === "import" || item === "interface" || item === "returns" || item === "terminal" || item === "true" || item === "type" || item === "infer" || item === "infers" || item === "with" || typeof item === "string" && /\^?[_a-zA-Z][\w_]*/.test(item);
}
(0, _chunkDLQEHMXDMjs.__name)(isFeatureName, "isFeatureName");
function isPrimitiveType(item) {
    return item === "string" || item === "number" || item === "boolean" || item === "Date" || item === "bigint";
}
(0, _chunkDLQEHMXDMjs.__name)(isPrimitiveType, "isPrimitiveType");
var TypeDefinition = "TypeDefinition";
function isTypeDefinition(item) {
    return reflection.isInstance(item, TypeDefinition);
}
(0, _chunkDLQEHMXDMjs.__name)(isTypeDefinition, "isTypeDefinition");
var ValueLiteral = "ValueLiteral";
function isValueLiteral(item) {
    return reflection.isInstance(item, ValueLiteral);
}
(0, _chunkDLQEHMXDMjs.__name)(isValueLiteral, "isValueLiteral");
var AbstractElement = "AbstractElement";
function isAbstractElement(item) {
    return reflection.isInstance(item, AbstractElement);
}
(0, _chunkDLQEHMXDMjs.__name)(isAbstractElement, "isAbstractElement");
var ArrayLiteral = "ArrayLiteral";
function isArrayLiteral(item) {
    return reflection.isInstance(item, ArrayLiteral);
}
(0, _chunkDLQEHMXDMjs.__name)(isArrayLiteral, "isArrayLiteral");
var ArrayType = "ArrayType";
function isArrayType(item) {
    return reflection.isInstance(item, ArrayType);
}
(0, _chunkDLQEHMXDMjs.__name)(isArrayType, "isArrayType");
var BooleanLiteral = "BooleanLiteral";
function isBooleanLiteral(item) {
    return reflection.isInstance(item, BooleanLiteral);
}
(0, _chunkDLQEHMXDMjs.__name)(isBooleanLiteral, "isBooleanLiteral");
var Conjunction = "Conjunction";
function isConjunction(item) {
    return reflection.isInstance(item, Conjunction);
}
(0, _chunkDLQEHMXDMjs.__name)(isConjunction, "isConjunction");
var Disjunction = "Disjunction";
function isDisjunction(item) {
    return reflection.isInstance(item, Disjunction);
}
(0, _chunkDLQEHMXDMjs.__name)(isDisjunction, "isDisjunction");
var Grammar = "Grammar";
function isGrammar(item) {
    return reflection.isInstance(item, Grammar);
}
(0, _chunkDLQEHMXDMjs.__name)(isGrammar, "isGrammar");
var GrammarImport = "GrammarImport";
function isGrammarImport(item) {
    return reflection.isInstance(item, GrammarImport);
}
(0, _chunkDLQEHMXDMjs.__name)(isGrammarImport, "isGrammarImport");
var InferredType = "InferredType";
function isInferredType(item) {
    return reflection.isInstance(item, InferredType);
}
(0, _chunkDLQEHMXDMjs.__name)(isInferredType, "isInferredType");
var Interface = "Interface";
function isInterface(item) {
    return reflection.isInstance(item, Interface);
}
(0, _chunkDLQEHMXDMjs.__name)(isInterface, "isInterface");
var NamedArgument = "NamedArgument";
function isNamedArgument(item) {
    return reflection.isInstance(item, NamedArgument);
}
(0, _chunkDLQEHMXDMjs.__name)(isNamedArgument, "isNamedArgument");
var Negation = "Negation";
function isNegation(item) {
    return reflection.isInstance(item, Negation);
}
(0, _chunkDLQEHMXDMjs.__name)(isNegation, "isNegation");
var NumberLiteral = "NumberLiteral";
function isNumberLiteral(item) {
    return reflection.isInstance(item, NumberLiteral);
}
(0, _chunkDLQEHMXDMjs.__name)(isNumberLiteral, "isNumberLiteral");
var Parameter = "Parameter";
function isParameter(item) {
    return reflection.isInstance(item, Parameter);
}
(0, _chunkDLQEHMXDMjs.__name)(isParameter, "isParameter");
var ParameterReference = "ParameterReference";
function isParameterReference(item) {
    return reflection.isInstance(item, ParameterReference);
}
(0, _chunkDLQEHMXDMjs.__name)(isParameterReference, "isParameterReference");
var ParserRule = "ParserRule";
function isParserRule(item) {
    return reflection.isInstance(item, ParserRule);
}
(0, _chunkDLQEHMXDMjs.__name)(isParserRule, "isParserRule");
var ReferenceType = "ReferenceType";
function isReferenceType(item) {
    return reflection.isInstance(item, ReferenceType);
}
(0, _chunkDLQEHMXDMjs.__name)(isReferenceType, "isReferenceType");
var ReturnType = "ReturnType";
function isReturnType(item) {
    return reflection.isInstance(item, ReturnType);
}
(0, _chunkDLQEHMXDMjs.__name)(isReturnType, "isReturnType");
var SimpleType = "SimpleType";
function isSimpleType(item) {
    return reflection.isInstance(item, SimpleType);
}
(0, _chunkDLQEHMXDMjs.__name)(isSimpleType, "isSimpleType");
var StringLiteral = "StringLiteral";
function isStringLiteral(item) {
    return reflection.isInstance(item, StringLiteral);
}
(0, _chunkDLQEHMXDMjs.__name)(isStringLiteral, "isStringLiteral");
var TerminalRule = "TerminalRule";
function isTerminalRule(item) {
    return reflection.isInstance(item, TerminalRule);
}
(0, _chunkDLQEHMXDMjs.__name)(isTerminalRule, "isTerminalRule");
var Type = "Type";
function isType(item) {
    return reflection.isInstance(item, Type);
}
(0, _chunkDLQEHMXDMjs.__name)(isType, "isType");
var TypeAttribute = "TypeAttribute";
function isTypeAttribute(item) {
    return reflection.isInstance(item, TypeAttribute);
}
(0, _chunkDLQEHMXDMjs.__name)(isTypeAttribute, "isTypeAttribute");
var UnionType = "UnionType";
function isUnionType(item) {
    return reflection.isInstance(item, UnionType);
}
(0, _chunkDLQEHMXDMjs.__name)(isUnionType, "isUnionType");
var Action = "Action";
function isAction(item) {
    return reflection.isInstance(item, Action);
}
(0, _chunkDLQEHMXDMjs.__name)(isAction, "isAction");
var Alternatives = "Alternatives";
function isAlternatives(item) {
    return reflection.isInstance(item, Alternatives);
}
(0, _chunkDLQEHMXDMjs.__name)(isAlternatives, "isAlternatives");
var Assignment = "Assignment";
function isAssignment(item) {
    return reflection.isInstance(item, Assignment);
}
(0, _chunkDLQEHMXDMjs.__name)(isAssignment, "isAssignment");
var CharacterRange = "CharacterRange";
function isCharacterRange(item) {
    return reflection.isInstance(item, CharacterRange);
}
(0, _chunkDLQEHMXDMjs.__name)(isCharacterRange, "isCharacterRange");
var CrossReference = "CrossReference";
function isCrossReference(item) {
    return reflection.isInstance(item, CrossReference);
}
(0, _chunkDLQEHMXDMjs.__name)(isCrossReference, "isCrossReference");
var EndOfFile = "EndOfFile";
function isEndOfFile(item) {
    return reflection.isInstance(item, EndOfFile);
}
(0, _chunkDLQEHMXDMjs.__name)(isEndOfFile, "isEndOfFile");
var Group = "Group";
function isGroup(item) {
    return reflection.isInstance(item, Group);
}
(0, _chunkDLQEHMXDMjs.__name)(isGroup, "isGroup");
var Keyword = "Keyword";
function isKeyword(item) {
    return reflection.isInstance(item, Keyword);
}
(0, _chunkDLQEHMXDMjs.__name)(isKeyword, "isKeyword");
var NegatedToken = "NegatedToken";
function isNegatedToken(item) {
    return reflection.isInstance(item, NegatedToken);
}
(0, _chunkDLQEHMXDMjs.__name)(isNegatedToken, "isNegatedToken");
var RegexToken = "RegexToken";
function isRegexToken(item) {
    return reflection.isInstance(item, RegexToken);
}
(0, _chunkDLQEHMXDMjs.__name)(isRegexToken, "isRegexToken");
var RuleCall = "RuleCall";
function isRuleCall(item) {
    return reflection.isInstance(item, RuleCall);
}
(0, _chunkDLQEHMXDMjs.__name)(isRuleCall, "isRuleCall");
var TerminalAlternatives = "TerminalAlternatives";
function isTerminalAlternatives(item) {
    return reflection.isInstance(item, TerminalAlternatives);
}
(0, _chunkDLQEHMXDMjs.__name)(isTerminalAlternatives, "isTerminalAlternatives");
var TerminalGroup = "TerminalGroup";
function isTerminalGroup(item) {
    return reflection.isInstance(item, TerminalGroup);
}
(0, _chunkDLQEHMXDMjs.__name)(isTerminalGroup, "isTerminalGroup");
var TerminalRuleCall = "TerminalRuleCall";
function isTerminalRuleCall(item) {
    return reflection.isInstance(item, TerminalRuleCall);
}
(0, _chunkDLQEHMXDMjs.__name)(isTerminalRuleCall, "isTerminalRuleCall");
var UnorderedGroup = "UnorderedGroup";
function isUnorderedGroup(item) {
    return reflection.isInstance(item, UnorderedGroup);
}
(0, _chunkDLQEHMXDMjs.__name)(isUnorderedGroup, "isUnorderedGroup");
var UntilToken = "UntilToken";
function isUntilToken(item) {
    return reflection.isInstance(item, UntilToken);
}
(0, _chunkDLQEHMXDMjs.__name)(isUntilToken, "isUntilToken");
var Wildcard = "Wildcard";
function isWildcard(item) {
    return reflection.isInstance(item, Wildcard);
}
(0, _chunkDLQEHMXDMjs.__name)(isWildcard, "isWildcard");
var LangiumGrammarAstReflection = class extends AbstractAstReflection {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LangiumGrammarAstReflection");
    getAllTypes() {
        return [
            "AbstractElement",
            "AbstractRule",
...
(0, _chunkDLQEHMXDMjs.__export)(ast_utils_exports, {
...
(0, _chunkDLQEHMXDMjs.__name)(linkContentToContainer, "linkContentToContainer");
...
(0, _chunkDLQEHMXDMjs.__name)(getContainerOfType, "getContainerOfType");
...
(0, _chunkDLQEHMXDMjs.__name)(hasContainerOfType, "hasContainerOfType");
...
(0, _chunkDLQEHMXDMjs.__name)(getDocument, "getDocument");
function findRootNode(node) {
    while(node.$container)node = node.$container;
    return node;
}
(0, _chunkDLQEHMXDMjs.__name)(findRootNode, "findRootNode");
...
(0, _chunkDLQEHMXDMjs.__name)(streamContents, "streamContents");
function streamAllContents(root, options) {
    if (!root) throw new Error("Root node must be an AstNode.");
    return new TreeStreamImpl(root, (node)=>streamContents(node, options));
}
(0, _chunkDLQEHMXDMjs.__name)(streamAllContents, "streamAllContents");
...
(0, _chunkDLQEHMXDMjs.__name)(streamAst, "streamAst");
...
(0, _chunkDLQEHMXDMjs.__name)(isAstNodeInRange, "isAstNodeInRange");
...
(0, _chunkDLQEHMXDMjs.__name)(streamReferences, "streamReferences");
...
(0, _chunkDLQEHMXDMjs.__name)(findLocalReferences, "findLocalReferences");
...
(0, _chunkDLQEHMXDMjs.__name)(assignMandatoryProperties, "assignMandatoryProperties");
...
(0, _chunkDLQEHMXDMjs.__name)(copyDefaultValue, "copyDefaultValue");
function copyAstNode(node, buildReference) {
    const copy = {
        $type: node.$type
    };
    for (const [name, value] of Object.entries(node))if (!name.startsWith("$")) {
        if (isAstNode(value)) copy[name] = copyAstNode(value, buildReference);
        else if (isReference(value)) copy[name] = buildReference(copy, name, value.$refNode, value.$refText);
        else if (Array.isArray(value)) {
            const copiedArray = [];
            for (const element of value){
                if (isAstNode(element)) copiedArray.push(copyAstNode(element, buildReference));
...
(0, _chunkDLQEHMXDMjs.__name)(cc, "cc");
...
(0, _chunkDLQEHMXDMjs.__name)(insertToSet, "insertToSet");
function addFlag(flagObj, flagKey) {
    if (flagObj[flagKey] === true) throw "duplicate flag " + flagKey;
    const x = flagObj[flagKey];
    flagObj[flagKey] = true;
}
(0, _chunkDLQEHMXDMjs.__name)(addFlag, "addFlag");
function ASSERT_EXISTS(obj) {
    if (obj === void 0) throw Error("Internal Error - Should never get here!");
    return true;
}
(0, _chunkDLQEHMXDMjs.__name)(ASSERT_EXISTS, "ASSERT_EXISTS");
function ASSERT_NEVER_REACH_HERE() {
    throw Error("Internal Error - Should never get here!");
}
(0, _chunkDLQEHMXDMjs.__name)(ASSERT_NEVER_REACH_HERE, "ASSERT_NEVER_REACH_HERE");
function isCharacter(obj) {
    return obj["type"] === "Character";
}
(0, _chunkDLQEHMXDMjs.__name)(isCharacter, "isCharacter");
...
var RegExpParser = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RegExpParser");
    constructor(){
        this.idx = 0;
        this.input = "";
        this.groupIdx = 0;
...
var BaseRegExpVisitor = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "BaseRegExpVisitor");
    visitChildren(node) {
...
var TerminalRegExpVisitor = class extends BaseRegExpVisitor {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "TerminalRegExpVisitor");
    constructor(){
        super(...arguments);
...
(0, _chunkDLQEHMXDMjs.__name)(getTerminalParts, "getTerminalParts");
...
(0, _chunkDLQEHMXDMjs.__name)(isMultilineComment, "isMultilineComment");
function isWhitespace(value) {
    const regexp = typeof value === "string" ? new RegExp(value) : value;
    return regexp.test(" ");
}
(0, _chunkDLQEHMXDMjs.__name)(isWhitespace, "isWhitespace");
function escapeRegExp(value) {
    return value.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
}
(0, _chunkDLQEHMXDMjs.__name)(escapeRegExp, "escapeRegExp");
function getCaseInsensitivePattern(keyword) {
    return Array.prototype.map.call(keyword, (letter)=>/\w/.test(letter) ? `[${letter.toLowerCase()}${letter.toUpperCase()}]` : escapeRegExp(letter)).join("");
}
(0, _chunkDLQEHMXDMjs.__name)(getCaseInsensitivePattern, "getCaseInsensitivePattern");
function partialMatches(regex, input) {
    const partial = partialRegExp(regex);
    const match = input.match(partial);
    return !!match && match[0].length > 0;
}
(0, _chunkDLQEHMXDMjs.__name)(partialMatches, "partialMatches");
function partialRegExp(regex) {
    ...
    function process2() {
        ...
        (0, _chunkDLQEHMXDMjs.__name)(appendRaw, "appendRaw");
        function appendOptional(nbChars) {
            result += "(?:" + source.substr(i, nbChars) + "|$)";
            i += nbChars;
        }
        (0, _chunkDLQEHMXDMjs.__name)(appendOptional, "appendOptional");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(process2, "process");
    return new RegExp(process2(), regex.flags);
}
(0, _chunkDLQEHMXDMjs.__name)(partialRegExp, "partialRegExp");
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/utils/grammar-utils.js
function getEntryRule(grammar) {
    return grammar.rules.find((e)=>isParserRule(e) && e.entry);
}
(0, _chunkDLQEHMXDMjs.__name)(getEntryRule, "getEntryRule");
function getHiddenRules(grammar) {
    return grammar.rules.filter((e)=>isTerminalRule(e) && e.hidden);
}
(0, _chunkDLQEHMXDMjs.__name)(getHiddenRules, "getHiddenRules");
...
(0, _chunkDLQEHMXDMjs.__name)(getAllReachableRules, "getAllReachableRules");
...
(0, _chunkDLQEHMXDMjs.__name)(ruleDfs, "ruleDfs");
...
(0, _chunkDLQEHMXDMjs.__name)(getCrossReferenceTerminal, "getCrossReferenceTerminal");
function isCommentTerminal(terminalRule) {
    return terminalRule.hidden && !terminalRegex(terminalRule).test(" ");
}
(0, _chunkDLQEHMXDMjs.__name)(isCommentTerminal, "isCommentTerminal");
function findNodesForProperty(node, property) {
    if (!node || !property) return [];
    return findNodesForPropertyInternal(node, property, node.astNode, true);
}
(0, _chunkDLQEHMXDMjs.__name)(findNodesForProperty, "findNodesForProperty");
...
(0, _chunkDLQEHMXDMjs.__name)(findNodeForProperty, "findNodeForProperty");
...
(0, _chunkDLQEHMXDMjs.__name)(findNodesForPropertyInternal, "findNodesForPropertyInternal");
...
(0, _chunkDLQEHMXDMjs.__name)(findNodesForKeyword, "findNodesForKeyword");
...
(0, _chunkDLQEHMXDMjs.__name)(findNodeForKeyword, "findNodeForKeyword");
function findNodesForKeywordInternal(node, keyword, element) {
    if (node.astNode !== element) return [];
    if (isKeyword(node.grammarSource) && node.grammarSource.value === keyword) return [
        node
    ];
...
(0, _chunkDLQEHMXDMjs.__name)(findNodesForKeywordInternal, "findNodesForKeywordInternal");
...
(0, _chunkDLQEHMXDMjs.__name)(findAssignment, "findAssignment");
...
(0, _chunkDLQEHMXDMjs.__name)(findNameAssignment, "findNameAssignment");
function findNameAssignmentInternal(type, startNode, cache) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(go, "go");
...
(0, _chunkDLQEHMXDMjs.__name)(findNameAssignmentInternal, "findNameAssignmentInternal");
...
(0, _chunkDLQEHMXDMjs.__name)(getActionAtElement, "getActionAtElement");
...
(0, _chunkDLQEHMXDMjs.__name)(isOptionalCardinality, "isOptionalCardinality");
function isArrayCardinality(cardinality) {
    return cardinality === "*" || cardinality === "+";
}
(0, _chunkDLQEHMXDMjs.__name)(isArrayCardinality, "isArrayCardinality");
function isArrayOperator(operator) {
    return operator === "+=";
}
(0, _chunkDLQEHMXDMjs.__name)(isArrayOperator, "isArrayOperator");
function isDataTypeRule(rule) {
    return isDataTypeRuleInternal(rule, /* @__PURE__ */ new Set());
}
(0, _chunkDLQEHMXDMjs.__name)(isDataTypeRule, "isDataTypeRule");
...
(0, _chunkDLQEHMXDMjs.__name)(isDataTypeRuleInternal, "isDataTypeRuleInternal");
function isDataType(type) {
    return isDataTypeInternal(type.type, /* @__PURE__ */ new Set());
}
(0, _chunkDLQEHMXDMjs.__name)(isDataType, "isDataType");
...
(0, _chunkDLQEHMXDMjs.__name)(isDataTypeInternal, "isDataTypeInternal");
...
(0, _chunkDLQEHMXDMjs.__name)(getExplicitRuleType, "getExplicitRuleType");
...
(0, _chunkDLQEHMXDMjs.__name)(getTypeName, "getTypeName");
...
(0, _chunkDLQEHMXDMjs.__name)(getActionType, "getActionType");
...
(0, _chunkDLQEHMXDMjs.__name)(getRuleType, "getRuleType");
...
(0, _chunkDLQEHMXDMjs.__name)(terminalRegex, "terminalRegex");
...
(0, _chunkDLQEHMXDMjs.__name)(abstractElementToRegex, "abstractElementToRegex");
...
(0, _chunkDLQEHMXDMjs.__name)(terminalAlternativesToRegex, "terminalAlternativesToRegex");
...
(0, _chunkDLQEHMXDMjs.__name)(terminalGroupToRegex, "terminalGroupToRegex");
...
(0, _chunkDLQEHMXDMjs.__name)(untilTokenToRegex, "untilTokenToRegex");
...
(0, _chunkDLQEHMXDMjs.__name)(negateTokenToRegex, "negateTokenToRegex");
...
(0, _chunkDLQEHMXDMjs.__name)(characterRangeToRegex, "characterRangeToRegex");
function keywordToRegex(keyword) {
    return escapeRegExp(keyword.value);
}
(0, _chunkDLQEHMXDMjs.__name)(keywordToRegex, "keywordToRegex");
...
(0, _chunkDLQEHMXDMjs.__name)(withCardinality, "withCardinality");
...
(0, _chunkDLQEHMXDMjs.__name)(createGrammarConfig, "createGrammarConfig");
...
(0, _chunkDLQEHMXDMjs.__name)(PRINT_ERROR, "PRINT_ERROR");
function PRINT_WARNING(msg) {
    if (console && console.warn) console.warn(`Warning: ${msg}`);
}
(0, _chunkDLQEHMXDMjs.__name)(PRINT_WARNING, "PRINT_WARNING");
...
(0, _chunkDLQEHMXDMjs.__name)(timer, "timer");
// ../../node_modules/.pnpm/@chevrotain+utils@11.0.3/node_modules/@chevrotain/utils/lib/src/to-fast-properties.js
function toFastProperties(toBecomeFast) {
    function FakeConstructor() {}
    (0, _chunkDLQEHMXDMjs.__name)(FakeConstructor, "FakeConstructor");
    FakeConstructor.prototype = toBecomeFast;
    const fakeInstance = new FakeConstructor();
    function fakeAccess() {
        return typeof fakeInstance.bar;
    }
    (0, _chunkDLQEHMXDMjs.__name)(fakeAccess, "fakeAccess");
    fakeAccess();
    fakeAccess();
    return toBecomeFast;
}
(0, _chunkDLQEHMXDMjs.__name)(toFastProperties, "toFastProperties");
...
(0, _chunkDLQEHMXDMjs.__name)(tokenLabel, "tokenLabel");
function hasTokenLabel(obj) {
    return (0, _chunkTZBO7MLIMjs.isString_default)(obj.LABEL) && obj.LABEL !== "";
}
(0, _chunkDLQEHMXDMjs.__name)(hasTokenLabel, "hasTokenLabel");
var AbstractProduction = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractProduction");
    get definition() {
    ...
    accept(visitor2) {
        visitor2.visit(this);
        (0, _chunkTZBO7MLIMjs.forEach_default)(this.definition, (prod)=>{
            prod.accept(visitor2);
        });
    }
};
var NonTerminal = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "NonTerminal");
    constructor(options){
        super([]);
        this.idx = 1;
        (0, _chunkTZBO7MLIMjs.assign_default)(this, (0, _chunkTZBO7MLIMjs.pickBy_default)(options, (v)=>v !== void 0));
    }
...
var Rule = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Rule");
    constructor(options){
...
var Alternative = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Alternative");
    constructor(options){
        super(options.definition);
...
var Option = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Option");
    constructor(options){
        super(options.definition);
        this.idx = 1;
        (0, _chunkTZBO7MLIMjs.assign_default)(this, (0, _chunkTZBO7MLIMjs.pickBy_default)(options, (v)=>v !== void 0));
...
var RepetitionMandatory = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RepetitionMandatory");
    constructor(options){
        super(options.definition);
        this.idx = 1;
        (0, _chunkTZBO7MLIMjs.assign_default)(this, (0, _chunkTZBO7MLIMjs.pickBy_default)(options, (v)=>v !== void 0));
...
var RepetitionMandatoryWithSeparator = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RepetitionMandatoryWithSeparator");
    constructor(options){
        super(options.definition);
        this.idx = 1;
        (0, _chunkTZBO7MLIMjs.assign_default)(this, (0, _chunkTZBO7MLIMjs.pickBy_default)(options, (v)=>v !== void 0));
...
var Repetition = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Repetition");
    constructor(options){
        super(options.definition);
        this.idx = 1;
        (0, _chunkTZBO7MLIMjs.assign_default)(this, (0, _chunkTZBO7MLIMjs.pickBy_default)(options, (v)=>v !== void 0));
...
var RepetitionWithSeparator = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RepetitionWithSeparator");
    constructor(options){
        super(options.definition);
        this.idx = 1;
        (0, _chunkTZBO7MLIMjs.assign_default)(this, (0, _chunkTZBO7MLIMjs.pickBy_default)(options, (v)=>v !== void 0));
...
var Alternation = class extends AbstractProduction {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Alternation");
    get definition() {
        return this._definition;
    }
    set definition(value) {
...
var Terminal = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Terminal");
    constructor(options){
        this.idx = 1;
        (0, _chunkTZBO7MLIMjs.assign_default)(this, (0, _chunkTZBO7MLIMjs.pickBy_default)(options, (v)=>v !== void 0));
    }
...
function serializeGrammar(topRules) {
    return (0, _chunkTZBO7MLIMjs.map_default)(topRules, serializeProduction);
}
(0, _chunkDLQEHMXDMjs.__name)(serializeGrammar, "serializeGrammar");
function serializeProduction(node) {
    function convertDefinition(definition) {
        return (0, _chunkTZBO7MLIMjs.map_default)(definition, serializeProduction);
    }
    (0, _chunkDLQEHMXDMjs.__name)(convertDefinition, "convertDefinition");
    if (node instanceof NonTerminal) {
        ...
        if ((0, _chunkTZBO7MLIMjs.isString_default)(node.label)) serializedNonTerminal.label = node.label;
        ...
        if ((0, _chunkTZBO7MLIMjs.isString_default)(node.label)) serializedTerminal.terminalLabel = node.label;
        const pattern = node.terminalType.PATTERN;
        if (node.terminalType.PATTERN) serializedTerminal.pattern = (0, _chunkTZBO7MLIMjs.isRegExp_default)(pattern) ? pattern.source : pattern;
...
(0, _chunkDLQEHMXDMjs.__name)(serializeProduction, "serializeProduction");
// ../../node_modules/.pnpm/@chevrotain+gast@11.0.3/node_modules/@chevrotain/gast/lib/src/visitor.js
var GAstVisitor = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "GAstVisitor");
    visit(node) {
        const nodeAny = node;
...
(0, _chunkDLQEHMXDMjs.__name)(isSequenceProd, "isSequenceProd");
function isOptionalProd(prod, alreadyVisited = []) {
    ...
    if (prod instanceof Alternation) return (0, _chunkTZBO7MLIMjs.some_default)(prod.definition, (subProd)=>{
        return isOptionalProd(subProd, alreadyVisited);
    });
    else if (prod instanceof NonTerminal && (0, _chunkTZBO7MLIMjs.includes_default)(alreadyVisited, prod)) return false;
    else if (prod instanceof AbstractProduction) {
        if (prod instanceof NonTerminal) alreadyVisited.push(prod);
        return (0, _chunkTZBO7MLIMjs.every_default)(prod.definition, (subProd)=>{
            return isOptionalProd(subProd, alreadyVisited);
        });
    } else return false;
}
(0, _chunkDLQEHMXDMjs.__name)(isOptionalProd, "isOptionalProd");
function isBranchingProd(prod) {
    return prod instanceof Alternation;
}
(0, _chunkDLQEHMXDMjs.__name)(isBranchingProd, "isBranchingProd");
...
(0, _chunkDLQEHMXDMjs.__name)(getProductionDslName, "getProductionDslName");
// ../../node_modules/.pnpm/chevrotain@11.0.3/node_modules/chevrotain/lib/src/parse/grammar/rest.js
var RestWalker = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RestWalker");
    walk(prod, prevRest = []) {
        (0, _chunkTZBO7MLIMjs.forEach_default)(prod.definition, (subProd, index)=>{
            const currRest = (0, _chunkTZBO7MLIMjs.drop_default)(prod.definition, index + 1);
    ...
    walkOr(orProd, currRest, prevRest) {
        const fullOrRest = currRest.concat(prevRest);
        (0, _chunkTZBO7MLIMjs.forEach_default)(orProd.definition, (alt)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(restForRepetitionWithSeparator, "restForRepetitionWithSeparator");
...
(0, _chunkDLQEHMXDMjs.__name)(first, "first");
function firstForSequence(prod) {
    ...
    return (0, _chunkTZBO7MLIMjs.uniq_default)(firstSet);
}
(0, _chunkDLQEHMXDMjs.__name)(firstForSequence, "firstForSequence");
function firstForBranching(prod) {
    const allAlternativesFirsts = (0, _chunkTZBO7MLIMjs.map_default)(prod.definition, (innerProd)=>{
        return first(innerProd);
    });
    return (0, _chunkTZBO7MLIMjs.uniq_default)((0, _chunkTZBO7MLIMjs.flatten_default)(allAlternativesFirsts));
}
(0, _chunkDLQEHMXDMjs.__name)(firstForBranching, "firstForBranching");
function firstForTerminal(terminal) {
    return [
        terminal.terminalType
    ];
}
(0, _chunkDLQEHMXDMjs.__name)(firstForTerminal, "firstForTerminal");
...
var ResyncFollowsWalker = class extends RestWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ResyncFollowsWalker");
    constructor(topProd){
        super();
...
function computeAllProdsFollows(topProductions) {
    const reSyncFollows = {};
    (0, _chunkTZBO7MLIMjs.forEach_default)(topProductions, (topProd)=>{
        const currRefsFollow = new ResyncFollowsWalker(topProd).startWalking();
        (0, _chunkTZBO7MLIMjs.assign_default)(reSyncFollows, currRefsFollow);
    });
    return reSyncFollows;
}
(0, _chunkDLQEHMXDMjs.__name)(computeAllProdsFollows, "computeAllProdsFollows");
function buildBetweenProdsFollowPrefix(inner, occurenceInParent) {
    return inner.name + occurenceInParent + IN;
}
(0, _chunkDLQEHMXDMjs.__name)(buildBetweenProdsFollowPrefix, "buildBetweenProdsFollowPrefix");
...
(0, _chunkDLQEHMXDMjs.__name)(getRegExpAst, "getRegExpAst");
function clearRegExpParserCache() {
    regExpAstCache = {};
}
(0, _chunkDLQEHMXDMjs.__name)(clearRegExpParserCache, "clearRegExpParserCache");
...
(0, _chunkDLQEHMXDMjs.__name)(getOptimizedStartCodesIndices, "getOptimizedStartCodesIndices");
function firstCharOptimizedIndices(ast, result, ignoreCase) {
            ...
            for(let i = 0; i < terms.length; i++){
                ...
                switch(atom2.type){
                    case "Character":
                        ...
                        break;
                    case "Set":
                        if (atom2.complement === true) throw Error(complementErrorMessage);
                        (0, _chunkTZBO7MLIMjs.forEach_default)(atom2.value, (code)=>{
    ...
    return (0, _chunkTZBO7MLIMjs.values_default)(result);
}
(0, _chunkDLQEHMXDMjs.__name)(firstCharOptimizedIndices, "firstCharOptimizedIndices");
function addOptimizedIdxToResult(code, result, ignoreCase) {
    const optimizedCharIdx = charCodeToOptimizedIndex(code);
    result[optimizedCharIdx] = optimizedCharIdx;
    if (ignoreCase === true) handleIgnoreCase(code, result);
}
(0, _chunkDLQEHMXDMjs.__name)(addOptimizedIdxToResult, "addOptimizedIdxToResult");
...
(0, _chunkDLQEHMXDMjs.__name)(handleIgnoreCase, "handleIgnoreCase");
function findCode(setNode, targetCharCodes) {
    return (0, _chunkTZBO7MLIMjs.find_default)(setNode.value, (codeOrRange)=>{
        if (typeof codeOrRange === "number") return (0, _chunkTZBO7MLIMjs.includes_default)(targetCharCodes, codeOrRange);
        else {
            const range = codeOrRange;
            return (0, _chunkTZBO7MLIMjs.find_default)(targetCharCodes, (targetCode)=>range.from <= targetCode && targetCode <= range.to) !== void 0;
        }
    });
}
(0, _chunkDLQEHMXDMjs.__name)(findCode, "findCode");
function isWholeOptional(ast) {
    const quantifier = ast.quantifier;
    if (quantifier && quantifier.atLeast === 0) return true;
    if (!ast.value) return false;
    return (0, _chunkHD3LK5B5Mjs.isArray_default)(ast.value) ? (0, _chunkTZBO7MLIMjs.every_default)(ast.value, isWholeOptional) : isWholeOptional(ast.value);
}
(0, _chunkDLQEHMXDMjs.__name)(isWholeOptional, "isWholeOptional");
var CharCodeFinder = class extends BaseRegExpVisitor {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "CharCodeFinder");
    ...
    visitCharacter(node) {
        if ((0, _chunkTZBO7MLIMjs.includes_default)(this.targetCharCodes, node.value)) this.found = true;
    }
    visitSet(node) {
        if (node.complement) {
...
function canMatchCharCode(charCodes, pattern) {
    ...
    } else return (0, _chunkTZBO7MLIMjs.find_default)(pattern, (char)=>{
        return (0, _chunkTZBO7MLIMjs.includes_default)(charCodes, char.charCodeAt(0));
    }) !== void 0;
}
(0, _chunkDLQEHMXDMjs.__name)(canMatchCharCode, "canMatchCharCode");
...
function analyzeTokenTypes(tokenTypes, options) {
    options = (0, _chunkTZBO7MLIMjs.defaults_default)(options, {
        ...
        tracer: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((msg, action)=>action(), "tracer")
    });
    ...
    tracer("Reject Lexer.NA", ()=>{
        onlyRelevantTypes = (0, _chunkTZBO7MLIMjs.reject_default)(tokenTypes, (currType)=>{
    ...
    tracer("Transform Patterns", ()=>{
        hasCustom = false;
        allTransformedPatterns = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, (currType)=>{
            const currPattern = currType[PATTERN];
            if ((0, _chunkTZBO7MLIMjs.isRegExp_default)(currPattern)) {
                const regExpSource = currPattern.source;
                if (regExpSource.length === 1 && // only these regExp meta characters which can appear in a length one regExp
                regExpSource !== "^" && regExpSource !== "$" && regExpSource !== "." && !currPattern.ignoreCase) return regExpSource;
                else if (regExpSource.length === 2 && regExpSource[0] === "\\" && // not a meta character
                !(0, _chunkTZBO7MLIMjs.includes_default)([
                    "d",
                    "D",
                    "s",
                    "S",
            ...
            } else if ((0, _chunkHD3LK5B5Mjs.isFunction_default)(currPattern)) {
                hasCustom = true;
                return {
                    exec: currPattern
                };
    ...
    tracer("misc mapping", ()=>{
        patternIdxToType = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, (currType)=>currType.tokenTypeIdx);
        patternIdxToGroup = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, (clazz)=>{
            const groupName = clazz.GROUP;
            if (groupName === Lexer.SKIPPED) return void 0;
            else if ((0, _chunkTZBO7MLIMjs.isString_default)(groupName)) return groupName;
            else if ((0, _chunkTZBO7MLIMjs.isUndefined_default)(groupName)) return false;
            else throw Error("non exhaustive match");
        });
        patternIdxToLongerAltIdxArr = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, (clazz)=>{
            const longerAltType = clazz.LONGER_ALT;
            if (longerAltType) {
                const longerAltIdxArr = (0, _chunkHD3LK5B5Mjs.isArray_default)(longerAltType) ? (0, _chunkTZBO7MLIMjs.map_default)(longerAltType, (type)=>(0, _chunkTZBO7MLIMjs.indexOf_default)(onlyRelevantTypes, type)) : [
                    (0, _chunkTZBO7MLIMjs.indexOf_default)(onlyRelevantTypes, longerAltType)
                ];
                return longerAltIdxArr;
            }
        });
        patternIdxToPushMode = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, (clazz)=>clazz.PUSH_MODE);
        patternIdxToPopMode = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, (clazz)=>(0, _chunkTZBO7MLIMjs.has_default)(clazz, "POP_MODE"));
    });
    let patternIdxToCanLineTerminator;
    tracer("Line Terminator Handling", ()=>{
        const lineTerminatorCharCodes = getCharCodes(options.lineTerminatorCharacters);
        patternIdxToCanLineTerminator = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, (tokType)=>false);
        if (options.positionTracking !== "onlyOffset") patternIdxToCanLineTerminator = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, (tokType)=>{
            if ((0, _chunkTZBO7MLIMjs.has_default)(tokType, "LINE_BREAKS")) return !!tokType.LINE_BREAKS;
    ...
    tracer("Misc Mapping #2", ()=>{
        patternIdxToIsCustom = (0, _chunkTZBO7MLIMjs.map_default)(onlyRelevantTypes, isCustomPattern);
        patternIdxToShort = (0, _chunkTZBO7MLIMjs.map_default)(allTransformedPatterns, isShortPattern);
        emptyGroups = (0, _chunkTZBO7MLIMjs.reduce_default)(onlyRelevantTypes, (acc, clazz)=>{
            const groupName = clazz.GROUP;
            if ((0, _chunkTZBO7MLIMjs.isString_default)(groupName) && !(groupName === Lexer.SKIPPED)) acc[groupName] = [];
            return acc;
        }, {});
        patternIdxToConfig = (0, _chunkTZBO7MLIMjs.map_default)(allTransformedPatterns, (x, idx)=>{
            return {
    ...
    if (!options.safeMode) tracer("First Char Optimization", ()=>{
        charCodeToPatternIdxToConfig = (0, _chunkTZBO7MLIMjs.reduce_default)(onlyRelevantTypes, (result, currTokType, idx)=>{
            if (typeof currTokType.PATTERN === "string") {
                const charCode = currTokType.PATTERN.charCodeAt(0);
                const optimizedIdx = charCodeToOptimizedIndex(charCode);
                addToMapOfArrays(result, optimizedIdx, patternIdxToConfig[idx]);
            } else if ((0, _chunkHD3LK5B5Mjs.isArray_default)(currTokType.START_CHARS_HINT)) {
                let lastOptimizedIdx;
                (0, _chunkTZBO7MLIMjs.forEach_default)(currTokType.START_CHARS_HINT, (charOrInt)=>{
            ...
            } else if ((0, _chunkTZBO7MLIMjs.isRegExp_default)(currTokType.PATTERN)) {
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
                    ...
                    if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(optimizedCodes)) canBeOptimized = false;
                    (0, _chunkTZBO7MLIMjs.forEach_default)(optimizedCodes, (code)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(analyzeTokenTypes, "analyzeTokenTypes");
...
(0, _chunkDLQEHMXDMjs.__name)(validatePatterns, "validatePatterns");
function validateRegExpPattern(tokenTypes) {
    let errors = [];
    const withRegExpPatterns = (0, _chunkTZBO7MLIMjs.filter_default)(tokenTypes, (currTokType)=>(0, _chunkTZBO7MLIMjs.isRegExp_default)(currTokType[PATTERN]));
...
(0, _chunkDLQEHMXDMjs.__name)(validateRegExpPattern, "validateRegExpPattern");
function findMissingPatterns(tokenTypes) {
    const tokenTypesWithMissingPattern = (0, _chunkTZBO7MLIMjs.filter_default)(tokenTypes, (currType)=>{
        return !(0, _chunkTZBO7MLIMjs.has_default)(currType, PATTERN);
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(tokenTypesWithMissingPattern, (currType)=>{
        return {
    ...
    const valid = (0, _chunkTZBO7MLIMjs.difference_default)(tokenTypes, tokenTypesWithMissingPattern);
    return {
        errors,
        valid
    };
}
(0, _chunkDLQEHMXDMjs.__name)(findMissingPatterns, "findMissingPatterns");
function findInvalidPatterns(tokenTypes) {
    const tokenTypesWithInvalidPattern = (0, _chunkTZBO7MLIMjs.filter_default)(tokenTypes, (currType)=>{
        const pattern = currType[PATTERN];
        return !(0, _chunkTZBO7MLIMjs.isRegExp_default)(pattern) && !(0, _chunkHD3LK5B5Mjs.isFunction_default)(pattern) && !(0, _chunkTZBO7MLIMjs.has_default)(pattern, "exec") && !(0, _chunkTZBO7MLIMjs.isString_default)(pattern);
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(tokenTypesWithInvalidPattern, (currType)=>{
        return {
    ...
    const valid = (0, _chunkTZBO7MLIMjs.difference_default)(tokenTypes, tokenTypesWithInvalidPattern);
    return {
        errors,
        valid
    };
}
(0, _chunkDLQEHMXDMjs.__name)(findInvalidPatterns, "findInvalidPatterns");
var end_of_input = /[^\\][$]/;
function findEndOfInputAnchor(tokenTypes) {
    class EndAnchorFinder extends BaseRegExpVisitor {
        static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "EndAnchorFinder");
        constructor(){
            super(...arguments);
            this.found = false;
        }
    ...
    const invalidRegex = (0, _chunkTZBO7MLIMjs.filter_default)(tokenTypes, (currType)=>{
        const pattern = currType.PATTERN;
        try {
    ...
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(invalidRegex, (currType)=>{
        return {
...
(0, _chunkDLQEHMXDMjs.__name)(findEndOfInputAnchor, "findEndOfInputAnchor");
function findEmptyMatchRegExps(tokenTypes) {
    const matchesEmptyString = (0, _chunkTZBO7MLIMjs.filter_default)(tokenTypes, (currType)=>{
        const pattern = currType.PATTERN;
        return pattern.test("");
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(matchesEmptyString, (currType)=>{
        return {
...
(0, _chunkDLQEHMXDMjs.__name)(findEmptyMatchRegExps, "findEmptyMatchRegExps");
var start_of_input = /[^\\[][\^]|^\^/;
function findStartOfInputAnchor(tokenTypes) {
    class StartAnchorFinder extends BaseRegExpVisitor {
        static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "StartAnchorFinder");
        constructor(){
            super(...arguments);
            this.found = false;
        }
...
(0, _chunkDLQEHMXDMjs.__name)(findStartOfInputAnchor, "findStartOfInputAnchor");
function findUnsupportedFlags(tokenTypes) {
    const invalidFlags = (0, _chunkTZBO7MLIMjs.filter_default)(tokenTypes, (currType)=>{
        const pattern = currType[PATTERN];
        return pattern instanceof RegExp && (pattern.multiline || pattern.global);
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(invalidFlags, (currType)=>{
        return {
...
(0, _chunkDLQEHMXDMjs.__name)(findUnsupportedFlags, "findUnsupportedFlags");
function findDuplicatePatterns(tokenTypes) {
    const found = [];
    let identicalPatterns = (0, _chunkTZBO7MLIMjs.map_default)(tokenTypes, (outerType)=>{
        return (0, _chunkTZBO7MLIMjs.reduce_default)(tokenTypes, (result, innerType)=>{
            if (outerType.PATTERN.source === innerType.PATTERN.source && !(0, _chunkTZBO7MLIMjs.includes_default)(found, innerType) && innerType.PATTERN !== Lexer.NA) {
    ...
    identicalPatterns = (0, _chunkTZBO7MLIMjs.compact_default)(identicalPatterns);
    const duplicatePatterns = (0, _chunkTZBO7MLIMjs.filter_default)(identicalPatterns, (currIdenticalSet)=>{
        return currIdenticalSet.length > 1;
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(duplicatePatterns, (setOfIdentical)=>{
        const tokenTypeNames = (0, _chunkTZBO7MLIMjs.map_default)(setOfIdentical, (currType)=>{
            return currType.name;
        });
        const dupPatternSrc = (0, _chunkTZBO7MLIMjs.head_default)(setOfIdentical).PATTERN;
        return {
...
(0, _chunkDLQEHMXDMjs.__name)(findDuplicatePatterns, "findDuplicatePatterns");
function findInvalidGroupType(tokenTypes) {
    const invalidTypes = (0, _chunkTZBO7MLIMjs.filter_default)(tokenTypes, (clazz)=>{
        if (!(0, _chunkTZBO7MLIMjs.has_default)(clazz, "GROUP")) return false;
        const group = clazz.GROUP;
        return group !== Lexer.SKIPPED && group !== Lexer.NA && !(0, _chunkTZBO7MLIMjs.isString_default)(group);
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(invalidTypes, (currType)=>{
        return {
...
(0, _chunkDLQEHMXDMjs.__name)(findInvalidGroupType, "findInvalidGroupType");
function findModesThatDoNotExist(tokenTypes, validModes) {
    const invalidModes = (0, _chunkTZBO7MLIMjs.filter_default)(tokenTypes, (clazz)=>{
        return clazz.PUSH_MODE !== void 0 && !(0, _chunkTZBO7MLIMjs.includes_default)(validModes, clazz.PUSH_MODE);
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(invalidModes, (tokType)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(findModesThatDoNotExist, "findModesThatDoNotExist");
function findUnreachablePatterns(tokenTypes) {
    const errors = [];
    const canBeTested = (0, _chunkTZBO7MLIMjs.reduce_default)(tokenTypes, (result, tokType, idx)=>{
        const pattern = tokType.PATTERN;
        if (pattern === Lexer.NA) return result;
        if ((0, _chunkTZBO7MLIMjs.isString_default)(pattern)) result.push({
            str: pattern,
            idx,
            tokenType: tokType
        });
        else if ((0, _chunkTZBO7MLIMjs.isRegExp_default)(pattern) && noMetaChar(pattern)) result.push({
            str: pattern.source,
            idx,
            tokenType: tokType
        });
    ...
    (0, _chunkTZBO7MLIMjs.forEach_default)(tokenTypes, (tokType, testIdx)=>{
        (0, _chunkTZBO7MLIMjs.forEach_default)(canBeTested, ({ str, idx, tokenType })=>{
...
(0, _chunkDLQEHMXDMjs.__name)(findUnreachablePatterns, "findUnreachablePatterns");
function testTokenType(str, pattern) {
    if ((0, _chunkTZBO7MLIMjs.isRegExp_default)(pattern)) {
        const regExpArray = pattern.exec(str);
        return regExpArray !== null && regExpArray.index === 0;
    } else if ((0, _chunkHD3LK5B5Mjs.isFunction_default)(pattern)) return pattern(str, 0, [], {});
    else if ((0, _chunkTZBO7MLIMjs.has_default)(pattern, "exec")) return pattern.exec(str, 0, [], {});
    else if (typeof pattern === "string") return pattern === str;
    else throw Error("non exhaustive match");
}
(0, _chunkDLQEHMXDMjs.__name)(testTokenType, "testTokenType");
function noMetaChar(regExp) {
    ...
    return (0, _chunkTZBO7MLIMjs.find_default)(metaChars, (char)=>regExp.source.indexOf(char) !== -1) === void 0;
}
(0, _chunkDLQEHMXDMjs.__name)(noMetaChar, "noMetaChar");
function addStartOfInput(pattern) {
    const flags = pattern.ignoreCase ? "i" : "";
    return new RegExp(`^(?:${pattern.source})`, flags);
}
(0, _chunkDLQEHMXDMjs.__name)(addStartOfInput, "addStartOfInput");
function addStickyFlag(pattern) {
    const flags = pattern.ignoreCase ? "iy" : "y";
    return new RegExp(`${pattern.source}`, flags);
}
(0, _chunkDLQEHMXDMjs.__name)(addStickyFlag, "addStickyFlag");
function performRuntimeChecks(lexerDefinition, trackLines, lineTerminatorCharacters) {
    const errors = [];
    if (!(0, _chunkTZBO7MLIMjs.has_default)(lexerDefinition, DEFAULT_MODE)) errors.push({
        message: "A MultiMode Lexer cannot be initialized without a <" + DEFAULT_MODE + "> property in its definition\n",
        type: LexerDefinitionErrorType.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE
    });
    if (!(0, _chunkTZBO7MLIMjs.has_default)(lexerDefinition, MODES)) errors.push({
        message: "A MultiMode Lexer cannot be initialized without a <" + MODES + "> property in its definition\n",
        type: LexerDefinitionErrorType.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY
    });
    if ((0, _chunkTZBO7MLIMjs.has_default)(lexerDefinition, MODES) && (0, _chunkTZBO7MLIMjs.has_default)(lexerDefinition, DEFAULT_MODE) && !(0, _chunkTZBO7MLIMjs.has_default)(lexerDefinition.modes, lexerDefinition.defaultMode)) errors.push({
        message: `A MultiMode Lexer cannot be initialized with a ${DEFAULT_MODE}: <${lexerDefinition.defaultMode}>which does not exist
`,
        type: LexerDefinitionErrorType.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST
    });
    if ((0, _chunkTZBO7MLIMjs.has_default)(lexerDefinition, MODES)) (0, _chunkTZBO7MLIMjs.forEach_default)(lexerDefinition.modes, (currModeValue, currModeName)=>{
        (0, _chunkTZBO7MLIMjs.forEach_default)(currModeValue, (currTokType, currIdx)=>{
            if ((0, _chunkTZBO7MLIMjs.isUndefined_default)(currTokType)) errors.push({
                message: `A Lexer cannot be initialized using an undefined Token Type. Mode:<${currModeName}> at index: <${currIdx}>
`,
                type: LexerDefinitionErrorType.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED
            });
            else if ((0, _chunkTZBO7MLIMjs.has_default)(currTokType, "LONGER_ALT")) {
                const longerAlt = (0, _chunkHD3LK5B5Mjs.isArray_default)(currTokType.LONGER_ALT) ? currTokType.LONGER_ALT : [
                    currTokType.LONGER_ALT
                ];
                (0, _chunkTZBO7MLIMjs.forEach_default)(longerAlt, (currLongerAlt)=>{
                    if (!(0, _chunkTZBO7MLIMjs.isUndefined_default)(currLongerAlt) && !(0, _chunkTZBO7MLIMjs.includes_default)(currModeValue, currLongerAlt)) errors.push({
...
(0, _chunkDLQEHMXDMjs.__name)(performRuntimeChecks, "performRuntimeChecks");
function performWarningRuntimeChecks(lexerDefinition, trackLines, lineTerminatorCharacters) {
    const warnings = [];
    let hasAnyLineBreak = false;
    const allTokenTypes = (0, _chunkTZBO7MLIMjs.compact_default)((0, _chunkTZBO7MLIMjs.flatten_default)((0, _chunkTZBO7MLIMjs.values_default)(lexerDefinition.modes)));
    const concreteTokenTypes = (0, _chunkTZBO7MLIMjs.reject_default)(allTokenTypes, (currType)=>currType[PATTERN] === Lexer.NA);
    const terminatorCharCodes = getCharCodes(lineTerminatorCharacters);
    if (trackLines) (0, _chunkTZBO7MLIMjs.forEach_default)(concreteTokenTypes, (tokType)=>{
        ...
        if (currIssue !== false) {
            ...
            if ((0, _chunkTZBO7MLIMjs.has_default)(tokType, "LINE_BREAKS")) {
...
(0, _chunkDLQEHMXDMjs.__name)(performWarningRuntimeChecks, "performWarningRuntimeChecks");
function cloneEmptyGroups(emptyGroups) {
    const clonedResult = {};
    const groupKeys = (0, _chunkTZBO7MLIMjs.keys_default)(emptyGroups);
    (0, _chunkTZBO7MLIMjs.forEach_default)(groupKeys, (currKey)=>{
        const currGroupValue = emptyGroups[currKey];
        if ((0, _chunkHD3LK5B5Mjs.isArray_default)(currGroupValue)) clonedResult[currKey] = [];
        else throw Error("non exhaustive match");
    });
    return clonedResult;
}
(0, _chunkDLQEHMXDMjs.__name)(cloneEmptyGroups, "cloneEmptyGroups");
function isCustomPattern(tokenType) {
    const pattern = tokenType.PATTERN;
    if ((0, _chunkTZBO7MLIMjs.isRegExp_default)(pattern)) return false;
    else if ((0, _chunkHD3LK5B5Mjs.isFunction_default)(pattern)) return true;
    else if ((0, _chunkTZBO7MLIMjs.has_default)(pattern, "exec")) return true;
    else if ((0, _chunkTZBO7MLIMjs.isString_default)(pattern)) return false;
    else throw Error("non exhaustive match");
}
(0, _chunkDLQEHMXDMjs.__name)(isCustomPattern, "isCustomPattern");
function isShortPattern(pattern) {
    if ((0, _chunkTZBO7MLIMjs.isString_default)(pattern) && pattern.length === 1) return pattern.charCodeAt(0);
    else return false;
}
(0, _chunkDLQEHMXDMjs.__name)(isShortPattern, "isShortPattern");
var LineTerminatorOptimizedTester = {
    // implements /\n|\r\n?/g.test
    test: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(text) {
...
function checkLineBreaksIssues(tokType, lineTerminatorCharCodes) {
    if ((0, _chunkTZBO7MLIMjs.has_default)(tokType, "LINE_BREAKS")) return false;
    else {
        if ((0, _chunkTZBO7MLIMjs.isRegExp_default)(tokType.PATTERN)) {
            try {
            ...
            return false;
        } else if ((0, _chunkTZBO7MLIMjs.isString_default)(tokType.PATTERN)) return false;
        else if (isCustomPattern(tokType)) return {
            issue: LexerDefinitionErrorType.CUSTOM_LINE_BREAK
        };
        else throw Error("non exhaustive match");
    }
}
(0, _chunkDLQEHMXDMjs.__name)(checkLineBreaksIssues, "checkLineBreaksIssues");
...
(0, _chunkDLQEHMXDMjs.__name)(buildLineBreakIssueMessage, "buildLineBreakIssueMessage");
function getCharCodes(charsOrCodes) {
    const charCodes = (0, _chunkTZBO7MLIMjs.map_default)(charsOrCodes, (numOrString)=>{
        if ((0, _chunkTZBO7MLIMjs.isString_default)(numOrString)) return numOrString.charCodeAt(0);
        else return numOrString;
    });
    return charCodes;
}
(0, _chunkDLQEHMXDMjs.__name)(getCharCodes, "getCharCodes");
...
(0, _chunkDLQEHMXDMjs.__name)(addToMapOfArrays, "addToMapOfArrays");
var minOptimizationVal = 256;
var charCodeToOptimizedIdxMap = [];
function charCodeToOptimizedIndex(charCode) {
    return charCode < minOptimizationVal ? charCode : charCodeToOptimizedIdxMap[charCode];
}
(0, _chunkDLQEHMXDMjs.__name)(charCodeToOptimizedIndex, "charCodeToOptimizedIndex");
function initCharCodeToOptimizedIndexMap() {
    if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(charCodeToOptimizedIdxMap)) {
        charCodeToOptimizedIdxMap = new Array(65536);
        for(let i = 0; i < 65536; i++)charCodeToOptimizedIdxMap[i] = i > 255 ? 255 + ~~(i / 255) : i;
    }
}
(0, _chunkDLQEHMXDMjs.__name)(initCharCodeToOptimizedIndexMap, "initCharCodeToOptimizedIndexMap");
...
(0, _chunkDLQEHMXDMjs.__name)(tokenStructuredMatcher, "tokenStructuredMatcher");
function tokenStructuredMatcherNoCategories(token, tokType) {
    return token.tokenTypeIdx === tokType.tokenTypeIdx;
}
(0, _chunkDLQEHMXDMjs.__name)(tokenStructuredMatcherNoCategories, "tokenStructuredMatcherNoCategories");
...
function augmentTokenTypes(tokenTypes) {
    ...
    (0, _chunkTZBO7MLIMjs.forEach_default)(tokenTypesAndParents, (tokType)=>{
        tokType.isParent = tokType.categoryMatches.length > 0;
    });
}
(0, _chunkDLQEHMXDMjs.__name)(augmentTokenTypes, "augmentTokenTypes");
function expandCategories(tokenTypes) {
    let result = (0, _chunkTZBO7MLIMjs.clone_default)(tokenTypes);
    let categories = tokenTypes;
    let searching = true;
    while(searching){
        categories = (0, _chunkTZBO7MLIMjs.compact_default)((0, _chunkTZBO7MLIMjs.flatten_default)((0, _chunkTZBO7MLIMjs.map_default)(categories, (currTokType)=>currTokType.CATEGORIES)));
        const newCategories = (0, _chunkTZBO7MLIMjs.difference_default)(categories, result);
        result = result.concat(newCategories);
        if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(newCategories)) searching = false;
        else categories = newCategories;
    }
    return result;
}
(0, _chunkDLQEHMXDMjs.__name)(expandCategories, "expandCategories");
function assignTokenDefaultProps(tokenTypes) {
    (0, _chunkTZBO7MLIMjs.forEach_default)(tokenTypes, (currTokType)=>{
        if (!hasShortKeyProperty(currTokType)) {
            tokenIdxToClass[tokenShortNameIdx] = currTokType;
            currTokType.tokenTypeIdx = tokenShortNameIdx++;
        }
        if (hasCategoriesProperty(currTokType) && !(0, _chunkHD3LK5B5Mjs.isArray_default)(currTokType.CATEGORIES)) currTokType.CATEGORIES = [
...
(0, _chunkDLQEHMXDMjs.__name)(assignTokenDefaultProps, "assignTokenDefaultProps");
function assignCategoriesTokensProp(tokenTypes) {
    (0, _chunkTZBO7MLIMjs.forEach_default)(tokenTypes, (currTokType)=>{
        currTokType.categoryMatches = [];
        (0, _chunkTZBO7MLIMjs.forEach_default)(currTokType.categoryMatchesMap, (val, key)=>{
            currTokType.categoryMatches.push(tokenIdxToClass[key].tokenTypeIdx);
        });
    });
}
(0, _chunkDLQEHMXDMjs.__name)(assignCategoriesTokensProp, "assignCategoriesTokensProp");
function assignCategoriesMapProp(tokenTypes) {
    (0, _chunkTZBO7MLIMjs.forEach_default)(tokenTypes, (currTokType)=>{
        singleAssignCategoriesToksMap([], currTokType);
    });
}
(0, _chunkDLQEHMXDMjs.__name)(assignCategoriesMapProp, "assignCategoriesMapProp");
function singleAssignCategoriesToksMap(path, nextNode) {
    (0, _chunkTZBO7MLIMjs.forEach_default)(path, (pathNode)=>{
        nextNode.categoryMatchesMap[pathNode.tokenTypeIdx] = true;
    });
    (0, _chunkTZBO7MLIMjs.forEach_default)(nextNode.CATEGORIES, (nextCategory)=>{
        const newPath = path.concat(nextNode);
        if (!(0, _chunkTZBO7MLIMjs.includes_default)(newPath, nextCategory)) singleAssignCategoriesToksMap(newPath, nextCategory);
    });
}
(0, _chunkDLQEHMXDMjs.__name)(singleAssignCategoriesToksMap, "singleAssignCategoriesToksMap");
function hasShortKeyProperty(tokType) {
    return (0, _chunkTZBO7MLIMjs.has_default)(tokType, "tokenTypeIdx");
}
(0, _chunkDLQEHMXDMjs.__name)(hasShortKeyProperty, "hasShortKeyProperty");
function hasCategoriesProperty(tokType) {
    return (0, _chunkTZBO7MLIMjs.has_default)(tokType, "CATEGORIES");
}
(0, _chunkDLQEHMXDMjs.__name)(hasCategoriesProperty, "hasCategoriesProperty");
function hasExtendingTokensTypesProperty(tokType) {
    return (0, _chunkTZBO7MLIMjs.has_default)(tokType, "categoryMatches");
}
(0, _chunkDLQEHMXDMjs.__name)(hasExtendingTokensTypesProperty, "hasExtendingTokensTypesProperty");
function hasExtendingTokensTypesMapProperty(tokType) {
    return (0, _chunkTZBO7MLIMjs.has_default)(tokType, "categoryMatchesMap");
}
(0, _chunkDLQEHMXDMjs.__name)(hasExtendingTokensTypesMapProperty, "hasExtendingTokensTypesMapProperty");
function isTokenType(tokType) {
    return (0, _chunkTZBO7MLIMjs.has_default)(tokType, "tokenTypeIdx");
}
(0, _chunkDLQEHMXDMjs.__name)(isTokenType, "isTokenType");
...
var Lexer = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Lexer");
    constructor(lexerDefinition, config = DEFAULT_LEXER_CONFIG){
        ...
        this.config = (0, _chunkTZBO7MLIMjs.assign_default)({}, DEFAULT_LEXER_CONFIG, config);
        ...
        this.TRACE_INIT("Lexer Constructor", ()=>{
            ...
            this.TRACE_INIT("Lexer Config handling", ()=>{
                if (this.config.lineTerminatorsPattern === DEFAULT_LEXER_CONFIG.lineTerminatorsPattern) this.config.lineTerminatorsPattern = LineTerminatorOptimizedTester;
                    ...
                    if (this.config.lineTerminatorCharacters === DEFAULT_LEXER_CONFIG.lineTerminatorCharacters) throw Error("Error: Missing <lineTerminatorCharacters> property on the Lexer config.\n	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS");
                }
                ...
                if ((0, _chunkHD3LK5B5Mjs.isArray_default)(lexerDefinition)) actualDefinition = {
                    modes: {
                        defaultMode: (0, _chunkTZBO7MLIMjs.clone_default)(lexerDefinition)
                    },
                    defaultMode: DEFAULT_MODE
                };
                else {
                    hasOnlySingleMode = false;
                    actualDefinition = (0, _chunkTZBO7MLIMjs.clone_default)(lexerDefinition);
                }
            });
            ...
            (0, _chunkTZBO7MLIMjs.forEach_default)(actualDefinition.modes, (currModeValue, currModeName)=>{
                actualDefinition.modes[currModeName] = (0, _chunkTZBO7MLIMjs.reject_default)(currModeValue, (currTokType)=>(0, _chunkTZBO7MLIMjs.isUndefined_default)(currTokType));
            });
            const allModeNames = (0, _chunkTZBO7MLIMjs.keys_default)(actualDefinition.modes);
            (0, _chunkTZBO7MLIMjs.forEach_default)(actualDefinition.modes, (currModDef, currModName)=>{
                this.TRACE_INIT(`Mode: <${currModName}> processing`, ()=>{
                    this.modes.push(currModName);
                    if (this.config.skipValidations === false) this.TRACE_INIT(`validatePatterns`, ()=>{
                        this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(validatePatterns(currModDef, allModeNames));
                    });
                    if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(this.lexerDefinitionErrors)) {
                        ...
                        this.emptyGroups = (0, _chunkTZBO7MLIMjs.assign_default)({}, this.emptyGroups, currAnalyzeResult.emptyGroups);
            ...
            if (!(0, _chunkGRZAG2UZMjs.isEmpty_default)(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
                const allErrMessages = (0, _chunkTZBO7MLIMjs.map_default)(this.lexerDefinitionErrors, (error)=>{
                    return error.message;
                });
                const allErrMessagesString = allErrMessages.join("-----------------------\n");
                throw new Error("Errors detected in definition of Lexer:\n" + allErrMessagesString);
            }
            (0, _chunkTZBO7MLIMjs.forEach_default)(this.lexerDefinitionWarning, (warningDescriptor)=>{
                PRINT_WARNING(warningDescriptor.message);
            });
            this.TRACE_INIT("Choosing sub-methods implementations", ()=>{
                if (SUPPORT_STICKY) {
                    this.chopInput = (0, _chunkHD3LK5B5Mjs.identity_default);
                    this.match = this.matchWithTest;
                } else {
                    this.updateLastIndex = (0, _chunkTZBO7MLIMjs.noop_default);
                    this.match = this.matchWithExec;
                }
                if (hasOnlySingleMode) this.handleModes = (0, _chunkTZBO7MLIMjs.noop_default);
                if (this.trackStartLines === false) this.computeNewColumn = (0, _chunkHD3LK5B5Mjs.identity_default);
                if (this.trackEndLines === false) this.updateTokenEndLineColumnLocation = (0, _chunkTZBO7MLIMjs.noop_default);
            ...
            this.TRACE_INIT("Failed Optimization Warnings", ()=>{
                const unOptimizedModes = (0, _chunkTZBO7MLIMjs.reduce_default)(this.canModeBeOptimized, (cannotBeOptimized, canBeOptimized, modeName)=>{
                    if (canBeOptimized === false) cannotBeOptimized.push(modeName);
                    return cannotBeOptimized;
                }, []);
                if (config.ensureOptimizations && !(0, _chunkGRZAG2UZMjs.isEmpty_default)(unOptimizedModes)) throw Error(`Lexer Modes: < ${unOptimizedModes.join(", ")} > cannot be optimized.
    ...
    tokenizeInternal(text, initialMode) {
        ...
        (0, _chunkDLQEHMXDMjs.__name)(getPossiblePatternsSlow, "getPossiblePatternsSlow");
        ...
        (0, _chunkDLQEHMXDMjs.__name)(getPossiblePatternsOptimized, "getPossiblePatternsOptimized");
        const pop_mode = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((popToken)=>{
            ...
            popToken.tokenType.PUSH_MODE === void 0) {
                ...
                modeStack.pop();
                const newMode = (0, _chunkTZBO7MLIMjs.last_default)(modeStack);
        ...
        (0, _chunkDLQEHMXDMjs.__name)(push_mode, "push_mode");
...
function tokenLabel2(tokType) {
    if (hasTokenLabel2(tokType)) return tokType.LABEL;
    else return tokType.name;
}
(0, _chunkDLQEHMXDMjs.__name)(tokenLabel2, "tokenLabel");
function hasTokenLabel2(obj) {
    return (0, _chunkTZBO7MLIMjs.isString_default)(obj.LABEL) && obj.LABEL !== "";
}
(0, _chunkDLQEHMXDMjs.__name)(hasTokenLabel2, "hasTokenLabel");
var PARENT = "parent";
...
(0, _chunkDLQEHMXDMjs.__name)(createToken, "createToken");
function createTokenInternal(config) {
    const pattern = config.pattern;
    const tokenType = {};
    tokenType.name = config.name;
    if (!(0, _chunkTZBO7MLIMjs.isUndefined_default)(pattern)) tokenType.PATTERN = pattern;
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, PARENT)) throw "The parent property is no longer supported.\nSee: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.";
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, CATEGORIES)) tokenType.CATEGORIES = config[CATEGORIES];
    augmentTokenTypes([
        tokenType
    ]);
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, LABEL)) tokenType.LABEL = config[LABEL];
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, GROUP)) tokenType.GROUP = config[GROUP];
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, POP_MODE)) tokenType.POP_MODE = config[POP_MODE];
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, PUSH_MODE)) tokenType.PUSH_MODE = config[PUSH_MODE];
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, LONGER_ALT)) tokenType.LONGER_ALT = config[LONGER_ALT];
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, LINE_BREAKS)) tokenType.LINE_BREAKS = config[LINE_BREAKS];
    if ((0, _chunkTZBO7MLIMjs.has_default)(config, START_CHARS_HINT)) tokenType.START_CHARS_HINT = config[START_CHARS_HINT];
    return tokenType;
}
(0, _chunkDLQEHMXDMjs.__name)(createTokenInternal, "createTokenInternal");
var EOF = createToken({
    name: "EOF",
    pattern: Lexer.NA
});
...
(0, _chunkDLQEHMXDMjs.__name)(createTokenInstance, "createTokenInstance");
function tokenMatcher(token, tokType) {
    return tokenStructuredMatcher(token, tokType);
}
(0, _chunkDLQEHMXDMjs.__name)(tokenMatcher, "tokenMatcher");
...
var defaultParserErrorProvider = {
    ...
    buildNoViableAltMessage ({ expectedPathsPerAlt, actual, previous, customUserDescription, ruleName }) {
        ...
        const actualText = (0, _chunkTZBO7MLIMjs.head_default)(actual).image;
        const errSuffix = "\nbut found: '" + actualText + "'";
        if (customUserDescription) return errPrefix + customUserDescription + errSuffix;
        else {
            const allLookAheadPaths = (0, _chunkTZBO7MLIMjs.reduce_default)(expectedPathsPerAlt, (result, currAltPaths)=>result.concat(currAltPaths), []);
            const nextValidTokenSequences = (0, _chunkTZBO7MLIMjs.map_default)(allLookAheadPaths, (currPath)=>`[${(0, _chunkTZBO7MLIMjs.map_default)(currPath, (currTokenType)=>tokenLabel2(currTokenType)).join(", ")}]`);
            const nextValidSequenceItems = (0, _chunkTZBO7MLIMjs.map_default)(nextValidTokenSequences, (itemMsg, idx)=>`  ${idx + 1}. ${itemMsg}`);
...
${nextValidSequenceItems.join("\n")}`;
    ...
    buildEarlyExitMessage ({ expectedIterationPaths, actual, customUserDescription, ruleName }) {
        ...
        if (customUserDescription) return errPrefix + customUserDescription + errSuffix;
            ...
            const nextValidTokenSequences = (0, _chunkTZBO7MLIMjs.map_default)(expectedIterationPaths, (currPath)=>`[${(0, _chunkTZBO7MLIMjs.map_default)(currPath, (currTokenType)=>tokenLabel2(currTokenType)).join(",")}]`);
...
var defaultGrammarValidatorErrorProvider = {
    buildDuplicateFoundError (topLevelRule, duplicateProds) {
        ...
        (0, _chunkDLQEHMXDMjs.__name)(getExtraProductionArgument2, "getExtraProductionArgument");
        const topLevelName = topLevelRule.name;
        const duplicateProd = (0, _chunkTZBO7MLIMjs.head_default)(duplicateProds);
...
and Non-Terminal names start with a lower case letter.`;
    ...
    buildAlternationPrefixAmbiguityError (options) {
        const pathMsg = (0, _chunkTZBO7MLIMjs.map_default)(options.prefixPath, (currTok)=>tokenLabel2(currTok)).join(", ");
...
<OR${options.alternation.idx}> inside <${options.topLevelRule.name}> Rule.
 has ${options.alternation.definition.length + 1} alternatives.`;
    ...
    buildLeftRecursionError (options) {
        ...
        const pathNames = (0, _chunkTZBO7MLIMjs.map_default)(options.leftRecursionPath, (currRule)=>currRule.name);
...
(0, _chunkDLQEHMXDMjs.__name)(resolveGrammar, "resolveGrammar");
var GastRefResolverVisitor = class extends GAstVisitor {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "GastRefResolverVisitor");
    ...
    resolveRefs() {
        (0, _chunkTZBO7MLIMjs.forEach_default)((0, _chunkTZBO7MLIMjs.values_default)(this.nameToTopRule), (prod)=>{
...
var AbstractNextPossibleTokensWalker = class extends RestWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractNextPossibleTokensWalker");
    ...
    startWalking() {
        ...
        this.ruleStack = (0, _chunkTZBO7MLIMjs.clone_default)(this.path.ruleStack).reverse();
        this.occurrenceStack = (0, _chunkTZBO7MLIMjs.clone_default)(this.path.occurrenceStack).reverse();
        this.ruleStack.pop();
    ...
    updateExpectedNext() {
        if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(this.ruleStack)) {
            this.nextProductionName = "";
            this.nextProductionOccurrence = 0;
...
var NextAfterTokenWalker = class extends AbstractNextPossibleTokensWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "NextAfterTokenWalker");
    constructor(topProd, path){
        super(topProd, path);
        this.path = path;
...
var AbstractNextTerminalAfterProductionWalker = class extends RestWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractNextTerminalAfterProductionWalker");
...
var NextTerminalAfterManyWalker = class extends AbstractNextTerminalAfterProductionWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "NextTerminalAfterManyWalker");
    walkMany(manyProd, currRest, prevRest) {
        if (manyProd.idx === this.occurrence) {
            const firstAfterMany = (0, _chunkTZBO7MLIMjs.head_default)(currRest.concat(prevRest));
...
var NextTerminalAfterManySepWalker = class extends AbstractNextTerminalAfterProductionWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "NextTerminalAfterManySepWalker");
    walkManySep(manySepProd, currRest, prevRest) {
        if (manySepProd.idx === this.occurrence) {
            const firstAfterManySep = (0, _chunkTZBO7MLIMjs.head_default)(currRest.concat(prevRest));
...
var NextTerminalAfterAtLeastOneWalker = class extends AbstractNextTerminalAfterProductionWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "NextTerminalAfterAtLeastOneWalker");
    walkAtLeastOne(atLeastOneProd, currRest, prevRest) {
        if (atLeastOneProd.idx === this.occurrence) {
            const firstAfterAtLeastOne = (0, _chunkTZBO7MLIMjs.head_default)(currRest.concat(prevRest));
...
var NextTerminalAfterAtLeastOneSepWalker = class extends AbstractNextTerminalAfterProductionWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "NextTerminalAfterAtLeastOneSepWalker");
    walkAtLeastOneSep(atleastOneSepProd, currRest, prevRest) {
        if (atleastOneSepProd.idx === this.occurrence) {
            const firstAfterfirstAfterAtLeastOneSep = (0, _chunkTZBO7MLIMjs.head_default)(currRest.concat(prevRest));
...
function possiblePathsFrom(targetDef, maxLength, currPath = []) {
    currPath = (0, _chunkTZBO7MLIMjs.clone_default)(currPath);
    let result = [];
    let i = 0;
    function remainingPathWith(nextDef) {
        return nextDef.concat((0, _chunkTZBO7MLIMjs.drop_default)(targetDef, i + 1));
    }
    (0, _chunkDLQEHMXDMjs.__name)(remainingPathWith, "remainingPathWith");
    function getAlternativesForProd(definition) {
        const alternatives = possiblePathsFrom(remainingPathWith(definition), maxLength, currPath);
        return result.concat(alternatives);
    }
    (0, _chunkDLQEHMXDMjs.__name)(getAlternativesForProd, "getAlternativesForProd");
    while(currPath.length < maxLength && i < targetDef.length){
        ...
        if (prod instanceof Alternative) return getAlternativesForProd(prod.definition);
            ...
            (0, _chunkTZBO7MLIMjs.forEach_default)(prod.definition, (currAlt)=>{
                if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(currAlt.definition) === false) result = getAlternativesForProd(currAlt.definition);
            });
            return result;
    ...
    result.push({
        ...
        suffixDef: (0, _chunkTZBO7MLIMjs.drop_default)(targetDef, i)
    });
    return result;
}
(0, _chunkDLQEHMXDMjs.__name)(possiblePathsFrom, "possiblePathsFrom");
function nextPossibleTokensAfter(initialDef, tokenVector, tokMatcher, maxLookAhead) {
    ...
    while(!(0, _chunkGRZAG2UZMjs.isEmpty_default)(possiblePaths)){
        const currPath = possiblePaths.pop();
        if (currPath === EXIT_ALTERNATIVE) {
            if (foundCompletePath && (0, _chunkTZBO7MLIMjs.last_default)(possiblePaths).idx <= minimalAlternativesIndex) possiblePaths.pop();
            continue;
        }
        ...
        if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(currDef)) continue;
        const prod = currDef[0];
        if (prod === EXIT_NON_TERMINAL) {
            const nextPath = {
                idx: currIdx,
                def: (0, _chunkTZBO7MLIMjs.drop_default)(currDef),
                ruleStack: (0, _chunkTZBO7MLIMjs.dropRight_default)(currRuleStack),
                occurrenceStack: (0, _chunkTZBO7MLIMjs.dropRight_default)(currOccurrenceStack)
            };
            ...
            const newRuleStack = (0, _chunkTZBO7MLIMjs.clone_default)(currRuleStack);
            newRuleStack.push(prod.nonTerminalName);
            const newOccurrenceStack = (0, _chunkTZBO7MLIMjs.clone_default)(currOccurrenceStack);
            newOccurrenceStack.push(prod.idx);
            const nextPath = {
                idx: currIdx,
                def: prod.definition.concat(EXIT_NON_TERMINAL_ARR, (0, _chunkTZBO7MLIMjs.drop_default)(currDef)),
            ...
            const nextPathWith = {
                idx: currIdx,
                def: prod.definition.concat((0, _chunkTZBO7MLIMjs.drop_default)(currDef)),
                ruleStack: currRuleStack,
                occurrenceStack: currOccurrenceStack
            };
            ...
            const nextDef = prod.definition.concat([
                secondIteration
            ], (0, _chunkTZBO7MLIMjs.drop_default)(currDef));
            const nextPath = {
                idx: currIdx,
                def: nextDef,
                ruleStack: currRuleStack,
            ...
            const currAltPath = {
                idx: currIdx,
                def: currAlt.definition.concat((0, _chunkTZBO7MLIMjs.drop_default)(currDef)),
                ruleStack: currRuleStack,
                occurrenceStack: currOccurrenceStack
            };
...
(0, _chunkDLQEHMXDMjs.__name)(nextPossibleTokensAfter, "nextPossibleTokensAfter");
function expandTopLevelRule(topRule, currIdx, currRuleStack, currOccurrenceStack) {
    const newRuleStack = (0, _chunkTZBO7MLIMjs.clone_default)(currRuleStack);
    newRuleStack.push(topRule.name);
    const newCurrOccurrenceStack = (0, _chunkTZBO7MLIMjs.clone_default)(currOccurrenceStack);
...
(0, _chunkDLQEHMXDMjs.__name)(expandTopLevelRule, "expandTopLevelRule");
...
(0, _chunkDLQEHMXDMjs.__name)(getProdType, "getProdType");
...
(0, _chunkDLQEHMXDMjs.__name)(getLookaheadPaths, "getLookaheadPaths");
...
(0, _chunkDLQEHMXDMjs.__name)(buildLookaheadFuncForOr, "buildLookaheadFuncForOr");
function buildLookaheadFuncForOptionalProd(occurrence, ruleGrammar, k, dynamicTokensEnabled, prodType, lookaheadBuilder) {
    const lookAheadPaths = getLookaheadPathsForOptionalProd(occurrence, ruleGrammar, prodType, k);
    const tokenMatcher2 = areTokenCategoriesNotUsed(lookAheadPaths) ? tokenStructuredMatcherNoCategories : tokenStructuredMatcher;
    return lookaheadBuilder(lookAheadPaths[0], tokenMatcher2, dynamicTokensEnabled);
}
(0, _chunkDLQEHMXDMjs.__name)(buildLookaheadFuncForOptionalProd, "buildLookaheadFuncForOptionalProd");
function buildAlternativesLookAheadFunc(alts, hasPredicates, tokenMatcher2, dynamicTokensEnabled) {
    const numOfAlts = alts.length;
    const areAllOneTokenLookahead = (0, _chunkTZBO7MLIMjs.every_default)(alts, (currAlt)=>{
        return (0, _chunkTZBO7MLIMjs.every_default)(currAlt, (currPath)=>{
            return currPath.length === 1;
        });
    });
    if (hasPredicates) return function(orAlts) {
        const predicates = (0, _chunkTZBO7MLIMjs.map_default)(orAlts, (currAlt)=>currAlt.GATE);
        ...
        const singleTokenAlts = (0, _chunkTZBO7MLIMjs.map_default)(alts, (currAlt)=>{
            return (0, _chunkTZBO7MLIMjs.flatten_default)(currAlt);
        });
        const choiceToAlt = (0, _chunkTZBO7MLIMjs.reduce_default)(singleTokenAlts, (result, currAlt, idx)=>{
            (0, _chunkTZBO7MLIMjs.forEach_default)(currAlt, (currTokType)=>{
                if (!(0, _chunkTZBO7MLIMjs.has_default)(result, currTokType.tokenTypeIdx)) result[currTokType.tokenTypeIdx] = idx;
                (0, _chunkTZBO7MLIMjs.forEach_default)(currTokType.categoryMatches, (currExtendingType)=>{
                    if (!(0, _chunkTZBO7MLIMjs.has_default)(result, currExtendingType)) result[currExtendingType] = idx;
                });
            });
            return result;
        }, {});
...
(0, _chunkDLQEHMXDMjs.__name)(buildAlternativesLookAheadFunc, "buildAlternativesLookAheadFunc");
function buildSingleAlternativeLookaheadFunction(alt, tokenMatcher2, dynamicTokensEnabled) {
    const areAllOneTokenLookahead = (0, _chunkTZBO7MLIMjs.every_default)(alt, (currPath)=>{
        return currPath.length === 1;
    });
    const numOfPaths = alt.length;
    if (areAllOneTokenLookahead && !dynamicTokensEnabled) {
        const singleTokensTypes = (0, _chunkTZBO7MLIMjs.flatten_default)(alt);
        if (singleTokensTypes.length === 1 && (0, _chunkGRZAG2UZMjs.isEmpty_default)(singleTokensTypes[0].categoryMatches)) {
            ...
            const choiceToAlt = (0, _chunkTZBO7MLIMjs.reduce_default)(singleTokensTypes, (result, currTokType, idx)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(buildSingleAlternativeLookaheadFunction, "buildSingleAlternativeLookaheadFunction");
var RestDefinitionFinderWalker = class extends RestWalker {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RestDefinitionFinderWalker");
...
var InsideDefinitionFinderVisitor = class extends GAstVisitor {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "InsideDefinitionFinderVisitor");
...
(0, _chunkDLQEHMXDMjs.__name)(initializeArrayOfArrays, "initializeArrayOfArrays");
...
(0, _chunkDLQEHMXDMjs.__name)(pathToHashKeys, "pathToHashKeys");
...
(0, _chunkDLQEHMXDMjs.__name)(isUniquePrefixHash, "isUniquePrefixHash");
function lookAheadSequenceFromAlternatives(altsDefs, k) {
    const partialAlts = (0, _chunkTZBO7MLIMjs.map_default)(altsDefs, (currAlt)=>possiblePathsFrom([
            currAlt
        ], 1));
    const finalResult = initializeArrayOfArrays(partialAlts.length);
    const altsHashes = (0, _chunkTZBO7MLIMjs.map_default)(partialAlts, (currAltPaths)=>{
        const dict = {};
        (0, _chunkTZBO7MLIMjs.forEach_default)(currAltPaths, (item)=>{
            const keys = pathToHashKeys(item.partialPath);
            (0, _chunkTZBO7MLIMjs.forEach_default)(keys, (currKey)=>{
                dict[currKey] = true;
            });
        });
        return dict;
    ...
    for(let pathLength = 1; pathLength <= k; pathLength++){
        ...
        for(let altIdx = 0; altIdx < currDataset.length; altIdx++){
            ...
            for(let currPathIdx = 0; currPathIdx < currAltPathsAndSuffixes.length; currPathIdx++){
                ...
                if (isUnique || (0, _chunkGRZAG2UZMjs.isEmpty_default)(suffixDef) || currPathPrefix.length === k) {
                    ...
                    (0, _chunkTZBO7MLIMjs.forEach_default)(newPartialPathsAndSuffixes, (item)=>{
                        const prefixKeys2 = pathToHashKeys(item.partialPath);
                        (0, _chunkTZBO7MLIMjs.forEach_default)(prefixKeys2, (key)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(lookAheadSequenceFromAlternatives, "lookAheadSequenceFromAlternatives");
...
(0, _chunkDLQEHMXDMjs.__name)(getLookaheadPathsForOr, "getLookaheadPathsForOr");
...
(0, _chunkDLQEHMXDMjs.__name)(getLookaheadPathsForOptionalProd, "getLookaheadPathsForOptionalProd");
...
(0, _chunkDLQEHMXDMjs.__name)(containsPath, "containsPath");
function isStrictPrefixOfPath(prefix, other) {
    return prefix.length < other.length && (0, _chunkTZBO7MLIMjs.every_default)(prefix, (tokType, idx)=>{
        const otherTokType = other[idx];
        return tokType === otherTokType || otherTokType.categoryMatchesMap[tokType.tokenTypeIdx];
    });
}
(0, _chunkDLQEHMXDMjs.__name)(isStrictPrefixOfPath, "isStrictPrefixOfPath");
function areTokenCategoriesNotUsed(lookAheadPaths) {
    return (0, _chunkTZBO7MLIMjs.every_default)(lookAheadPaths, (singleAltPaths)=>(0, _chunkTZBO7MLIMjs.every_default)(singleAltPaths, (singlePath)=>(0, _chunkTZBO7MLIMjs.every_default)(singlePath, (token)=>(0, _chunkGRZAG2UZMjs.isEmpty_default)(token.categoryMatches))));
}
(0, _chunkDLQEHMXDMjs.__name)(areTokenCategoriesNotUsed, "areTokenCategoriesNotUsed");
...
function validateLookahead(options) {
    ...
    return (0, _chunkTZBO7MLIMjs.map_default)(lookaheadValidationErrorMessages, (errorMessage)=>Object.assign({
            type: ParserDefinitionErrorType.CUSTOM_LOOKAHEAD_VALIDATION
        }, errorMessage));
}
(0, _chunkDLQEHMXDMjs.__name)(validateLookahead, "validateLookahead");
function validateGrammar(topLevels, tokenTypes, errMsgProvider, grammarName) {
    const duplicateErrors = (0, _chunkTZBO7MLIMjs.flatMap_default)(topLevels, (currTopLevel)=>validateDuplicateProductions(currTopLevel, errMsgProvider));
    const termsNamespaceConflictErrors = checkTerminalAndNoneTerminalsNameSpace(topLevels, tokenTypes, errMsgProvider);
    const tooManyAltsErrors = (0, _chunkTZBO7MLIMjs.flatMap_default)(topLevels, (curRule)=>validateTooManyAlts(curRule, errMsgProvider));
    const duplicateRulesError = (0, _chunkTZBO7MLIMjs.flatMap_default)(topLevels, (curRule)=>validateRuleDoesNotAlreadyExist(curRule, topLevels, grammarName, errMsgProvider));
    return duplicateErrors.concat(termsNamespaceConflictErrors, tooManyAltsErrors, duplicateRulesError);
}
(0, _chunkDLQEHMXDMjs.__name)(validateGrammar, "validateGrammar");
function validateDuplicateProductions(topLevelRule, errMsgProvider) {
    ...
    const productionGroups = (0, _chunkTZBO7MLIMjs.groupBy_default)(allRuleProductions, identifyProductionForDuplicates);
    const duplicates = (0, _chunkTZBO7MLIMjs.pickBy_default)(productionGroups, (currGroup)=>{
        return currGroup.length > 1;
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)((0, _chunkTZBO7MLIMjs.values_default)(duplicates), (currDuplicates)=>{
        const firstProd = (0, _chunkTZBO7MLIMjs.head_default)(currDuplicates);
...
(0, _chunkDLQEHMXDMjs.__name)(validateDuplicateProductions, "validateDuplicateProductions");
function identifyProductionForDuplicates(prod) {
    return `${getProductionDslName(prod)}_#_${prod.idx}_#_${getExtraProductionArgument(prod)}`;
}
(0, _chunkDLQEHMXDMjs.__name)(identifyProductionForDuplicates, "identifyProductionForDuplicates");
function getExtraProductionArgument(prod) {
    if (prod instanceof Terminal) return prod.terminalType.name;
    else if (prod instanceof NonTerminal) return prod.nonTerminalName;
    else return "";
}
(0, _chunkDLQEHMXDMjs.__name)(getExtraProductionArgument, "getExtraProductionArgument");
var OccurrenceValidationCollector = class extends GAstVisitor {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "OccurrenceValidationCollector");
    constructor(){
        super(...arguments);
        this.allProductions = [];
    }
...
function validateRuleDoesNotAlreadyExist(rule, allRules, className, errMsgProvider) {
    const errors = [];
    const occurrences = (0, _chunkTZBO7MLIMjs.reduce_default)(allRules, (result, curRule)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(validateRuleDoesNotAlreadyExist, "validateRuleDoesNotAlreadyExist");
function validateRuleIsOverridden(ruleName, definedRulesNames, className) {
    const errors = [];
    let errMsg;
    if (!(0, _chunkTZBO7MLIMjs.includes_default)(definedRulesNames, ruleName)) {
...
(0, _chunkDLQEHMXDMjs.__name)(validateRuleIsOverridden, "validateRuleIsOverridden");
function validateNoLeftRecursion(topRule, currRule, errMsgProvider, path = []) {
    const errors = [];
    const nextNonTerminals = getFirstNoneTerminal(currRule.definition);
    if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(nextNonTerminals)) return [];
    else {
        const ruleName = topRule.name;
        const foundLeftRecursion = (0, _chunkTZBO7MLIMjs.includes_default)(nextNonTerminals, topRule);
        ...
        const validNextSteps = (0, _chunkTZBO7MLIMjs.difference_default)(nextNonTerminals, path.concat([
            topRule
        ]));
        const errorsFromNextSteps = (0, _chunkTZBO7MLIMjs.flatMap_default)(validNextSteps, (currRefRule)=>{
            const newPath = (0, _chunkTZBO7MLIMjs.clone_default)(path);
...
(0, _chunkDLQEHMXDMjs.__name)(validateNoLeftRecursion, "validateNoLeftRecursion");
function getFirstNoneTerminal(definition) {
    let result = [];
    if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(definition)) return result;
    const firstProd = (0, _chunkTZBO7MLIMjs.head_default)(definition);
    ...
    else if (firstProd instanceof Alternation) result = (0, _chunkTZBO7MLIMjs.flatten_default)((0, _chunkTZBO7MLIMjs.map_default)(firstProd.definition, (currSubDef)=>getFirstNoneTerminal(currSubDef.definition)));
    else if (firstProd instanceof Terminal) ;
    else throw Error("non exhaustive match");
    const isFirstOptional = isOptionalProd(firstProd);
    const hasMore = definition.length > 1;
    if (isFirstOptional && hasMore) {
        const rest = (0, _chunkTZBO7MLIMjs.drop_default)(definition);
        return result.concat(getFirstNoneTerminal(rest));
    } else return result;
}
(0, _chunkDLQEHMXDMjs.__name)(getFirstNoneTerminal, "getFirstNoneTerminal");
var OrCollector = class extends GAstVisitor {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "OrCollector");
    constructor(){
        super(...arguments);
        this.alternations = [];
    }
...
function validateEmptyOrAlternative(topLevelRule, errMsgProvider) {
    ...
    const errors = (0, _chunkTZBO7MLIMjs.flatMap_default)(ors, (currOr)=>{
        const exceptLast = (0, _chunkTZBO7MLIMjs.dropRight_default)(currOr.definition);
        return (0, _chunkTZBO7MLIMjs.flatMap_default)(exceptLast, (currAlternative, currAltIdx)=>{
            const possibleFirstInAlt = nextPossibleTokensAfter([
                currAlternative
            ], [], tokenStructuredMatcher, 1);
            if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(possibleFirstInAlt)) return [
                {
...
(0, _chunkDLQEHMXDMjs.__name)(validateEmptyOrAlternative, "validateEmptyOrAlternative");
function validateAmbiguousAlternationAlternatives(topLevelRule, globalMaxLookahead, errMsgProvider) {
    const orCollector = new OrCollector();
    topLevelRule.accept(orCollector);
    let ors = orCollector.alternations;
    ors = (0, _chunkTZBO7MLIMjs.reject_default)(ors, (currOr)=>currOr.ignoreAmbiguities === true);
    const errors = (0, _chunkTZBO7MLIMjs.flatMap_default)(ors, (currOr)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(validateAmbiguousAlternationAlternatives, "validateAmbiguousAlternationAlternatives");
var RepetitionCollector = class extends GAstVisitor {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RepetitionCollector");
    constructor(){
        super(...arguments);
        this.allProductions = [];
    }
...
(0, _chunkDLQEHMXDMjs.__name)(validateTooManyAlts, "validateTooManyAlts");
function validateSomeNonEmptyLookaheadPath(topLevelRules, maxLookahead, errMsgProvider) {
    const errors = [];
    (0, _chunkTZBO7MLIMjs.forEach_default)(topLevelRules, (currTopRule)=>{
        const collectorVisitor2 = new RepetitionCollector();
        currTopRule.accept(collectorVisitor2);
        const allRuleProductions = collectorVisitor2.allProductions;
        (0, _chunkTZBO7MLIMjs.forEach_default)(allRuleProductions, (currProd)=>{
            const prodType = getProdType(currProd);
            const actualMaxLookahead = currProd.maxLookahead || maxLookahead;
            const currOccurrence = currProd.idx;
            const paths = getLookaheadPathsForOptionalProd(currOccurrence, currTopRule, prodType, actualMaxLookahead);
            const pathsInsideProduction = paths[0];
            if ((0, _chunkGRZAG2UZMjs.isEmpty_default)((0, _chunkTZBO7MLIMjs.flatten_default)(pathsInsideProduction))) {
...
(0, _chunkDLQEHMXDMjs.__name)(validateSomeNonEmptyLookaheadPath, "validateSomeNonEmptyLookaheadPath");
function checkAlternativesAmbiguities(alternatives, alternation2, rule, errMsgProvider) {
    const foundAmbiguousPaths = [];
    const identicalAmbiguities = (0, _chunkTZBO7MLIMjs.reduce_default)(alternatives, (result, currAlt, currAltIdx)=>{
        if (alternation2.definition[currAltIdx].ignoreAmbiguities === true) return result;
        (0, _chunkTZBO7MLIMjs.forEach_default)(currAlt, (currPath)=>{
            const altsCurrPathAppearsIn = [
                currAltIdx
            ];
            (0, _chunkTZBO7MLIMjs.forEach_default)(alternatives, (currOtherAlt, currOtherAltIdx)=>{
    ...
    const currErrors = (0, _chunkTZBO7MLIMjs.map_default)(identicalAmbiguities, (currAmbDescriptor)=>{
        const ambgIndices = (0, _chunkTZBO7MLIMjs.map_default)(currAmbDescriptor.alts, (currAltIdx)=>currAltIdx + 1);
...
(0, _chunkDLQEHMXDMjs.__name)(checkAlternativesAmbiguities, "checkAlternativesAmbiguities");
function checkPrefixAlternativesAmbiguities(alternatives, alternation2, rule, errMsgProvider) {
    const pathsAndIndices = (0, _chunkTZBO7MLIMjs.reduce_default)(alternatives, (result, currAlt, idx)=>{
        const currPathsAndIdx = (0, _chunkTZBO7MLIMjs.map_default)(currAlt, (currPath)=>{
            return {
                idx,
                path: currPath
            };
    ...
    const errors = (0, _chunkTZBO7MLIMjs.compact_default)((0, _chunkTZBO7MLIMjs.flatMap_default)(pathsAndIndices, (currPathAndIdx)=>{
        ...
        const prefixAmbiguitiesPathsAndIndices = (0, _chunkTZBO7MLIMjs.filter_default)(pathsAndIndices, (searchPathAndIdx)=>{
        ...
        const currPathPrefixErrors = (0, _chunkTZBO7MLIMjs.map_default)(prefixAmbiguitiesPathsAndIndices, (currAmbPathAndIdx)=>{
            const ambgIndices = [
...
(0, _chunkDLQEHMXDMjs.__name)(checkPrefixAlternativesAmbiguities, "checkPrefixAlternativesAmbiguities");
function checkTerminalAndNoneTerminalsNameSpace(topLevels, tokenTypes, errMsgProvider) {
    const errors = [];
    const tokenNames = (0, _chunkTZBO7MLIMjs.map_default)(tokenTypes, (currToken)=>currToken.name);
    (0, _chunkTZBO7MLIMjs.forEach_default)(topLevels, (currRule)=>{
        const currRuleName = currRule.name;
        if ((0, _chunkTZBO7MLIMjs.includes_default)(tokenNames, currRuleName)) {
...
(0, _chunkDLQEHMXDMjs.__name)(checkTerminalAndNoneTerminalsNameSpace, "checkTerminalAndNoneTerminalsNameSpace");
...
function resolveGrammar2(options) {
    const actualOptions = (0, _chunkTZBO7MLIMjs.defaults_default)(options, {
        errMsgProvider: defaultGrammarResolverErrorProvider
    });
    const topRulesTable = {};
    (0, _chunkTZBO7MLIMjs.forEach_default)(options.rules, (rule)=>{
        topRulesTable[rule.name] = rule;
    });
    return resolveGrammar(topRulesTable, actualOptions.errMsgProvider);
}
(0, _chunkDLQEHMXDMjs.__name)(resolveGrammar2, "resolveGrammar");
...
(0, _chunkDLQEHMXDMjs.__name)(validateGrammar2, "validateGrammar");
...
function isRecognitionException(error) {
    return (0, _chunkTZBO7MLIMjs.includes_default)(RECOGNITION_EXCEPTION_NAMES, error.name);
}
(0, _chunkDLQEHMXDMjs.__name)(isRecognitionException, "isRecognitionException");
var RecognitionException = class extends Error {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RecognitionException");
...
var MismatchedTokenException = class extends RecognitionException {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "MismatchedTokenException");
...
var NoViableAltException = class extends RecognitionException {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "NoViableAltException");
    constructor(message, token, previousToken){
        super(message, token);
        this.previousToken = previousToken;
...
var NotAllInputParsedException = class extends RecognitionException {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "NotAllInputParsedException");
    constructor(message, token){
        super(message, token);
...
var EarlyExitException = class extends RecognitionException {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "EarlyExitException");
    constructor(message, token, previousToken){
        super(message, token);
        this.previousToken = previousToken;
...
var InRuleRecoveryException = class extends Error {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "InRuleRecoveryException");
    constructor(message){
        super(message);
...
var Recoverable = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Recoverable");
    initRecoverable(config) {
        this.firstAfterRepMap = {};
        this.resyncFollows = {};
        this.recoveryEnabled = (0, _chunkTZBO7MLIMjs.has_default)(config, "recoveryEnabled") ? config.recoveryEnabled : DEFAULT_PARSER_CONFIG.recoveryEnabled;
    ...
    tryInRepetitionRecovery(grammarRule, grammarRuleArgs, lookAheadFunc, expectedTokType) {
        ...
        const generateErrorMessage = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
            ...
            error.resyncedTokens = (0, _chunkTZBO7MLIMjs.dropRight_default)(resyncedTokens);
    ...
    canRecoverWithSingleTokenInsertion(expectedTokType, follows) {
        ...
        if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(follows)) return false;
        const mismatchedTok = this.LA(1);
        const isMisMatchedTokInFollows = (0, _chunkTZBO7MLIMjs.find_default)(follows, (possibleFollowsTokType)=>{
    ...
    isInCurrentRuleReSyncSet(tokenTypeIdx) {
        ...
        return (0, _chunkTZBO7MLIMjs.includes_default)(currentRuleReSyncSet, tokenTypeIdx);
    }
    findReSyncTokenType() {
        ...
        let k = 2;
        while(true){
            const foundMatch = (0, _chunkTZBO7MLIMjs.find_default)(allPossibleReSyncTokTypes, (resyncTokType)=>{
    ...
    buildFullFollowKeyStack() {
        ...
        return (0, _chunkTZBO7MLIMjs.map_default)(explicitRuleStack, (ruleName, idx)=>{
    ...
    flattenFollowSet() {
        const followStack = (0, _chunkTZBO7MLIMjs.map_default)(this.buildFullFollowKeyStack(), (currKey)=>{
            return this.getFollowSetFromFollowKey(currKey);
        });
        return (0, _chunkTZBO7MLIMjs.flatten_default)(followStack);
    }
    ...
    reSyncTo(tokType) {
        ...
        return (0, _chunkTZBO7MLIMjs.dropRight_default)(resyncedTokens);
    }
    attemptInRepetitionRecovery(prodFunc, args, lookaheadFunc, dslMethodIdx, prodOccurrence, nextToksWalker, notStuck) {}
    getCurrentGrammarPath(tokType, tokIdxInRule) {
        const pathRuleStack = this.getHumanReadableRuleStack();
        const pathOccurrenceStack = (0, _chunkTZBO7MLIMjs.clone_default)(this.RULE_OCCURRENCE_STACK);
        const grammarPath = {
    ...
    getHumanReadableRuleStack() {
        return (0, _chunkTZBO7MLIMjs.map_default)(this.RULE_STACK, (currShortName)=>this.shortRuleNameToFullName(currShortName));
    }
};
...
(0, _chunkDLQEHMXDMjs.__name)(attemptInRepetitionRecovery, "attemptInRepetitionRecovery");
...
(0, _chunkDLQEHMXDMjs.__name)(getKeyForAutomaticLookahead, "getKeyForAutomaticLookahead");
...
var LLkLookaheadStrategy = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LLkLookaheadStrategy");
    constructor(options){
        var _a;
    ...
    validate(options) {
        ...
        if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(leftRecursionErrors)) {
    ...
    validateNoLeftRecursion(rules) {
        return (0, _chunkTZBO7MLIMjs.flatMap_default)(rules, (currTopRule)=>validateNoLeftRecursion(currTopRule, currTopRule, defaultGrammarValidatorErrorProvider));
    }
    validateEmptyOrAlternatives(rules) {
        return (0, _chunkTZBO7MLIMjs.flatMap_default)(rules, (currTopRule)=>validateEmptyOrAlternative(currTopRule, defaultGrammarValidatorErrorProvider));
    }
    validateAmbiguousAlternationAlternatives(rules, maxLookahead) {
        return (0, _chunkTZBO7MLIMjs.flatMap_default)(rules, (currTopRule)=>validateAmbiguousAlternationAlternatives(currTopRule, maxLookahead, defaultGrammarValidatorErrorProvider));
    }
...
var LooksAhead = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LooksAhead");
    initLooksAhead(config) {
        this.dynamicTokensEnabled = (0, _chunkTZBO7MLIMjs.has_default)(config, "dynamicTokensEnabled") ? config.dynamicTokensEnabled : DEFAULT_PARSER_CONFIG.dynamicTokensEnabled;
        this.maxLookahead = (0, _chunkTZBO7MLIMjs.has_default)(config, "maxLookahead") ? config.maxLookahead : DEFAULT_PARSER_CONFIG.maxLookahead;
        this.lookaheadStrategy = (0, _chunkTZBO7MLIMjs.has_default)(config, "lookaheadStrategy") ? config.lookaheadStrategy : new LLkLookaheadStrategy({
            maxLookahead: this.maxLookahead
        });
        this.lookAheadFuncsCache = /* @__PURE__ */ new Map();
    }
    preComputeLookaheadFunctions(rules) {
        (0, _chunkTZBO7MLIMjs.forEach_default)(rules, (currRule)=>{
            this.TRACE_INIT(`${currRule.name} Rule Lookahead`, ()=>{
                ...
                (0, _chunkTZBO7MLIMjs.forEach_default)(alternation2, (currProd)=>{
                ...
                (0, _chunkTZBO7MLIMjs.forEach_default)(repetition2, (currProd)=>{
                    this.computeLookaheadFunc(currRule, currProd.idx, MANY_IDX, "Repetition", currProd.maxLookahead, getProductionDslName(currProd));
                });
                (0, _chunkTZBO7MLIMjs.forEach_default)(option2, (currProd)=>{
                    this.computeLookaheadFunc(currRule, currProd.idx, OPTION_IDX, "Option", currProd.maxLookahead, getProductionDslName(currProd));
                });
                (0, _chunkTZBO7MLIMjs.forEach_default)(repetitionMandatory2, (currProd)=>{
                    this.computeLookaheadFunc(currRule, currProd.idx, AT_LEAST_ONE_IDX, "RepetitionMandatory", currProd.maxLookahead, getProductionDslName(currProd));
                });
                (0, _chunkTZBO7MLIMjs.forEach_default)(repetitionMandatoryWithSeparator, (currProd)=>{
                    this.computeLookaheadFunc(currRule, currProd.idx, AT_LEAST_ONE_SEP_IDX, "RepetitionMandatoryWithSeparator", currProd.maxLookahead, getProductionDslName(currProd));
                });
                (0, _chunkTZBO7MLIMjs.forEach_default)(repetitionWithSeparator, (currProd)=>{
...
var DslMethodsCollectorVisitor = class extends GAstVisitor {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DslMethodsCollectorVisitor");
    constructor(){
        super(...arguments);
        this.dslMethods = {
            option: [],
...
(0, _chunkDLQEHMXDMjs.__name)(collectMethods, "collectMethods");
...
(0, _chunkDLQEHMXDMjs.__name)(setNodeLocationOnlyOffset, "setNodeLocationOnlyOffset");
...
(0, _chunkDLQEHMXDMjs.__name)(setNodeLocationFull, "setNodeLocationFull");
...
(0, _chunkDLQEHMXDMjs.__name)(addTerminalToCst, "addTerminalToCst");
...
(0, _chunkDLQEHMXDMjs.__name)(addNoneTerminalToCst, "addNoneTerminalToCst");
...
(0, _chunkDLQEHMXDMjs.__name)(defineNameProp, "defineNameProp");
// ../../node_modules/.pnpm/chevrotain@11.0.3/node_modules/chevrotain/lib/src/parse/cst/cst_visitor.js
function defaultVisit(ctx, param) {
    const childrenNames = (0, _chunkTZBO7MLIMjs.keys_default)(ctx);
...
(0, _chunkDLQEHMXDMjs.__name)(defaultVisit, "defaultVisit");
function createBaseSemanticVisitorConstructor(grammarName, ruleNames) {
    const derivedConstructor = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {}, "derivedConstructor");
    defineNameProp(derivedConstructor, grammarName + "BaseSemantics");
    const semanticProto = {
        visit: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(cstNode, param) {
            if ((0, _chunkHD3LK5B5Mjs.isArray_default)(cstNode)) cstNode = cstNode[0];
            if ((0, _chunkTZBO7MLIMjs.isUndefined_default)(cstNode)) return void 0;
            return this[cstNode.name](cstNode.children, param);
        }, "visit"),
        validateVisitor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
            const semanticDefinitionErrors = validateVisitor(this, ruleNames);
            if (!(0, _chunkGRZAG2UZMjs.isEmpty_default)(semanticDefinitionErrors)) {
                const errorMessages = (0, _chunkTZBO7MLIMjs.map_default)(semanticDefinitionErrors, (currDefError)=>currDefError.msg);
...
(0, _chunkDLQEHMXDMjs.__name)(createBaseSemanticVisitorConstructor, "createBaseSemanticVisitorConstructor");
function createBaseVisitorConstructorWithDefaults(grammarName, ruleNames, baseConstructor) {
    const derivedConstructor = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {}, "derivedConstructor");
    defineNameProp(derivedConstructor, grammarName + "BaseSemanticsWithDefaults");
    const withDefaultsProto = Object.create(baseConstructor.prototype);
    (0, _chunkTZBO7MLIMjs.forEach_default)(ruleNames, (ruleName)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(createBaseVisitorConstructorWithDefaults, "createBaseVisitorConstructorWithDefaults");
...
(0, _chunkDLQEHMXDMjs.__name)(validateVisitor, "validateVisitor");
function validateMissingCstMethods(visitorInstance, ruleNames) {
    const missingRuleNames = (0, _chunkTZBO7MLIMjs.filter_default)(ruleNames, (currRuleName)=>{
        return (0, _chunkHD3LK5B5Mjs.isFunction_default)(visitorInstance[currRuleName]) === false;
    });
    const errors = (0, _chunkTZBO7MLIMjs.map_default)(missingRuleNames, (currRuleName)=>{
        return {
    ...
    return (0, _chunkTZBO7MLIMjs.compact_default)(errors);
}
(0, _chunkDLQEHMXDMjs.__name)(validateMissingCstMethods, "validateMissingCstMethods");
// ../../node_modules/.pnpm/chevrotain@11.0.3/node_modules/chevrotain/lib/src/parse/parser/traits/tree_builder.js
var TreeBuilder = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "TreeBuilder");
    initTreeBuilder(config) {
        this.CST_STACK = [];
        this.outputCst = config.outputCst;
        this.nodeLocationTracking = (0, _chunkTZBO7MLIMjs.has_default)(config, "nodeLocationTracking") ? config.nodeLocationTracking : DEFAULT_PARSER_CONFIG.nodeLocationTracking;
        if (!this.outputCst) {
            this.cstInvocationStateUpdate = (0, _chunkTZBO7MLIMjs.noop_default);
            this.cstFinallyStateUpdate = (0, _chunkTZBO7MLIMjs.noop_default);
            this.cstPostTerminal = (0, _chunkTZBO7MLIMjs.noop_default);
            this.cstPostNonTerminal = (0, _chunkTZBO7MLIMjs.noop_default);
            this.cstPostRule = (0, _chunkTZBO7MLIMjs.noop_default);
        } else {
            if (/full/i.test(this.nodeLocationTracking)) {
                if (this.recoveryEnabled) {
                    ...
                    this.setNodeLocationFromToken = (0, _chunkTZBO7MLIMjs.noop_default);
                    this.setNodeLocationFromNode = (0, _chunkTZBO7MLIMjs.noop_default);
                ...
                this.setNodeLocationFromNode = (0, _chunkTZBO7MLIMjs.noop_default);
                this.cstPostRule = (0, _chunkTZBO7MLIMjs.noop_default);
                this.setInitialNodeLocation = (0, _chunkTZBO7MLIMjs.noop_default);
    ...
    getBaseCstVisitorConstructor() {
        if ((0, _chunkTZBO7MLIMjs.isUndefined_default)(this.baseCstVisitorConstructor)) {
            const newBaseCstVisitorConstructor = createBaseSemanticVisitorConstructor(this.className, (0, _chunkTZBO7MLIMjs.keys_default)(this.gastProductionsCache));
    ...
    getBaseCstVisitorConstructorWithDefaults() {
        if ((0, _chunkTZBO7MLIMjs.isUndefined_default)(this.baseCstVisitorWithDefaultsConstructor)) {
            const newConstructor = createBaseVisitorConstructorWithDefaults(this.className, (0, _chunkTZBO7MLIMjs.keys_default)(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
var LexerAdapter = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LexerAdapter");
    initLexerAdapter() {
        this.tokVector = [];
...
var RecognizerApi = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RecognizerApi");
    ACTION(impl) {
    ...
    RULE(name, implementation, config = DEFAULT_RULE_CONFIG) {
        if ((0, _chunkTZBO7MLIMjs.includes_default)(this.definedRulesNames, name)) {
    ...
    getSerializedGastProductions() {
        return serializeGrammar((0, _chunkTZBO7MLIMjs.values_default)(this.gastProductionsCache));
    }
};
...
var RecognizerEngine = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RecognizerEngine");
    initRecognizerEngine(tokenVocabulary, config) {
        ...
        if ((0, _chunkTZBO7MLIMjs.has_default)(config, "serializedGrammar")) throw Error("The Parser's configuration can no longer contain a <serializedGrammar> property.\n	See: https://chevrotain.io/docs/changes/BREAKING_CHANGES.html#_6-0-0\n	For Further details.");
        if ((0, _chunkHD3LK5B5Mjs.isArray_default)(tokenVocabulary)) {
            if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(tokenVocabulary)) throw Error("A Token Vocabulary cannot be empty.\n	Note that the first argument for the parser constructor\n	is no longer a Token vector (since v4.0).");
        ...
        if ((0, _chunkHD3LK5B5Mjs.isArray_default)(tokenVocabulary)) this.tokensMap = (0, _chunkTZBO7MLIMjs.reduce_default)(tokenVocabulary, (acc, tokType)=>{
            acc[tokType.name] = tokType;
            return acc;
        }, {});
        else if ((0, _chunkTZBO7MLIMjs.has_default)(tokenVocabulary, "modes") && (0, _chunkTZBO7MLIMjs.every_default)((0, _chunkTZBO7MLIMjs.flatten_default)((0, _chunkTZBO7MLIMjs.values_default)(tokenVocabulary.modes)), isTokenType)) {
            const allTokenTypes2 = (0, _chunkTZBO7MLIMjs.flatten_default)((0, _chunkTZBO7MLIMjs.values_default)(tokenVocabulary.modes));
            const uniqueTokens = (0, _chunkTZBO7MLIMjs.uniq_default)(allTokenTypes2);
            this.tokensMap = (0, _chunkTZBO7MLIMjs.reduce_default)(uniqueTokens, (acc, tokType)=>{
                acc[tokType.name] = tokType;
                return acc;
            }, {});
        } else if ((0, _chunkHD3LK5B5Mjs.isObject_default)(tokenVocabulary)) this.tokensMap = (0, _chunkTZBO7MLIMjs.clone_default)(tokenVocabulary);
        ...
        const allTokenTypes = (0, _chunkTZBO7MLIMjs.has_default)(tokenVocabulary, "modes") ? (0, _chunkTZBO7MLIMjs.flatten_default)((0, _chunkTZBO7MLIMjs.values_default)(tokenVocabulary.modes)) : (0, _chunkTZBO7MLIMjs.values_default)(tokenVocabulary);
        const noTokenCategoriesUsed = (0, _chunkTZBO7MLIMjs.every_default)(allTokenTypes, (tokenConstructor)=>(0, _chunkGRZAG2UZMjs.isEmpty_default)(tokenConstructor.categoryMatches));
        this.tokenMatcher = noTokenCategoriesUsed ? tokenStructuredMatcherNoCategories : tokenStructuredMatcher;
        augmentTokenTypes((0, _chunkTZBO7MLIMjs.values_default)(this.tokensMap));
    }
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
        const resyncEnabled = (0, _chunkTZBO7MLIMjs.has_default)(config, "resyncEnabled") ? config.resyncEnabled : DEFAULT_RULE_CONFIG.resyncEnabled;
        const recoveryValueFunc = (0, _chunkTZBO7MLIMjs.has_default)(config, "recoveryValueFunc") ? config.recoveryValueFunc : DEFAULT_RULE_CONFIG.recoveryValueFunc;
        const shortName = this.ruleShortNameIdx << BITS_FOR_METHOD_TYPE + BITS_FOR_OCCURRENCE_IDX;
        this.ruleShortNameIdx++;
        this.shortRuleNameToFull[shortName] = ruleName;
        this.fullRuleNameToShort[ruleName] = shortName;
        let invokeRuleWithTry;
        if (this.outputCst === true) invokeRuleWithTry = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function invokeRuleWithTry2(...args) {
            try {
        ...
        else invokeRuleWithTry = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function invokeRuleWithTryCst(...args) {
            try {
                this.ruleInvocationStateUpdate(shortName, ruleName, this.subruleIdx);
    ...
    optionInternalLogic(actionORMethodDef, occurrence, key) {
        ...
        if (typeof actionORMethodDef !== "function") {
            ...
            if (predicate !== void 0) {
                ...
                lookAheadFunc = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
    ...
    atLeastOneInternalLogic(prodOccurrence, actionORMethodDef, key) {
        ...
        this.attemptInRepetitionRecovery(this.atLeastOneInternal, [
            prodOccurrence,
            actionORMethodDef
        ], lookAheadFunc, AT_LEAST_ONE_IDX, prodOccurrence, NextTerminalAfterAtLeastOneWalker);
    }
    ...
    atLeastOneSepFirstInternalLogic(prodOccurrence, options, key) {
        ...
        if (firstIterationLookaheadFunc.call(this) === true) {
            action.call(this);
            const separatorLookAheadFunc = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
    ...
    manyInternalLogic(prodOccurrence, actionORMethodDef, key) {
        ...
        if (typeof actionORMethodDef !== "function") {
            ...
            if (predicate !== void 0) {
                ...
                lookaheadFunction = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
                    return predicate.call(this) && orgLookaheadFunction.call(this);
                }, "lookaheadFunction");
            }
        } else action = actionORMethodDef;
        ...
        this.attemptInRepetitionRecovery(this.manyInternal, [
            prodOccurrence,
            actionORMethodDef
        ], lookaheadFunction, MANY_IDX, prodOccurrence, NextTerminalAfterManyWalker, // The notStuck parameter is only relevant when "attemptInRepetitionRecovery"
    ...
    orInternal(altsOrOpts, occurrence) {
        ...
        const alts = (0, _chunkHD3LK5B5Mjs.isArray_default)(altsOrOpts) ? altsOrOpts : altsOrOpts.DEF;
    ...
    saveRecogState() {
        ...
        const savedRuleStack = (0, _chunkTZBO7MLIMjs.clone_default)(this.RULE_STACK);
        return {
            errors: savedErrors,
...
var ErrorHandler = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ErrorHandler");
    initErrorHandler(config) {
        this._errors = [];
        this.errorMessageProvider = (0, _chunkTZBO7MLIMjs.has_default)(config, "errorMessageProvider") ? config.errorMessageProvider : DEFAULT_PARSER_CONFIG.errorMessageProvider;
    }
    SAVE_ERROR(error) {
        if (isRecognitionException(error)) {
            error.context = {
                ruleStack: this.getHumanReadableRuleStack(),
                ruleOccurrenceStack: (0, _chunkTZBO7MLIMjs.clone_default)(this.RULE_OCCURRENCE_STACK)
            };
    ...
    get errors() {
        return (0, _chunkTZBO7MLIMjs.clone_default)(this._errors);
    }
...
var ContentAssist = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ContentAssist");
    initContentAssist() {}
    computeContentAssist(startRuleName, precedingInput) {
        const startRuleGast = this.gastProductionsCache[startRuleName];
        if ((0, _chunkTZBO7MLIMjs.isUndefined_default)(startRuleGast)) throw Error(`Rule ->${startRuleName}<- does not exist in this grammar.`);
    ...
    getNextPossibleTokenTypes(grammarPath) {
        const topRuleName = (0, _chunkTZBO7MLIMjs.head_default)(grammarPath.ruleStack);
...
var GastRecorder = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "GastRecorder");
    ...
    subruleInternalRecord(ruleToCall, occurrence, options) {
        ...
        if (!ruleToCall || (0, _chunkTZBO7MLIMjs.has_default)(ruleToCall, "ruleName") === false) {
 ...
 inside top level rule: <${this.recordingProdStack[0].name}>`);
        ...
        const prevProd = (0, _chunkTZBO7MLIMjs.last_default)(this.recordingProdStack);
...
function recordProd(prodConstructor, mainProdArg, occurrence, handleSep = false) {
    assertMethodIdxIsValid(occurrence);
    const prevProd = (0, _chunkTZBO7MLIMjs.last_default)(this.recordingProdStack);
    const grammarAction = (0, _chunkHD3LK5B5Mjs.isFunction_default)(mainProdArg) ? mainProdArg : mainProdArg.DEF;
    const newProd = new prodConstructor({
        definition: [],
        idx: occurrence
    });
    if (handleSep) newProd.separator = mainProdArg.SEP;
    if ((0, _chunkTZBO7MLIMjs.has_default)(mainProdArg, "MAX_LOOKAHEAD")) newProd.maxLookahead = mainProdArg.MAX_LOOKAHEAD;
...
(0, _chunkDLQEHMXDMjs.__name)(recordProd, "recordProd");
function recordOrProd(mainProdArg, occurrence) {
    assertMethodIdxIsValid(occurrence);
    const prevProd = (0, _chunkTZBO7MLIMjs.last_default)(this.recordingProdStack);
    const hasOptions = (0, _chunkHD3LK5B5Mjs.isArray_default)(mainProdArg) === false;
    ...
    if ((0, _chunkTZBO7MLIMjs.has_default)(mainProdArg, "MAX_LOOKAHEAD")) newOrProd.maxLookahead = mainProdArg.MAX_LOOKAHEAD;
    const hasPredicates = (0, _chunkTZBO7MLIMjs.some_default)(alts, (currAlt)=>(0, _chunkHD3LK5B5Mjs.isFunction_default)(currAlt.GATE));
    newOrProd.hasPredicates = hasPredicates;
    prevProd.definition.push(newOrProd);
    (0, _chunkTZBO7MLIMjs.forEach_default)(alts, (currAlt)=>{
        const currAltFlat = new Alternative({
            definition: []
        });
        newOrProd.definition.push(currAltFlat);
        if ((0, _chunkTZBO7MLIMjs.has_default)(currAlt, "IGNORE_AMBIGUITIES")) currAltFlat.ignoreAmbiguities = currAlt.IGNORE_AMBIGUITIES;
        else if ((0, _chunkTZBO7MLIMjs.has_default)(currAlt, "GATE")) currAltFlat.ignoreAmbiguities = true;
...
(0, _chunkDLQEHMXDMjs.__name)(recordOrProd, "recordOrProd");
function getIdxSuffix(idx) {
    return idx === 0 ? "" : `${idx}`;
}
(0, _chunkDLQEHMXDMjs.__name)(getIdxSuffix, "getIdxSuffix");
...
(0, _chunkDLQEHMXDMjs.__name)(assertMethodIdxIsValid, "assertMethodIdxIsValid");
...
var PerformanceTracer = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "PerformanceTracer");
    initPerformanceTracer(config) {
        if ((0, _chunkTZBO7MLIMjs.has_default)(config, "traceInitPerf")) {
...
(0, _chunkDLQEHMXDMjs.__name)(applyMixins, "applyMixins");
...
var DEFAULT_RULE_CONFIG = Object.freeze({
    recoveryValueFunc: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>void 0, "recoveryValueFunc"),
    resyncEnabled: true
});
...
(0, _chunkDLQEHMXDMjs.__name)(EMPTY_ALT, "EMPTY_ALT");
var Parser = class _Parser {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Parser");
    /**
        ...
        this.TRACE_INIT("performSelfAnalysis", ()=>{
            ...
            this.TRACE_INIT("Grammar Recording", ()=>{
                try {
                    ...
                    (0, _chunkTZBO7MLIMjs.forEach_default)(this.definedRulesNames, (currRuleName)=>{
            ...
            this.TRACE_INIT("Grammar Resolving", ()=>{
                resolverErrors = resolveGrammar2({
                    rules: (0, _chunkTZBO7MLIMjs.values_default)(this.gastProductionsCache)
                });
                this.definitionErrors = this.definitionErrors.concat(resolverErrors);
            });
            this.TRACE_INIT("Grammar Validations", ()=>{
                if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(resolverErrors) && this.skipValidations === false) {
                    const validationErrors = validateGrammar2({
                        rules: (0, _chunkTZBO7MLIMjs.values_default)(this.gastProductionsCache),
                        tokenTypes: (0, _chunkTZBO7MLIMjs.values_default)(this.tokensMap),
                        errMsgProvider: defaultGrammarValidatorErrorProvider,
                        grammarName: className
                    });
            ...
            if ((0, _chunkGRZAG2UZMjs.isEmpty_default)(this.definitionErrors)) {
                if (this.recoveryEnabled) this.TRACE_INIT("computeAllProdsFollows", ()=>{
                    const allFollows = computeAllProdsFollows((0, _chunkTZBO7MLIMjs.values_default)(this.gastProductionsCache));
                ...
                this.TRACE_INIT("ComputeLookaheadFunctions", ()=>{
                    ...
                    this.preComputeLookaheadFunctions((0, _chunkTZBO7MLIMjs.values_default)(this.gastProductionsCache));
                });
            }
            if (!_Parser.DEFER_DEFINITION_ERRORS_HANDLING && !(0, _chunkGRZAG2UZMjs.isEmpty_default)(this.definitionErrors)) {
                defErrorsMsgs = (0, _chunkTZBO7MLIMjs.map_default)(this.definitionErrors, (defError)=>defError.message);
 ...
 ${defErrorsMsgs.join("\n-------------------------------\n")}`);
    ...
    constructor(tokenVocabulary, config){
        ...
        if ((0, _chunkTZBO7MLIMjs.has_default)(config, "ignoredIssues")) throw new Error("The <ignoredIssues> IParserConfig property has been deprecated.\n	Please use the <IGNORE_AMBIGUITIES> flag on the relevant DSL method instead.\n	See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#IGNORING_AMBIGUITIES\n	For further details.");
        this.skipValidations = (0, _chunkTZBO7MLIMjs.has_default)(config, "skipValidations") ? config.skipValidations : DEFAULT_PARSER_CONFIG.skipValidations;
    }
};
...
var EmbeddedActionsParser = class extends Parser {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "EmbeddedActionsParser");
    constructor(tokenVocabulary, config = DEFAULT_PARSER_CONFIG){
        const configClone = (0, _chunkTZBO7MLIMjs.clone_default)(config);
...
(0, _chunkDLQEHMXDMjs.__name)(buildATNKey, "buildATNKey");
var ATN_BASIC = 1;
...
var AbstractTransition = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractTransition");
    constructor(target){
        this.target = target;
    }
    isEpsilon() {
...
var AtomTransition = class extends AbstractTransition {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AtomTransition");
...
var EpsilonTransition = class extends AbstractTransition {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "EpsilonTransition");
    constructor(target){
        super(target);
    }
    isEpsilon() {
...
var RuleTransition = class extends AbstractTransition {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RuleTransition");
...
(0, _chunkDLQEHMXDMjs.__name)(createATN, "createATN");
...
(0, _chunkDLQEHMXDMjs.__name)(createRuleStartAndStopATNStates, "createRuleStartAndStopATNStates");
...
(0, _chunkDLQEHMXDMjs.__name)(atom, "atom");
...
(0, _chunkDLQEHMXDMjs.__name)(repetition, "repetition");
...
(0, _chunkDLQEHMXDMjs.__name)(repetitionSep, "repetitionSep");
...
(0, _chunkDLQEHMXDMjs.__name)(repetitionMandatory, "repetitionMandatory");
...
(0, _chunkDLQEHMXDMjs.__name)(repetitionMandatorySep, "repetitionMandatorySep");
function alternation(atn, rule, alternation2) {
    const start = newState(atn, rule, alternation2, {
        type: ATN_BASIC
    });
    defineDecisionState(atn, start);
    const alts = (0, _chunkTZBO7MLIMjs.map_default)(alternation2.definition, (e)=>atom(atn, rule, e));
    const handle = makeAlts(atn, rule, start, alternation2, ...alts);
    return handle;
}
(0, _chunkDLQEHMXDMjs.__name)(alternation, "alternation");
...
(0, _chunkDLQEHMXDMjs.__name)(option, "option");
function block(atn, rule, block2) {
    const handles = (0, _chunkTZBO7MLIMjs.filter_default)((0, _chunkTZBO7MLIMjs.map_default)(block2.definition, (e)=>atom(atn, rule, e)), (e)=>e !== void 0);
    if (handles.length === 1) return handles[0];
    else if (handles.length === 0) return void 0;
    else return makeBlock(atn, handles);
}
(0, _chunkDLQEHMXDMjs.__name)(block, "block");
...
(0, _chunkDLQEHMXDMjs.__name)(plus, "plus");
...
(0, _chunkDLQEHMXDMjs.__name)(star, "star");
...
(0, _chunkDLQEHMXDMjs.__name)(optional, "optional");
function defineDecisionState(atn, state) {
    atn.decisionStates.push(state);
    state.decision = atn.decisionStates.length - 1;
    return state.decision;
}
(0, _chunkDLQEHMXDMjs.__name)(defineDecisionState, "defineDecisionState");
...
(0, _chunkDLQEHMXDMjs.__name)(makeAlts, "makeAlts");
...
(0, _chunkDLQEHMXDMjs.__name)(getProdType2, "getProdType");
...
(0, _chunkDLQEHMXDMjs.__name)(makeBlock, "makeBlock");
...
(0, _chunkDLQEHMXDMjs.__name)(tokenRef, "tokenRef");
...
(0, _chunkDLQEHMXDMjs.__name)(ruleRef, "ruleRef");
...
(0, _chunkDLQEHMXDMjs.__name)(buildRuleHandle, "buildRuleHandle");
function epsilon(a, b) {
    const transition = new EpsilonTransition(b);
    addTransition(a, transition);
}
(0, _chunkDLQEHMXDMjs.__name)(epsilon, "epsilon");
...
var ATNConfigSet = class {
    ...
    get alts() {
        return (0, _chunkTZBO7MLIMjs.map_default)(this.configs, (e)=>e.alt);
    }
    get key() {
        let value = "";
...
(0, _chunkDLQEHMXDMjs.__name)(getATNConfigKey, "getATNConfigKey");
...
(0, _chunkDLQEHMXDMjs.__name)(createDFACache, "createDFACache");
var PredicateSet = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "PredicateSet");
    constructor(){
        this.predicates = [];
    }
    is(index) {
...
var LLStarLookaheadStrategy = class extends LLkLookaheadStrategy {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LLStarLookaheadStrategy");
    constructor(options){
        var _a;
        super();
    ...
    buildLookaheadForAlternation(options) {
        ...
        const partialAlts = (0, _chunkTZBO7MLIMjs.map_default)(getLookaheadPaths({
            maxLookahead: 1,
            occurrence: prodOccurrence,
            prodType: "Alternation",
            rule
        }), (currAlt)=>(0, _chunkTZBO7MLIMjs.map_default)(currAlt, (path)=>path[0]));
        if (isLL1Sequence(partialAlts, false) && !dynamicTokensEnabled) {
            const choiceToAlt = (0, _chunkTZBO7MLIMjs.reduce_default)(partialAlts, (result, currAlt, idx)=>{
                (0, _chunkTZBO7MLIMjs.forEach_default)(currAlt, (currTokType)=>{
                    if (currTokType) {
    ...
    buildLookaheadForOptional(options) {
        ...
        const decisionState = this.atn.decisionMap[key];
        const decisionIndex = decisionState.decision;
        const alts = (0, _chunkTZBO7MLIMjs.map_default)(getLookaheadPaths({
            maxLookahead: 1,
            occurrence: prodOccurrence,
            prodType,
            rule
        }), (e)=>{
            return (0, _chunkTZBO7MLIMjs.map_default)(e, (g)=>g[0]);
        });
        if (isLL1Sequence(alts) && alts[0][0] && !dynamicTokensEnabled) {
            ...
            if (singleTokensTypes.length === 1 && (0, _chunkGRZAG2UZMjs.isEmpty_default)(singleTokensTypes[0].categoryMatches)) {
                ...
                const choiceToAlt = (0, _chunkTZBO7MLIMjs.reduce_default)(singleTokensTypes, (result, currTokType)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(isLL1Sequence, "isLL1Sequence");
...
(0, _chunkDLQEHMXDMjs.__name)(initATNSimulator, "initATNSimulator");
...
(0, _chunkDLQEHMXDMjs.__name)(adaptivePredict, "adaptivePredict");
...
(0, _chunkDLQEHMXDMjs.__name)(performLookahead, "performLookahead");
function computeLookaheadTarget(dfa, previousD, token, lookahead, predicateSet, logging) {
    ...
    if (predictedAlt !== void 0) {
        ...
        const prediction = (0, _chunkTZBO7MLIMjs.min_default)(reach.alts);
        newState2.isAcceptState = true;
...
(0, _chunkDLQEHMXDMjs.__name)(computeLookaheadTarget, "computeLookaheadTarget");
...
(0, _chunkDLQEHMXDMjs.__name)(reportLookaheadAmbiguity, "reportLookaheadAmbiguity");
...
(0, _chunkDLQEHMXDMjs.__name)(buildAmbiguityError, "buildAmbiguityError");
...
(0, _chunkDLQEHMXDMjs.__name)(getProductionDslName2, "getProductionDslName");
function buildAdaptivePredictError(path, previous, current) {
    const nextTransitions = (0, _chunkTZBO7MLIMjs.flatMap_default)(previous.configs.elements, (e)=>e.state.transitions);
    const nextTokenTypes = (0, _chunkTZBO7MLIMjs.uniqBy_default)(nextTransitions.filter((e)=>e instanceof AtomTransition).map((e)=>e.tokenType), (e)=>e.tokenTypeIdx);
    return {
        actualToken: current,
...
(0, _chunkDLQEHMXDMjs.__name)(buildAdaptivePredictError, "buildAdaptivePredictError");
function getExistingTargetState(state, token) {
    return state.edges[token.tokenTypeIdx];
}
(0, _chunkDLQEHMXDMjs.__name)(getExistingTargetState, "getExistingTargetState");
...
(0, _chunkDLQEHMXDMjs.__name)(computeReachSet, "computeReachSet");
function getReachableTarget(transition, token) {
    if (transition instanceof AtomTransition && tokenMatcher(token, transition.tokenType)) return transition.target;
    return void 0;
}
(0, _chunkDLQEHMXDMjs.__name)(getReachableTarget, "getReachableTarget");
...
(0, _chunkDLQEHMXDMjs.__name)(getUniqueAlt, "getUniqueAlt");
...
(0, _chunkDLQEHMXDMjs.__name)(newDFAState, "newDFAState");
function addDFAEdge(dfa, from, token, to) {
    to = addDFAState(dfa, to);
    from.edges[token.tokenTypeIdx] = to;
    return to;
}
(0, _chunkDLQEHMXDMjs.__name)(addDFAEdge, "addDFAEdge");
...
(0, _chunkDLQEHMXDMjs.__name)(addDFAState, "addDFAState");
...
(0, _chunkDLQEHMXDMjs.__name)(computeStartState, "computeStartState");
...
(0, _chunkDLQEHMXDMjs.__name)(closure, "closure");
...
(0, _chunkDLQEHMXDMjs.__name)(getEpsilonTarget, "getEpsilonTarget");
function hasConfigInRuleStopState(configs) {
    for (const c of configs.elements){
        if (c.state.type === ATN_RULE_STOP) return true;
    }
    return false;
}
(0, _chunkDLQEHMXDMjs.__name)(hasConfigInRuleStopState, "hasConfigInRuleStopState");
function allConfigsInRuleStopStates(configs) {
    for (const c of configs.elements){
        if (c.state.type !== ATN_RULE_STOP) return false;
    }
    return true;
}
(0, _chunkDLQEHMXDMjs.__name)(allConfigsInRuleStopStates, "allConfigsInRuleStopStates");
...
(0, _chunkDLQEHMXDMjs.__name)(hasConflictTerminatingPrediction, "hasConflictTerminatingPrediction");
...
(0, _chunkDLQEHMXDMjs.__name)(getConflictingAltSets, "getConflictingAltSets");
...
(0, _chunkDLQEHMXDMjs.__name)(hasConflictingAltSet, "hasConflictingAltSet");
...
(0, _chunkDLQEHMXDMjs.__name)(hasStateAssociatedWithOneAlt, "hasStateAssociatedWithOneAlt");
...
(function(Position2) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(create, "create");
...
(function(TextEdit2) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(replace, "replace");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(insert, "insert");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(del, "del");
    TextEdit2.del = del;
    function is(value) {
        const candidate = value;
...
(function(MarkedString2) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(fromPlainText, "fromPlainText");
...
(function(StringValue2) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(createSnippet, "createSnippet");
...
(function(TextDocument3) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(applyEdits, "applyEdits");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(mergeSort2, "mergeSort");
})(TextDocument || (TextDocument = {}));
var FullTextDocument = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "FullTextDocument");
...
(function(Is2) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(defined, "defined");
    Is2.defined = defined;
    function undefined2(value) {
        return typeof value === "undefined";
    }
    (0, _chunkDLQEHMXDMjs.__name)(undefined2, "undefined");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(objectLiteral, "objectLiteral");
    Is2.objectLiteral = objectLiteral;
    function typedArray(value, check) {
        return Array.isArray(value) && value.every(check);
    }
    (0, _chunkDLQEHMXDMjs.__name)(typedArray, "typedArray");
    Is2.typedArray = typedArray;
})(Is || (Is = {}));
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/parser/cst-node-builder.js
var CstNodeBuilder = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "CstNodeBuilder");
    constructor(){
        this.nodeStack = [];
    }
    get current() {
...
var AbstractCstNode = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractCstNode");
...
var LeafCstNodeImpl = class extends AbstractCstNode {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LeafCstNodeImpl");
    get offset() {
        return this._offset;
    }
    get length() {
...
var CompositeCstNodeImpl = class extends AbstractCstNode {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "CompositeCstNodeImpl");
    constructor(){
        super(...arguments);
...
var CstNodeContainer = class _CstNodeContainer extends Array {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "CstNodeContainer");
    constructor(parent){
        super();
        this.parent = parent;
...
var RootCstNodeImpl = class extends CompositeCstNodeImpl {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "RootCstNodeImpl");
    get text() {
...
(0, _chunkDLQEHMXDMjs.__name)(isDataTypeNode, "isDataTypeNode");
var ruleSuffix = "\u200B";
var withRuleSuffix = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((name)=>name.endsWith(ruleSuffix) ? name : name + ruleSuffix, "withRuleSuffix");
var AbstractLangiumParser = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractLangiumParser");
...
var LangiumParser = class extends AbstractLangiumParser {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LangiumParser");
    get current() {
...
var AbstractParserErrorMessageProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractParserErrorMessageProvider");
...
var LangiumParserErrorMessageProvider = class extends AbstractParserErrorMessageProvider {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LangiumParserErrorMessageProvider");
...
var LangiumCompletionParser = class extends AbstractLangiumParser {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LangiumCompletionParser");
    constructor(){
        super(...arguments);
        this.tokens = [];
        this.elementStack = [];
...
var ChevrotainWrapper = class extends EmbeddedActionsParser {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ChevrotainWrapper");
...
(0, _chunkDLQEHMXDMjs.__name)(createParser, "createParser");
...
(0, _chunkDLQEHMXDMjs.__name)(buildRules, "buildRules");
function buildElement(ctx, element, ignoreGuard = false) {
    ...
    if (isKeyword(element)) method = buildKeyword(ctx, element);
        ...
        method = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>ctx.parser.consume(idx, EOF, element), "method");
...
(0, _chunkDLQEHMXDMjs.__name)(buildElement, "buildElement");
function buildAction(ctx, action) {
    const actionType = getTypeName(action);
    return ()=>ctx.parser.action(actionType, action);
}
(0, _chunkDLQEHMXDMjs.__name)(buildAction, "buildAction");
function buildRuleCall(ctx, ruleCall) {
    ...
    } else if (!rule) throw new ErrorWithLocation(ruleCall.$cstNode, `Undefined rule type: ${ruleCall.$type}`);
    else assertUnreachable(rule);
}
(0, _chunkDLQEHMXDMjs.__name)(buildRuleCall, "buildRuleCall");
...
(0, _chunkDLQEHMXDMjs.__name)(buildRuleCallPredicate, "buildRuleCallPredicate");
...
(0, _chunkDLQEHMXDMjs.__name)(buildPredicate, "buildPredicate");
function buildAlternatives(ctx, alternatives) {
    if (alternatives.elements.length === 1) return buildElement(ctx, alternatives.elements[0]);
        ...
        return (args)=>ctx.parser.alternatives(idx, methods.map((method)=>{
                const alt = {
                    ALT: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>method.ALT(args), "ALT")
                };
...
(0, _chunkDLQEHMXDMjs.__name)(buildAlternatives, "buildAlternatives");
function buildUnorderedGroup(ctx, group) {
    ...
    const orIdx = ctx.or++;
    const idFunc = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((groupIdx, lParser)=>{
        const stackId = lParser.getRuleStack().join("-");
        return `uGroup_${groupIdx}_${stackId}`;
    }, "idFunc");
    const alternatives = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((args)=>ctx.parser.alternatives(orIdx, methods.map((method, idx)=>{
            const alt = {
                ALT: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>true, "ALT")
            };
...
(0, _chunkDLQEHMXDMjs.__name)(buildUnorderedGroup, "buildUnorderedGroup");
function buildGroup(ctx, group) {
    const methods = group.elements.map((e)=>buildElement(ctx, e));
    return (args)=>methods.forEach((method)=>method(args));
}
(0, _chunkDLQEHMXDMjs.__name)(buildGroup, "buildGroup");
function getGuardCondition(element) {
    if (isGroup(element)) return element.guardCondition;
    return void 0;
}
(0, _chunkDLQEHMXDMjs.__name)(getGuardCondition, "getGuardCondition");
...
(0, _chunkDLQEHMXDMjs.__name)(buildCrossReference, "buildCrossReference");
...
(0, _chunkDLQEHMXDMjs.__name)(buildKeyword, "buildKeyword");
function wrap(ctx, guard, method, cardinality) {
    ...
    if (!cardinality) {
        if (gate) {
            ...
            return (args)=>ctx.parser.alternatives(idx, [
                    {
                        ALT: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>method(args), "ALT"),
                        GATE: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>gate(args), "GATE")
                    },
                    {
                        ALT: EMPTY_ALT(),
                        GATE: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>!gate(args), "GATE")
    ...
    if (cardinality === "*") {
        ...
        return (args)=>ctx.parser.many(idx, {
                DEF: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>method(args), "DEF"),
        ...
        if (gate) {
            ...
            return (args)=>ctx.parser.alternatives(orIdx, [
                    {
                        ALT: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>ctx.parser.atLeastOne(idx, {
                                DEF: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>method(args), "DEF")
                            }), "ALT"),
                        GATE: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>gate(args), "GATE")
                    },
...
(0, _chunkDLQEHMXDMjs.__name)(getRule, "getRule");
...
(0, _chunkDLQEHMXDMjs.__name)(getRuleName, "getRuleName");
function getToken(ctx, name) {
    const token = ctx.tokens[name];
    if (!token) throw new Error(`Token "${name}" not found."`);
    return token;
}
(0, _chunkDLQEHMXDMjs.__name)(getToken, "getToken");
...
(0, _chunkDLQEHMXDMjs.__name)(createCompletionParser, "createCompletionParser");
...
(0, _chunkDLQEHMXDMjs.__name)(createLangiumParser, "createLangiumParser");
...
(0, _chunkDLQEHMXDMjs.__name)(prepareLangiumParser, "prepareLangiumParser");
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/parser/token-builder.js
var DefaultTokenBuilder = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultTokenBuilder");
...
var DefaultValueConverter = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultValueConverter");
...
(function(ValueConverter2) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(convertString, "convertString");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(convertEscapeCharacter, "convertEscapeCharacter");
    function convertID(input) {
        if (input.charAt(0) === "^") return input.substring(1);
        else return input;
    }
    (0, _chunkDLQEHMXDMjs.__name)(convertID, "convertID");
    ValueConverter2.convertID = convertID;
    function convertInt(input) {
        return parseInt(input);
    }
    (0, _chunkDLQEHMXDMjs.__name)(convertInt, "convertInt");
    ValueConverter2.convertInt = convertInt;
    function convertBigint(input) {
        return BigInt(input);
    }
    (0, _chunkDLQEHMXDMjs.__name)(convertBigint, "convertBigint");
    ValueConverter2.convertBigint = convertBigint;
    function convertDate(input) {
        return new Date(input);
    }
    (0, _chunkDLQEHMXDMjs.__name)(convertDate, "convertDate");
    ValueConverter2.convertDate = convertDate;
    function convertNumber(input) {
        return Number(input);
    }
    (0, _chunkDLQEHMXDMjs.__name)(convertNumber, "convertNumber");
    ValueConverter2.convertNumber = convertNumber;
    function convertBoolean(input) {
        return input.toLowerCase() === "true";
    }
    (0, _chunkDLQEHMXDMjs.__name)(convertBoolean, "convertBoolean");
...
(0, _chunkDLQEHMXDMjs.__reExport)(cancellation_exports, (0, _chunkDLQEHMXDMjs.__toESM)(require_cancellation(), 1));
...
(0, _chunkDLQEHMXDMjs.__name)(delayNextTick, "delayNextTick");
var lastTick = 0;
...
(0, _chunkDLQEHMXDMjs.__name)(startCancelableOperation, "startCancelableOperation");
function setInterruptionPeriod(period) {
    globalInterruptionPeriod = period;
}
(0, _chunkDLQEHMXDMjs.__name)(setInterruptionPeriod, "setInterruptionPeriod");
var OperationCancelled = Symbol("OperationCancelled");
function isOperationCancelled(err) {
    return err === OperationCancelled;
}
(0, _chunkDLQEHMXDMjs.__name)(isOperationCancelled, "isOperationCancelled");
...
(0, _chunkDLQEHMXDMjs.__name)(interruptAndCheck, "interruptAndCheck");
var Deferred = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Deferred");
    constructor(){
...
(function(TextDocument3) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(update, "update");
...
(0, _chunkDLQEHMXDMjs.__name)(mergeSort, "mergeSort");
...
(0, _chunkDLQEHMXDMjs.__name)(computeLineOffsets, "computeLineOffsets");
function isEOL(char) {
    return char === 13 || char === 10;
}
(0, _chunkDLQEHMXDMjs.__name)(isEOL, "isEOL");
...
(0, _chunkDLQEHMXDMjs.__name)(getWellformedRange, "getWellformedRange");
...
(0, _chunkDLQEHMXDMjs.__name)(getWellformedEdit, "getWellformedEdit");
...
(()=>{
    ...
    var t = {
        470: (t2)=>{
            ...
            (0, _chunkDLQEHMXDMjs.__name)(e2, "e");
            function r2(t3, e3) {
            ...
            (0, _chunkDLQEHMXDMjs.__name)(r2, "r");
            var n2 = {
                resolve: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
                ...
                normalize: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3) {
                ...
                isAbsolute: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3) {
                    return e2(t3), t3.length > 0 && 47 === t3.charCodeAt(0);
                }, "isAbsolute"),
                join: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
                ...
                relative: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3, r3) {
                ...
                _makeLong: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3) {
                    return t3;
                }, "_makeLong"),
                dirname: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3) {
                    if (e2(t3), 0 === t3.length) return ".";
                ...
                basename: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3, r3) {
                ...
                extname: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3) {
                    e2(t3);
                ...
                format: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3) {
                ...
                parse: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(t3) {
                    e2(t3);
                    var r3 = {
                        root: "",
                        dir: "",
    ...
    (0, _chunkDLQEHMXDMjs.__name)(r, "r");
    r.d = (t2, e2)=>{
    ...
    (()=>{
        let t2;
        r.r(n), r.d(n, {
            URI: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>f, "URI"),
            Utils: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>P, "Utils")
        });
        ...
        (0, _chunkDLQEHMXDMjs.__name)(s, "s");
        const h = "", a = "/", c = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/;
        class f {
            static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "f");
            static isUri(t3) {
        ...
        const u = t2 ? 1 : void 0;
        class l extends f {
            static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "l");
            _formatted = null;
            _fsPath = null;
            get fsPath() {
        ...
        (0, _chunkDLQEHMXDMjs.__name)(d, "d");
        function p(t3) {
            let e3;
        ...
        (0, _chunkDLQEHMXDMjs.__name)(p, "p");
        function m(e3, r2) {
            let n2;
        ...
        (0, _chunkDLQEHMXDMjs.__name)(m, "m");
        function y(t3, e3) {
            const r2 = e3 ? p : d;
        ...
        (0, _chunkDLQEHMXDMjs.__name)(v, "v");
        const b = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
        function C(t3) {
            return t3.match(b) ? t3.replace(b, (t4)=>v(t4)) : t3;
        }
        (0, _chunkDLQEHMXDMjs.__name)(C, "C");
        var A = r(470);
        const w = A.posix || A, x = "/";
        var P;
        !function(t3) {
...
(function(UriUtils2) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(equals, "equals");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(relative, "relative");
...
var DefaultLangiumDocumentFactory = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultLangiumDocumentFactory");
    constructor(services){
...
var DefaultLangiumDocuments = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultLangiumDocuments");
    constructor(services){
...
var DefaultLinker = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultLinker");
    constructor(services){
        ...
        const reference = {
            ...
            get ref () {
                ...
                if (isAstNode(this._ref)) return this._ref;
                    ...
                    if (refData.error && getDocument(node).state < DocumentState.ComputedScopes) return void 0;
    ...
    getLinkedNode(refInfo) {
        try {
            const description = this.getCandidate(refInfo);
            if (isLinkingError(description)) return {
                error: description
            };
            const linkedNode = this.loadAstNode(description);
    ...
    createLinkingError(refInfo, targetDescription) {
        ...
        if (document.state < DocumentState.ComputedScopes) console.warn(`Attempted reference resolution before document reached ComputedScopes state (${document.uri}).`);
...
(0, _chunkDLQEHMXDMjs.__name)(isNamed, "isNamed");
var DefaultNameProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultNameProvider");
    getName(node) {
...
var DefaultReferences = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultReferences");
    constructor(services){
        ...
        if (sourceCstNode) {
            ...
            if (assignment && nodeElem) {
                ...
                if (isReference(reference)) return reference.ref;
                    ...
                    if (isReference(ref) && ref.$refNode && ref.$refNode.offset <= sourceCstNode.offset && ref.$refNode.end >= sourceCstNode.end) return ref.ref;
                }
            }
            if (nodeElem) {
...
var MultiMap = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "MultiMap");
   ...
   */ entries() {
        return stream(this.map.entries()).flatMap(([key, array])=>array.map((value)=>[
                    key,
                    value
                ]));
    }
...
var BiMap = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "BiMap");
    get size() {
...
var DefaultScopeComputation = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultScopeComputation");
    constructor(services){
        this.nameProvider = services.references.NameProvider;
...
var StreamScope = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "StreamScope");
...
var MapScope = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "MapScope");
    constructor(elements, outerScope, options){
        var _a;
...
var DisposableCache = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DisposableCache");
    constructor(){
        this.toDispose = [];
...
var SimpleCache = class extends DisposableCache {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "SimpleCache");
    constructor(){
        super(...arguments);
...
var ContextCache = class extends DisposableCache {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ContextCache");
...
var DocumentCache = class extends ContextCache {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DocumentCache");
...
var WorkspaceCache = class extends SimpleCache {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "WorkspaceCache");
    constructor(sharedServices){
        super();
...
var DefaultScopeProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultScopeProvider");
    constructor(services){
        this.reflection = services.shared.AstReflection;
        this.nameProvider = services.references.NameProvider;
        this.descriptions = services.workspace.AstNodeDescriptionProvider;
...
(0, _chunkDLQEHMXDMjs.__name)(isAstNodeWithComment, "isAstNodeWithComment");
function isIntermediateReference(obj) {
    return typeof obj === "object" && !!obj && ("$ref" in obj || "$error" in obj);
}
(0, _chunkDLQEHMXDMjs.__name)(isIntermediateReference, "isIntermediateReference");
var DefaultJsonSerializer = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultJsonSerializer");
    constructor(services){
    ...
    serialize(node, options = {}) {
        ...
        const defaultReplacer = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((key, value)=>this.replacer(key, value, options), "defaultReplacer");
    ...
    addAstNodeRegionWithAssignmentsTo(node) {
        const createDocumentSegment = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((cstNode)=>({
...
var DefaultServiceRegistry = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultServiceRegistry");
    register(language) {
...
(0, _chunkDLQEHMXDMjs.__name)(diagnosticData, "diagnosticData");
...
var ValidationRegistry = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ValidationRegistry");
    constructor(services){
...
var DefaultDocumentValidator = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultDocumentValidator");
    constructor(services){
    ...
    async validateAst(rootNode, options, cancelToken = cancellation_exports.CancellationToken.None) {
        ...
        const acceptor = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((severity, message, info)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(getDiagnosticRange, "getDiagnosticRange");
...
(0, _chunkDLQEHMXDMjs.__name)(toDiagnosticSeverity, "toDiagnosticSeverity");
...
var DefaultAstNodeDescriptionProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultAstNodeDescriptionProvider");
    constructor(services){
        this.astNodeLocator = services.workspace.AstNodeLocator;
        this.nameProvider = services.references.NameProvider;
    }
    createDescription(node, name, document = getDocument(node)) {
        ...
        let nameNodeSegment;
        const nameSegmentGetter = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
            var _a;
...
var DefaultReferenceDescriptionProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultReferenceDescriptionProvider");
    constructor(services){
        this.nodeLocator = services.workspace.AstNodeLocator;
    }
...
var DefaultAstNodeLocator = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultAstNodeLocator");
    constructor(){
...
var DefaultConfigurationProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultConfigurationProvider");
    constructor(services){
...
(function(Disposable2) {
    function create(callback) {
        return {
            dispose: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async ()=>await callback(), "dispose")
        };
    }
    (0, _chunkDLQEHMXDMjs.__name)(create, "create");
...
var DefaultDocumentBuilder = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultDocumentBuilder");
    constructor(services){
...
var DefaultIndexManager = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultIndexManager");
    constructor(services){
...
var DefaultWorkspaceManager = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultWorkspaceManager");
    constructor(services){
   ...
   */ async performStartup(folders) {
        ...
        const documents = [];
        const collector = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((document)=>{
...
var DefaultLexer = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultLexer");
    constructor(services){
...
(0, _chunkDLQEHMXDMjs.__name)(isTokenTypeArray, "isTokenTypeArray");
function isIMultiModeLexerDefinition(tokenVocabulary) {
    return tokenVocabulary && "modes" in tokenVocabulary && "defaultMode" in tokenVocabulary;
}
(0, _chunkDLQEHMXDMjs.__name)(isIMultiModeLexerDefinition, "isIMultiModeLexerDefinition");
function isTokenTypeDictionary(tokenVocabulary) {
    return !isTokenTypeArray(tokenVocabulary) && !isIMultiModeLexerDefinition(tokenVocabulary);
}
(0, _chunkDLQEHMXDMjs.__name)(isTokenTypeDictionary, "isTokenTypeDictionary");
...
(0, _chunkDLQEHMXDMjs.__name)(parseJSDoc, "parseJSDoc");
...
(0, _chunkDLQEHMXDMjs.__name)(isJSDoc, "isJSDoc");
...
(0, _chunkDLQEHMXDMjs.__name)(getLines, "getLines");
...
(0, _chunkDLQEHMXDMjs.__name)(tokenize, "tokenize");
...
(0, _chunkDLQEHMXDMjs.__name)(buildInlineTokens, "buildInlineTokens");
...
(0, _chunkDLQEHMXDMjs.__name)(skipWhitespace, "skipWhitespace");
function lastCharacter(line) {
    const match = line.match(whitespaceEndRegex);
    if (match && typeof match.index === "number") return match.index;
    return void 0;
}
(0, _chunkDLQEHMXDMjs.__name)(lastCharacter, "lastCharacter");
...
(0, _chunkDLQEHMXDMjs.__name)(parseJSDocComment, "parseJSDocComment");
...
(0, _chunkDLQEHMXDMjs.__name)(parseJSDocElement, "parseJSDocElement");
...
(0, _chunkDLQEHMXDMjs.__name)(appendEmptyLine, "appendEmptyLine");
...
(0, _chunkDLQEHMXDMjs.__name)(parseJSDocText, "parseJSDocText");
function parseJSDocInline(context) {
    const token = context.tokens[context.index];
    if (token.type === "inline-tag") return parseJSDocTag(context, true);
    else return parseJSDocLine(context);
}
(0, _chunkDLQEHMXDMjs.__name)(parseJSDocInline, "parseJSDocInline");
    ...
    if ((nextToken === null || nextToken === void 0 ? void 0 : nextToken.type) === "text") {
        if (inline) {
            ...
            return new JSDocTagImpl(name, new JSDocTextImpl([
                docLine
            ], docLine.range), inline, Range.create(tagToken.range.start, docLine.range.end));
        } else {
...
(0, _chunkDLQEHMXDMjs.__name)(parseJSDocTag, "parseJSDocTag");
function parseJSDocLine(context) {
    const token = context.tokens[context.index++];
    return new JSDocLineImpl(token.content, token.range);
}
(0, _chunkDLQEHMXDMjs.__name)(parseJSDocLine, "parseJSDocLine");
...
(0, _chunkDLQEHMXDMjs.__name)(normalizeOptions, "normalizeOptions");
...
(0, _chunkDLQEHMXDMjs.__name)(normalizeOption, "normalizeOption");
var JSDocCommentImpl = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "JSDocCommentImpl");
...
var JSDocTagImpl = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "JSDocTagImpl");
...
(0, _chunkDLQEHMXDMjs.__name)(renderInlineTag, "renderInlineTag");
...
(0, _chunkDLQEHMXDMjs.__name)(renderLinkDefault, "renderLinkDefault");
var JSDocTextImpl = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "JSDocTextImpl");
...
var JSDocLineImpl = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "JSDocLineImpl");
...
(0, _chunkDLQEHMXDMjs.__name)(fillNewlines, "fillNewlines");
...
var JSDocDocumentationProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "JSDocDocumentationProvider");
    constructor(services){
        this.indexManager = services.shared.workspace.IndexManager;
        this.commentProvider = services.documentation.CommentProvider;
    }
    getDocumentation(node) {
        ...
        if (comment && isJSDoc(comment)) {
            ...
            return parsedJSDoc.toMarkdown({
                renderLink: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((link, display)=>{
                    return this.documentationLinkRenderer(node, link, display);
                }, "renderLink"),
                renderTag: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((tag)=>{
...
var DefaultCommentProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultCommentProvider");
    constructor(services){
...
var event_exports = {};
(0, _chunkDLQEHMXDMjs.__reExport)(event_exports, (0, _chunkDLQEHMXDMjs.__toESM)(require_events(), 1));
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/parser/async-parser.js
var DefaultAsyncParser = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultAsyncParser");
    constructor(services){
...
var AbstractThreadedAsyncParser = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractThreadedAsyncParser");
    constructor(services){
        this.threadCount = 8;
...
var ParserWorker = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ParserWorker");
    get ready() {
        return this._ready;
    }
    get onReady() {
...
var DefaultWorkspaceLock = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultWorkspaceLock");
    constructor(){
...
var DefaultHydrator = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DefaultHydrator");
    constructor(services){
        ...
        for (const [name, value] of Object.entries(node)){
            ...
            if (Array.isArray(value)) {
                ...
                for (const item of value){
                    if (isAstNode(item)) arr.push(this.dehydrateAstNode(item, context));
    ...
    hydrateAstNode(node, context) {
        ...
        for (const [name, value] of Object.entries(node)){
            ...
            if (Array.isArray(value)) {
                ...
                astNode[name] = arr;
                for (const item of value){
                    if (isAstNode(item)) arr.push(this.setParent(this.hydrateAstNode(item, context), astNode));
...
function createDefaultCoreModule(context) {
    return {
        documentation: {
            CommentProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultCommentProvider(services), "CommentProvider"),
            DocumentationProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new JSDocDocumentationProvider(services), "DocumentationProvider")
        },
        parser: {
            AsyncParser: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultAsyncParser(services), "AsyncParser"),
            GrammarConfig: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>createGrammarConfig(services), "GrammarConfig"),
            LangiumParser: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>createLangiumParser(services), "LangiumParser"),
            CompletionParser: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>createCompletionParser(services), "CompletionParser"),
            ValueConverter: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new DefaultValueConverter(), "ValueConverter"),
            TokenBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new DefaultTokenBuilder(), "TokenBuilder"),
            Lexer: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultLexer(services), "Lexer"),
            ParserErrorMessageProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new LangiumParserErrorMessageProvider(), "ParserErrorMessageProvider")
        },
        workspace: {
            AstNodeLocator: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new DefaultAstNodeLocator(), "AstNodeLocator"),
            AstNodeDescriptionProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultAstNodeDescriptionProvider(services), "AstNodeDescriptionProvider"),
            ReferenceDescriptionProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultReferenceDescriptionProvider(services), "ReferenceDescriptionProvider")
        },
        references: {
            Linker: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultLinker(services), "Linker"),
            NameProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new DefaultNameProvider(), "NameProvider"),
            ScopeProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultScopeProvider(services), "ScopeProvider"),
            ScopeComputation: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultScopeComputation(services), "ScopeComputation"),
            References: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultReferences(services), "References")
        },
        serializer: {
            Hydrator: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultHydrator(services), "Hydrator"),
            JsonSerializer: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultJsonSerializer(services), "JsonSerializer")
        },
        validation: {
            DocumentValidator: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultDocumentValidator(services), "DocumentValidator"),
            ValidationRegistry: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new ValidationRegistry(services), "ValidationRegistry")
        },
        shared: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>context.shared, "shared")
    };
}
(0, _chunkDLQEHMXDMjs.__name)(createDefaultCoreModule, "createDefaultCoreModule");
function createDefaultSharedCoreModule(context) {
    return {
        ServiceRegistry: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new DefaultServiceRegistry(), "ServiceRegistry"),
        workspace: {
            LangiumDocuments: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultLangiumDocuments(services), "LangiumDocuments"),
            LangiumDocumentFactory: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultLangiumDocumentFactory(services), "LangiumDocumentFactory"),
            DocumentBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultDocumentBuilder(services), "DocumentBuilder"),
            IndexManager: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultIndexManager(services), "IndexManager"),
            WorkspaceManager: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultWorkspaceManager(services), "WorkspaceManager"),
            FileSystemProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>context.fileSystemProvider(services), "FileSystemProvider"),
            WorkspaceLock: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new DefaultWorkspaceLock(), "WorkspaceLock"),
            ConfigurationProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((services)=>new DefaultConfigurationProvider(services), "ConfigurationProvider")
        }
    };
}
(0, _chunkDLQEHMXDMjs.__name)(createDefaultSharedCoreModule, "createDefaultSharedCoreModule");
...
(0, _chunkDLQEHMXDMjs.__name)(inject, "inject");
var isProxy = Symbol("isProxy");
function eagerLoad(item) {
    if (item && item[isProxy]) for (const value of Object.values(item))eagerLoad(value);
    return item;
}
(0, _chunkDLQEHMXDMjs.__name)(eagerLoad, "eagerLoad");
function _inject(module, injector) {
    const proxy = new Proxy({}, {
        deleteProperty: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>false, "deleteProperty"),
        get: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((obj, prop)=>_resolve(obj, prop, module, injector || proxy), "get"),
        getOwnPropertyDescriptor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((obj, prop)=>(_resolve(obj, prop, module, injector || proxy), Object.getOwnPropertyDescriptor(obj, prop)), "getOwnPropertyDescriptor"),
        has: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((_, prop)=>prop in module, "has"),
        ownKeys: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>[
...
(0, _chunkDLQEHMXDMjs.__name)(_inject, "_inject");
...
function _resolve(obj, prop, module, injector) {
    if (prop in obj) {
        ...
        if (obj[prop] === __requested__) throw new Error('Cycle detected. Please make "' + String(prop) + '" lazy. See https://langium.org/docs/configuration-services/#resolving-cyclic-dependencies');
        return obj[prop];
...
(0, _chunkDLQEHMXDMjs.__name)(_resolve, "_resolve");
...
(0, _chunkDLQEHMXDMjs.__name)(_merge, "_merge");
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/utils/index.js
var utils_exports = {};
(0, _chunkDLQEHMXDMjs.__export)(utils_exports, {
    AstUtils: ()=>ast_utils_exports,
    BiMap: ()=>BiMap,
    Cancellation: ()=>cancellation_exports,
    ContextCache: ()=>ContextCache,
...
(0, _chunkDLQEHMXDMjs.__reExport)(utils_exports, event_exports);
...
var EmptyFileSystemProvider = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "EmptyFileSystemProvider");
    readFile() {
...
var EmptyFileSystem = {
    fileSystemProvider: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new EmptyFileSystemProvider(), "fileSystemProvider")
};
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/utils/grammar-loader.js
var minimalGrammarModule = {
    Grammar: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>void 0, "Grammar"),
    LanguageMetaData: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>({
...
var minimalSharedGrammarModule = {
    AstReflection: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>new LangiumGrammarAstReflection(), "AstReflection")
};
...
(0, _chunkDLQEHMXDMjs.__name)(createMinimalGrammarServices, "createMinimalGrammarServices");
...
(0, _chunkDLQEHMXDMjs.__name)(loadGrammarFromJson, "loadGrammarFromJson");
// ../../node_modules/.pnpm/langium@3.0.0/node_modules/langium/lib/index.js
(0, _chunkDLQEHMXDMjs.__reExport)(lib_exports, utils_exports);
// ../parser/dist/chunks/mermaid-parser.core/chunk-U3TRWOCV.mjs
var __defProp = Object.defineProperty;
var __name2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((target, value)=>__defProp(target, "name", {
        value,
        configurable: true
    }), "__name");
...
(0, _chunkDLQEHMXDMjs.__name)(isBranch, "isBranch");
...
var AbstractMermaidValueConverter = class extends DefaultValueConverter {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractMermaidValueConverter");
    static #_2 = __name2(this, "AbstractMermaidValueConverter");
    runConverter(rule, input, cstNode) {
...
var CommonValueConverter = class extends AbstractMermaidValueConverter {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "CommonValueConverter");
    static #_2 = __name2(this, "CommonValueConverter");
    runCustomConverter(_rule, _input, _cstNode) {
        return void 0;
    }
};
var AbstractMermaidTokenBuilder = class extends DefaultTokenBuilder {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "AbstractMermaidTokenBuilder");
    static #_2 = __name2(this, "AbstractMermaidTokenBuilder");
...
var CommonTokenBuilder = class extends AbstractMermaidTokenBuilder {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "CommonTokenBuilder");
    static #_2 = __name2(this, "CommonTokenBuilder");
};

},{"a5cec28e8e7796c":"fjG6A","./chunk-TZBO7MLI.mjs":"fY3tK","./chunk-GRZAG2UZ.mjs":"d1pnj","./chunk-HD3LK5B5.mjs":"lpo2u","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}],"fjG6A":[function(require,module,exports,__globalThis) {
...
},{}],"6Rhiy":[function(require,module,exports,__globalThis) {
module.exports = require("45a3603bcc25328a")(module.bundle.resolve("info-PWGDJKR5-EWYWRXAE.2b95f8ed.js")).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('egqyC'));

},{"45a3603bcc25328a":"f82WQ","egqyC":"egqyC"}],"f82WQ":[function(require,module,exports,__globalThis) {
"use strict";
...
},{}],"4kIpd":[function(require,module,exports,__globalThis) {
module.exports = require("586050279e8263f0")(module.bundle.resolve("packet-7PPW3X5M-7FK7JLXI.b7f14de3.js")).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('aYrkI'));

},{"586050279e8263f0":"f82WQ","aYrkI":"aYrkI"}],"gDbnA":[function(require,module,exports,__globalThis) {
module.exports = require("f95d303f0a9a6257")(module.bundle.resolve("pie-RF5LNP4B-4BD42V5W.92e78606.js")).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('5eesl'));

},{"f95d303f0a9a6257":"f82WQ","5eesl":"5eesl"}],"dVsea":[function(require,module,exports,__globalThis) {
module.exports = require("495162d1ee6f2d3")(module.bundle.resolve("gitGraph-F2EDSAW4-EHNGVA3B.02b24063.js")).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('iHWI3'));

},{"495162d1ee6f2d3":"f82WQ","iHWI3":"iHWI3"}],"7LBdV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "InfoModule", ()=>InfoModule);
parcelHelpers.export(exports, "createInfoServices", ()=>createInfoServices);
var _chunkHBGMPAD7Mjs = require("./chunk-HBGMPAD7.mjs");
var _chunkDLQEHMXDMjs = require("./chunk-DLQEHMXD.mjs");
// ../parser/dist/chunks/mermaid-parser.core/chunk-O2VHLUZY.mjs
var InfoTokenBuilder = class extends (0, _chunkHBGMPAD7Mjs.AbstractMermaidTokenBuilder) {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "InfoTokenBuilder");
    static #_2 = (0, _chunkHBGMPAD7Mjs.__name)(this, "InfoTokenBuilder");
    constructor(){
        super([
            "info",
            "showInfo"
...
var InfoModule = {
    parser: {
        TokenBuilder: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(()=>new InfoTokenBuilder(), "TokenBuilder"),
        ValueConverter: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(()=>new (0, _chunkHBGMPAD7Mjs.CommonValueConverter)(), "ValueConverter")
    }
};
function createInfoServices(context = (0, _chunkHBGMPAD7Mjs.EmptyFileSystem)) {
    const shared = (0, _chunkHBGMPAD7Mjs.inject)((0, _chunkHBGMPAD7Mjs.createDefaultSharedCoreModule)(context), (0, _chunkHBGMPAD7Mjs.MermaidGeneratedSharedModule));
    const Info = (0, _chunkHBGMPAD7Mjs.inject)((0, _chunkHBGMPAD7Mjs.createDefaultCoreModule)({
        shared
    }), (0, _chunkHBGMPAD7Mjs.InfoGeneratedModule), InfoModule);
...
(0, _chunkDLQEHMXDMjs.__name)(createInfoServices, "createInfoServices");
(0, _chunkHBGMPAD7Mjs.__name)(createInfoServices, "createInfoServices");

},{"./chunk-HBGMPAD7.mjs":"i5fzF","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}],"hbCHI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PacketModule", ()=>PacketModule);
parcelHelpers.export(exports, "createPacketServices", ()=>createPacketServices);
var _chunkHBGMPAD7Mjs = require("./chunk-HBGMPAD7.mjs");
var _chunkDLQEHMXDMjs = require("./chunk-DLQEHMXD.mjs");
// ../parser/dist/chunks/mermaid-parser.core/chunk-HTBTGXD4.mjs
var PacketTokenBuilder = class extends (0, _chunkHBGMPAD7Mjs.AbstractMermaidTokenBuilder) {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "PacketTokenBuilder");
    static #_2 = (0, _chunkHBGMPAD7Mjs.__name)(this, "PacketTokenBuilder");
    constructor(){
        super([
            "packet-beta"
        ]);
...
var PacketModule = {
    parser: {
        TokenBuilder: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(()=>new PacketTokenBuilder(), "TokenBuilder"),
        ValueConverter: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(()=>new (0, _chunkHBGMPAD7Mjs.CommonValueConverter)(), "ValueConverter")
    }
};
function createPacketServices(context = (0, _chunkHBGMPAD7Mjs.EmptyFileSystem)) {
    const shared = (0, _chunkHBGMPAD7Mjs.inject)((0, _chunkHBGMPAD7Mjs.createDefaultSharedCoreModule)(context), (0, _chunkHBGMPAD7Mjs.MermaidGeneratedSharedModule));
    const Packet = (0, _chunkHBGMPAD7Mjs.inject)((0, _chunkHBGMPAD7Mjs.createDefaultCoreModule)({
        shared
    }), (0, _chunkHBGMPAD7Mjs.PacketGeneratedModule), PacketModule);
...
(0, _chunkDLQEHMXDMjs.__name)(createPacketServices, "createPacketServices");
(0, _chunkHBGMPAD7Mjs.__name)(createPacketServices, "createPacketServices");

},{"./chunk-HBGMPAD7.mjs":"i5fzF","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}],"2wQrm":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PieModule", ()=>PieModule);
parcelHelpers.export(exports, "createPieServices", ()=>createPieServices);
var _chunkHBGMPAD7Mjs = require("./chunk-HBGMPAD7.mjs");
var _chunkDLQEHMXDMjs = require("./chunk-DLQEHMXD.mjs");
// ../parser/dist/chunks/mermaid-parser.core/chunk-NM56GJBF.mjs
var PieTokenBuilder = class extends (0, _chunkHBGMPAD7Mjs.AbstractMermaidTokenBuilder) {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "PieTokenBuilder");
    static #_2 = (0, _chunkHBGMPAD7Mjs.__name)(this, "PieTokenBuilder");
    constructor(){
        super([
            "pie",
            "showData"
...
var PieValueConverter = class extends (0, _chunkHBGMPAD7Mjs.AbstractMermaidValueConverter) {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "PieValueConverter");
    static #_2 = (0, _chunkHBGMPAD7Mjs.__name)(this, "PieValueConverter");
...
var PieModule = {
    parser: {
        TokenBuilder: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(()=>new PieTokenBuilder(), "TokenBuilder"),
        ValueConverter: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(()=>new PieValueConverter(), "ValueConverter")
    }
};
function createPieServices(context = (0, _chunkHBGMPAD7Mjs.EmptyFileSystem)) {
    const shared = (0, _chunkHBGMPAD7Mjs.inject)((0, _chunkHBGMPAD7Mjs.createDefaultSharedCoreModule)(context), (0, _chunkHBGMPAD7Mjs.MermaidGeneratedSharedModule));
    const Pie = (0, _chunkHBGMPAD7Mjs.inject)((0, _chunkHBGMPAD7Mjs.createDefaultCoreModule)({
        shared
    }), (0, _chunkHBGMPAD7Mjs.PieGeneratedModule), PieModule);
...
(0, _chunkDLQEHMXDMjs.__name)(createPieServices, "createPieServices");
(0, _chunkHBGMPAD7Mjs.__name)(createPieServices, "createPieServices");

},{"./chunk-HBGMPAD7.mjs":"i5fzF","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}],"gw2Ak":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "GitGraphModule", ()=>GitGraphModule);
parcelHelpers.export(exports, "createGitGraphServices", ()=>createGitGraphServices);
var _chunkHBGMPAD7Mjs = require("./chunk-HBGMPAD7.mjs");
var _chunkDLQEHMXDMjs = require("./chunk-DLQEHMXD.mjs");
// ../parser/dist/chunks/mermaid-parser.core/chunk-QE2ZKFLT.mjs
var GitGraphTokenBuilder = class extends (0, _chunkHBGMPAD7Mjs.AbstractMermaidTokenBuilder) {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "GitGraphTokenBuilder");
    static #_2 = (0, _chunkHBGMPAD7Mjs.__name)(this, "GitGraphTokenBuilder");
    constructor(){
        super([
            "gitGraph"
        ]);
...
var GitGraphModule = {
    parser: {
        TokenBuilder: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(()=>new GitGraphTokenBuilder(), "TokenBuilder"),
        ValueConverter: /* @__PURE__ */ (0, _chunkHBGMPAD7Mjs.__name)(()=>new (0, _chunkHBGMPAD7Mjs.CommonValueConverter)(), "ValueConverter")
    }
};
function createGitGraphServices(context = (0, _chunkHBGMPAD7Mjs.EmptyFileSystem)) {
    const shared = (0, _chunkHBGMPAD7Mjs.inject)((0, _chunkHBGMPAD7Mjs.createDefaultSharedCoreModule)(context), (0, _chunkHBGMPAD7Mjs.MermaidGeneratedSharedModule));
    const GitGraph = (0, _chunkHBGMPAD7Mjs.inject)((0, _chunkHBGMPAD7Mjs.createDefaultCoreModule)({
        shared
    }), (0, _chunkHBGMPAD7Mjs.GitGraphGeneratedModule), GitGraphModule);
...
(0, _chunkDLQEHMXDMjs.__name)(createGitGraphServices, "createGitGraphServices");
(0, _chunkHBGMPAD7Mjs.__name)(createGitGraphServices, "createGitGraphServices");

},{"./chunk-HBGMPAD7.mjs":"i5fzF","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}]},["3jzL3"], null, "parcelRequire6955", {}, "./", "/")

//# sourceMappingURL=gitGraphDiagram-L4TVWIEC.4d2196bb.js.map
