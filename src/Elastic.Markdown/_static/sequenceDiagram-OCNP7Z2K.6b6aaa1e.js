...
})({"gkhAa":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "c281a80d6b6aaa1e";
"use strict";
...
},{}],"kR2Yk":[function(require,module,exports,__globalThis) {
...
var addBox = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(data) {
...
var addActor = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(id, name, description, type) {
...
var activationCount = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((part)=>{
    let i;
    let count = 0;
    if (!part) return 0;
    for(i = 0; i < state.records.messages.length; i++){
        if (state.records.messages[i].type === LINETYPE.ACTIVE_START && state.records.messages[i].from === part) count++;
        if (state.records.messages[i].type === LINETYPE.ACTIVE_END && state.records.messages[i].from === part) count--;
    }
    return count;
}, "activationCount");
var addMessage = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(idFrom, idTo, message, answer) {
...
var addSignal = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(idFrom, idTo, message, messageType, activate = false) {
...
var hasAtLeastOneBox = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return state.records.boxes.length > 0;
}, "hasAtLeastOneBox");
var hasAtLeastOneBoxWithTitle = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return state.records.boxes.some((b)=>b.name);
}, "hasAtLeastOneBoxWithTitle");
var getMessages = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return state.records.messages;
}, "getMessages");
var getBoxes = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return state.records.boxes;
}, "getBoxes");
var getActors = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return state.records.actors;
}, "getActors");
var getCreatedActors = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return state.records.createdActors;
}, "getCreatedActors");
var getDestroyedActors = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return state.records.destroyedActors;
}, "getDestroyedActors");
var getActor = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(id) {
    return state.records.actors.get(id);
}, "getActor");
var getActorKeys = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return [
        ...state.records.actors.keys()
    ];
}, "getActorKeys");
var enableSequenceNumbers = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    state.records.sequenceNumbersEnabled = true;
}, "enableSequenceNumbers");
var disableSequenceNumbers = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    state.records.sequenceNumbersEnabled = false;
}, "disableSequenceNumbers");
var showSequenceNumbers = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>state.records.sequenceNumbersEnabled, "showSequenceNumbers");
var setWrap = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(wrapSetting) {
    state.records.wrapEnabled = wrapSetting;
}, "setWrap");
var extractWrap = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((text)=>{
...
var autoWrap = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
    if (state.records.wrapEnabled !== void 0) return state.records.wrapEnabled;
    return (0, _chunkDD37ZF33Mjs.getConfig2)().sequence?.wrap ?? false;
}, "autoWrap");
var clear2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    state.reset();
    (0, _chunkDD37ZF33Mjs.clear)();
}, "clear");
var parseMessage = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(str) {
    ...
    (0, _chunkDD37ZF33Mjs.log).debug(`parseMessage: ${JSON.stringify(message)}`);
    return message;
}, "parseMessage");
var parseBoxData = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(str) {
    ...
    return {
        text: cleanedText ? (0, _chunkDD37ZF33Mjs.sanitizeText)(cleanedText, (0, _chunkDD37ZF33Mjs.getConfig2)()) : void 0,
        color,
        wrap
    };
}, "parseBoxData");
...
var addNote = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actor, placement, message) {
    const note = {
        actor,
        placement,
        message: message.text,
...
var addLinks = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actorId, text) {
    const actor = getActor(actorId);
    try {
        let sanitizedText = (0, _chunkDD37ZF33Mjs.sanitizeText)(text.text, (0, _chunkDD37ZF33Mjs.getConfig2)());
        sanitizedText = sanitizedText.replace(/&amp;/g, "&");
        sanitizedText = sanitizedText.replace(/&equals;/g, "=");
        const links = JSON.parse(sanitizedText);
        insertLinks(actor, links);
    } catch (e) {
        (0, _chunkDD37ZF33Mjs.log).error("error while parsing actor link text", e);
    }
}, "addLinks");
var addALink = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actorId, text) {
    const actor = getActor(actorId);
    try {
        const links = {};
        let sanitizedText = (0, _chunkDD37ZF33Mjs.sanitizeText)(text.text, (0, _chunkDD37ZF33Mjs.getConfig2)());
...
(0, _chunkDLQEHMXDMjs.__name)(insertLinks, "insertLinks");
var addProperties = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actorId, text) {
    const actor = getActor(actorId);
    try {
        const sanitizedText = (0, _chunkDD37ZF33Mjs.sanitizeText)(text.text, (0, _chunkDD37ZF33Mjs.getConfig2)());
        const properties = JSON.parse(sanitizedText);
        insertProperties(actor, properties);
    } catch (e) {
        (0, _chunkDD37ZF33Mjs.log).error("error while parsing actor properties text", e);
    }
}, "addProperties");
...
(0, _chunkDLQEHMXDMjs.__name)(insertProperties, "insertProperties");
function boxEnd() {
    state.records.currentBox = void 0;
}
(0, _chunkDLQEHMXDMjs.__name)(boxEnd, "boxEnd");
var addDetails = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actorId, text) {
    const actor = getActor(actorId);
    ...
    try {
        ...
        (0, _chunkDD37ZF33Mjs.log).error("error while parsing actor details text", e);
    }
}, "addDetails");
var getActorProperty = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actor, key) {
    if (actor?.properties !== void 0) return actor.properties[key];
    return void 0;
}, "getActorProperty");
var apply = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(param) {
    if (Array.isArray(param)) param.forEach(function(item) {
        ...
        case "createParticipant":
            if (state.records.actors.has(param.actor)) throw new Error("It is not possible to have actors with the same id, even if one is destroyed before the next is created. Use 'AS' aliases to simulate the behavior");
        ...
        case "addMessage":
            if (state.records.lastCreated) {
                if (param.to !== state.records.lastCreated) throw new Error("The created participant " + state.records.lastCreated.name + " does not have an associated creating message after its declaration. Please check the sequence diagram.");
                else state.records.lastCreated = void 0;
            } else if (state.records.lastDestroyed) {
                if (param.to !== state.records.lastDestroyed && param.from !== state.records.lastDestroyed) throw new Error("The destroyed participant " + state.records.lastDestroyed.name + " does not have an associated destroying message after its declaration. Please check the sequence diagram.");
        ...
        case "altEnd":
            ...
            break;
        case "setAccTitle":
            (0, _chunkDD37ZF33Mjs.setAccTitle)(param.text);
            break;
        case "parStart":
...
var sequenceDb_default = {
    ...
    getConfig: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>(0, _chunkDD37ZF33Mjs.getConfig2)().sequence, "getConfig"),
    clear: clear2,
    parseMessage,
    parseBoxData,
    LINETYPE,
...
var getStyles = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((options)=>`.actor {
...
var drawPopup = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, actor, minMenuWidth, textAttrs, forceMenus) {
...
var popupMenuToggle = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(popId) {
    return "var pu = document.getElementById('" + popId + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }";
}, "popupMenuToggle");
var drawKatex = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(elem, textData, msgModel = null) {
    let textElem = elem.append("foreignObject");
    const lines = await (0, _chunkDD37ZF33Mjs.renderKatex)(textData.text, (0, _chunkDD37ZF33Mjs.getConfig)());
...
var drawText = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, textData) {
    ...
    let textHeight = 0;
    const lines = textData.text.split((0, _chunkDD37ZF33Mjs.common_default).lineBreakRegex);
    const [_textFontSize, _textFontSizePx] = (0, _chunkI7ZFS43CMjs.parseFontSize)(textData.fontSize);
    let textElems = [];
    let dy = 0;
    let yfunc = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>textData.y, "yfunc");
    if (textData.valign !== void 0 && textData.textMargin !== void 0 && textData.textMargin > 0) switch(textData.valign){
        case "top":
        case "start":
            yfunc = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>Math.round(textData.y + textData.textMargin), "yfunc");
            break;
        case "middle":
        case "center":
            yfunc = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>Math.round(textData.y + (prevTextHeight + textHeight + textData.textMargin) / 2), "yfunc");
            break;
        case "bottom":
        case "end":
            yfunc = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>Math.round(textData.y + (prevTextHeight + textHeight + 2 * textData.textMargin) - textData.textMargin), "yfunc");
            break;
    }
    ...
    for (let [i, line] of lines.entries()){
        ...
        const text = line || (0, _chunkI7ZFS43CMjs.ZERO_WIDTH_SPACE);
        if (textData.tspan) {
...
var actorCnt = -1;
var fixLifeLineHeights = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((diagram2, actors, actorKeys, conf2)=>{
...
var drawActorTypeParticipant = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, actor, conf2, isFooter) {
    ...
    if (actor.properties?.icon) {
        ...
        if (iconSrc.charAt(0) === "@") (0, _chunkXZYS6ULZMjs.drawEmbeddedImage)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc.substr(1));
        else (0, _chunkXZYS6ULZMjs.drawImage)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc);
    }
    _drawTextCandidateFunc(conf2, (0, _chunkDD37ZF33Mjs.hasKatex)(actor.description))(actor.description, g, rect.x, rect.y, rect.width, rect.height, {
...
var drawActorTypeActor = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, actor, conf2, isFooter) {
    const actorY = isFooter ? actor.stopy : actor.starty;
    const center = actor.x + actor.width / 2;
    ...
    actor.height = bounds2.height;
    _drawTextCandidateFunc(conf2, (0, _chunkDD37ZF33Mjs.hasKatex)(actor.description))(actor.description, actElem, rect.x, rect.y + 35, rect.width, rect.height, {
        class: `actor ${ACTOR_MAN_FIGURE_CLASS}`
    }, conf2);
    return actor.height;
}, "drawActorTypeActor");
var drawActor = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(elem, actor, conf2, isFooter) {
    switch(actor.type){
        case "actor":
...
var drawBox = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, box, conf2) {
...
var anchorElement = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem) {
    return elem.append("g");
}, "anchorElement");
var drawActivation = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, bounds2, verticalPos, conf2, actorActivations2) {
    const rect = (0, _chunkXZYS6ULZMjs.getNoteRect)();
...
var drawLoop = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(elem, loopModel, labelText, conf2) {
    ...
    const g = elem.append("g");
    const drawLoopLine = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(startx, starty, stopx, stopy) {
    ...
    let txt = (0, _chunkXZYS6ULZMjs.getTextObj)();
    txt.text = labelText;
    ...
    txt.fontWeight = fontWeight;
    txt.wrap = true;
    let textElem = (0, _chunkDD37ZF33Mjs.hasKatex)(txt.text) ? await drawKatex(g, txt, loopModel) : drawText(g, txt);
    if (loopModel.sectionTitles !== void 0) {
        for (const [idx, item] of Object.entries(loopModel.sectionTitles))if (item.message) {
            ...
            if ((0, _chunkDD37ZF33Mjs.hasKatex)(txt.text)) {
...
var drawBackgroundRect2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem, bounds2) {
    (0, _chunkXZYS6ULZMjs.drawBackgroundRect)(elem, bounds2);
}, "drawBackgroundRect");
...
var insertSequenceNumber = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(elem) {
...
var getTextObj2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return {
        x: 0,
        y: 0,
        fill: void 0,
...
var getNoteRect2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    return {
        x: 0,
        y: 0,
        fill: "#EDF2AE",
...
var _drawTextCandidateFunc = /* @__PURE__ */ function() {
    ...
    function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
        ...
        const [_actorFontSize, _actorFontSizePx] = (0, _chunkI7ZFS43CMjs.parseFontSize)(actorFontSize);
    ...
    async function byKatex(content, g, x, y, width, height, textAttrs, conf2) {
        const dim = await (0, _chunkDD37ZF33Mjs.calculateMathMLDimensions)(content, (0, _chunkDD37ZF33Mjs.getConfig)());
        const s = g.append("switch");
        ...
        text.append("div").style("text-align", "center").style("vertical-align", "middle").html(await (0, _chunkDD37ZF33Mjs.renderKatex)(content, (0, _chunkDD37ZF33Mjs.getConfig)()));
        byTspan(content, s, x, y, width, height, textAttrs, conf2);
        _setTextAttrs(text, textAttrs);
    }
    (0, _chunkDLQEHMXDMjs.__name)(byKatex, "byKatex");
...
var bounds = {
    ...
    activations: [],
    models: {
        getHeight: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
        ...
        clear: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
            this.actors = [];
            this.boxes = [];
            this.loops = [];
            this.messages = [];
        ...
        addBox: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(boxModel) {
            this.boxes.push(boxModel);
        }, "addBox"),
        addActor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actorModel) {
            this.actors.push(actorModel);
        }, "addActor"),
        addLoop: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(loopModel) {
            this.loops.push(loopModel);
        }, "addLoop"),
        addMessage: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(msgModel) {
            this.messages.push(msgModel);
        }, "addMessage"),
        addNote: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(noteModel) {
            this.notes.push(noteModel);
        }, "addNote"),
        lastActor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
            return this.actors[this.actors.length - 1];
        }, "lastActor"),
        lastLoop: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
            return this.loops[this.loops.length - 1];
        }, "lastLoop"),
        lastMessage: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
            return this.messages[this.messages.length - 1];
        }, "lastMessage"),
        lastNote: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
    ...
    init: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
        this.sequenceItems = [];
        this.activations = [];
        this.models.clear();
        this.data = {
        ...
        this.verticalPos = 0;
        setConf((0, _chunkDD37ZF33Mjs.getConfig2)());
    }, "init"),
    updateVal: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(obj, key, val, fun) {
        if (obj[key] === void 0) obj[key] = val;
        else obj[key] = fun(val, obj[key]);
    }, "updateVal"),
    updateBounds: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(startx, starty, stopx, stopy) {
        const _self = this;
        let cnt = 0;
        function updateFn(type) {
            return /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function updateItemBounds(item) {
                cnt++;
        ...
        (0, _chunkDLQEHMXDMjs.__name)(updateFn, "updateFn");
        this.sequenceItems.forEach(updateFn());
        this.activations.forEach(updateFn("activation"));
    }, "updateBounds"),
    insert: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(startx, starty, stopx, stopy) {
        const _startx = (0, _chunkDD37ZF33Mjs.common_default).getMin(startx, stopx);
        const _stopx = (0, _chunkDD37ZF33Mjs.common_default).getMax(startx, stopx);
        const _starty = (0, _chunkDD37ZF33Mjs.common_default).getMin(starty, stopy);
        const _stopy = (0, _chunkDD37ZF33Mjs.common_default).getMax(starty, stopy);
    ...
    newActivation: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(message, diagram2, actors) {
    ...
    endActivation: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(message) {
        const lastActorActivationIdx = this.activations.map(function(activation) {
            return activation.actor;
        }).lastIndexOf(message.from);
        return this.activations.splice(lastActorActivationIdx, 1)[0];
    }, "endActivation"),
    createLoop: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(title = {
        message: void 0,
        wrap: false,
        width: void 0
    }, fill) {
    ...
    newLoop: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(title = {
        message: void 0,
        wrap: false,
        width: void 0
    }, fill) {
    ...
    endLoop: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
        return this.sequenceItems.pop();
    }, "endLoop"),
    isLoopOverlap: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
        return this.sequenceItems.length ? this.sequenceItems[this.sequenceItems.length - 1].overlap : false;
    }, "isLoopOverlap"),
    addSectionToLoop: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(message) {
    ...
    saveVerticalPos: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
        if (this.isLoopOverlap()) this.savedVerticalPos = this.verticalPos;
    }, "saveVerticalPos"),
    resetVerticalPos: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
        if (this.isLoopOverlap()) this.verticalPos = this.savedVerticalPos;
    }, "resetVerticalPos"),
    bumpVerticalPos: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(bump) {
        this.verticalPos = this.verticalPos + bump;
        this.data.stopy = (0, _chunkDD37ZF33Mjs.common_default).getMax(this.data.stopy, this.verticalPos);
    }, "bumpVerticalPos"),
    getVerticalPos: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
        return this.verticalPos;
    }, "getVerticalPos"),
    getBounds: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function() {
        return {
            bounds: this.data,
            models: this.models
        };
...
var drawNote = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(elem, noteModel) {
    ...
    const textObj = (0, _chunkXZYS6ULZMjs.getTextObj)();
    ...
    const textElem = (0, _chunkDD37ZF33Mjs.hasKatex)(textObj.text) ? await drawKatex(g, textObj) : drawText(g, textObj);
...
var noteFont = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((cnf)=>{
    return {
...
var actorFont = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((cnf)=>{
    return {
...
async function boundMessage(_diagram, msgModel) {
    ...
    const lines = (0, _chunkDD37ZF33Mjs.common_default).splitBreaks(message).length;
    const isKatexMsg = (0, _chunkDD37ZF33Mjs.hasKatex)(message);
    const textDims = isKatexMsg ? await (0, _chunkDD37ZF33Mjs.calculateMathMLDimensions)(message, (0, _chunkDD37ZF33Mjs.getConfig2)()) : (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(message, messageFont(conf));
    if (!isKatexMsg) {
    ...
    if (startx === stopx) {
        ...
        totalOffset += 30;
        const dx = (0, _chunkDD37ZF33Mjs.common_default).getMax(textWidth / 2, conf.width / 2);
...
(0, _chunkDLQEHMXDMjs.__name)(boundMessage, "boundMessage");
var drawMessage = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(diagram2, msgModel, lineStartY, diagObj) {
    const { startx, stopx, starty, message, type, sequenceIndex, sequenceVisible } = msgModel;
    const textDims = (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(message, messageFont(conf));
    const textObj = (0, _chunkXZYS6ULZMjs.getTextObj)();
    textObj.x = startx;
    textObj.y = starty + 10;
    ...
    textObj.tspan = false;
    if ((0, _chunkDD37ZF33Mjs.hasKatex)(textObj.text)) await drawKatex(diagram2, textObj, {
        startx,
        stopx,
        starty: lineStartY
    });
    ...
    let line;
    if (startx === stopx) {
        if (conf.rightAngles) line = diagram2.append("path").attr("d", `M  ${startx},${lineStartY} H ${startx + (0, _chunkDD37ZF33Mjs.common_default).getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`);
...
var addActorRenderingData = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
    let prevWidth = 0;
    let prevMargin = 0;
    let prevBox = void 0;
    let maxHeight = 0;
    for (const actorKey of actorKeys){
        ...
        actor.height = (0, _chunkDD37ZF33Mjs.common_default).getMax(actor.height || conf.height, conf.height);
        actor.margin = actor.margin || conf.actorMargin;
        maxHeight = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxHeight, actor.height);
...
var drawActors = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(diagram2, actors, actorKeys, isFooter) {
    if (!isFooter) for (const actorKey of actorKeys){
        ...
        for (const actorKey of actorKeys){
            ...
            maxHeight = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxHeight, height);
        }
        bounds.bumpVerticalPos(maxHeight + conf.boxMargin);
    }
}, "drawActors");
var drawActorsPopup = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(diagram2, actors, actorKeys, doc) {
    let maxHeight = 0;
    let maxWidth = 0;
    for (const actorKey of actorKeys){
        const actor = actors.get(actorKey);
...
var actorActivations = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actor) {
    return bounds.activations.filter(function(activation) {
        return activation.actor === actor;
    });
}, "actorActivations");
var activationBounds = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actor, actors) {
    const actorObj = actors.get(actor);
    const activations = actorActivations(actor);
    const left = activations.reduce(function(acc, activation) {
        return (0, _chunkDD37ZF33Mjs.common_default).getMin(acc, activation.startx);
    }, actorObj.x + actorObj.width / 2 - 1);
    const right = activations.reduce(function(acc, activation) {
        return (0, _chunkDD37ZF33Mjs.common_default).getMax(acc, activation.stopx);
    }, actorObj.x + actorObj.width / 2 + 1);
    return [
        left,
        right
...
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
    ...
    if (msg.id && msg.message && loopWidths[msg.id]) {
        ...
        msg.message = (0, _chunkI7ZFS43CMjs.utils_default).wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
        msg.width = loopWidth;
        msg.wrap = true;
        const textDims = (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(msg.message, textConf);
        const totalOffset = (0, _chunkDD37ZF33Mjs.common_default).getMax(textDims.height, conf.labelBoxHeight);
        heightAdjust = postMargin + totalOffset;
        (0, _chunkDD37ZF33Mjs.log).debug(`${totalOffset} - ${msg.message}`);
    }
    addLoopFn(msg);
    bounds.bumpVerticalPos(heightAdjust);
}
(0, _chunkDLQEHMXDMjs.__name)(adjustLoopHeightForWrap, "adjustLoopHeightForWrap");
function adjustCreatedDestroyedData(msg, msgModel, lineStartY, index, actors, createdActors, destroyedActors) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(receiverAdjustment, "receiverAdjustment");
    ...
    (0, _chunkDLQEHMXDMjs.__name)(senderAdjustment, "senderAdjustment");
...
(0, _chunkDLQEHMXDMjs.__name)(adjustCreatedDestroyedData, "adjustCreatedDestroyedData");
var draw = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(_text, id, _version, diagObj) {
    const { securityLevel, sequence } = (0, _chunkDD37ZF33Mjs.getConfig2)();
    conf = sequence;
    let sandboxElement;
    ...
    bounds.init();
    (0, _chunkDD37ZF33Mjs.log).debug(diagObj.db);
    ...
    (0, _chunkDLQEHMXDMjs.__name)(activeEnd, "activeEnd");
    let sequenceIndex = 1;
        ...
        switch(msg.type){
            ...
            default:
                try {
                    ...
                    (0, _chunkDD37ZF33Mjs.log).error("error while drawing message", e);
                }
        }
        if ([
    ...
    (0, _chunkDD37ZF33Mjs.log).debug("createdActors", createdActors);
    (0, _chunkDD37ZF33Mjs.log).debug("destroyedActors", destroyedActors);
    ...
    (0, _chunkDD37ZF33Mjs.log).debug(`models:`, bounds.models);
}, "draw");
async function getMaxMessageWidthPerActor(actors, messages, diagObj) {
    ...
    for (const msg of messages)if (actors.get(msg.to) && actors.get(msg.from)) {
        ...
        const wrappedMessage = msg.wrap ? (0, _chunkI7ZFS43CMjs.utils_default).wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
        const messageDimensions = (0, _chunkDD37ZF33Mjs.hasKatex)(wrappedMessage) ? await (0, _chunkDD37ZF33Mjs.calculateMathMLDimensions)(msg.message, (0, _chunkDD37ZF33Mjs.getConfig2)()) : (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(wrappedMessage, textFont);
        const messageWidth = messageDimensions.width + 2 * conf.wrapPadding;
        if (isMessage && msg.from === actor.nextActor) maxMessageWidthPerActor[msg.to] = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxMessageWidthPerActor[msg.to] || 0, messageWidth);
        else if (isMessage && msg.from === actor.prevActor) maxMessageWidthPerActor[msg.from] = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxMessageWidthPerActor[msg.from] || 0, messageWidth);
        else if (isMessage && msg.from === msg.to) {
            maxMessageWidthPerActor[msg.from] = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxMessageWidthPerActor[msg.from] || 0, messageWidth / 2);
            maxMessageWidthPerActor[msg.to] = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxMessageWidthPerActor[msg.to] || 0, messageWidth / 2);
        } else if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) maxMessageWidthPerActor[msg.from] = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxMessageWidthPerActor[msg.from] || 0, messageWidth);
        else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) maxMessageWidthPerActor[actor.prevActor] = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxMessageWidthPerActor[actor.prevActor] || 0, messageWidth);
        else if (msg.placement === diagObj.db.PLACEMENT.OVER) {
            if (actor.prevActor) maxMessageWidthPerActor[actor.prevActor] = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxMessageWidthPerActor[actor.prevActor] || 0, messageWidth / 2);
            if (actor.nextActor) maxMessageWidthPerActor[msg.from] = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxMessageWidthPerActor[msg.from] || 0, messageWidth / 2);
        }
    }
    (0, _chunkDD37ZF33Mjs.log).debug("maxMessageWidthPerActor:", maxMessageWidthPerActor);
    return maxMessageWidthPerActor;
}
(0, _chunkDLQEHMXDMjs.__name)(getMaxMessageWidthPerActor, "getMaxMessageWidthPerActor");
var getRequiredPopupWidth = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(actor) {
    let requiredPopupWidth = 0;
    const textFont = actorFont(conf);
    for(const key in actor.links){
        const labelDimensions = (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(key, textFont);
...
async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
    ...
    for (const prop of actors.keys()){
        ...
        if (actor.wrap) actor.description = (0, _chunkI7ZFS43CMjs.utils_default).wrapLabel(actor.description, conf.width - 2 * conf.wrapPadding, actorFont(conf));
        const actDims = (0, _chunkDD37ZF33Mjs.hasKatex)(actor.description) ? await (0, _chunkDD37ZF33Mjs.calculateMathMLDimensions)(actor.description, (0, _chunkDD37ZF33Mjs.getConfig2)()) : (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(actor.description, actorFont(conf));
        actor.width = actor.wrap ? conf.width : (0, _chunkDD37ZF33Mjs.common_default).getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
        actor.height = actor.wrap ? (0, _chunkDD37ZF33Mjs.common_default).getMax(actDims.height, conf.height) : conf.height;
        maxHeight = (0, _chunkDD37ZF33Mjs.common_default).getMax(maxHeight, actor.height);
    }
    for(const actorKey in actorToMessageWidth){
        ...
        if (!nextActor) {
            ...
            actor.margin = (0, _chunkDD37ZF33Mjs.common_default).getMax(actorWidth2, conf.actorMargin);
            continue;
        }
        const messageWidth = actorToMessageWidth[actorKey];
        const actorWidth = messageWidth + conf.actorMargin - actor.width / 2 - nextActor.width / 2;
        actor.margin = (0, _chunkDD37ZF33Mjs.common_default).getMax(actorWidth, conf.actorMargin);
    }
    let maxBoxHeight = 0;
    boxes.forEach((box)=>{
        ...
        if (box.wrap) box.name = (0, _chunkI7ZFS43CMjs.utils_default).wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
        const boxMsgDimensions = (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(box.name, textFont);
        maxBoxHeight = (0, _chunkDD37ZF33Mjs.common_default).getMax(boxMsgDimensions.height, maxBoxHeight);
        const minWidth = (0, _chunkDD37ZF33Mjs.common_default).getMax(totalWidth, boxMsgDimensions.width + 2 * conf.wrapPadding);
    ...
    return (0, _chunkDD37ZF33Mjs.common_default).getMax(maxHeight, conf.height);
}
(0, _chunkDLQEHMXDMjs.__name)(calculateActorMargins, "calculateActorMargins");
var buildNoteModel = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(msg, actors, diagObj) {
    const fromActor = actors.get(msg.from);
    const toActor = actors.get(msg.to);
    const startx = fromActor.x;
    const stopx = toActor.x;
    const shouldWrap = msg.wrap && msg.message;
    let textDimensions = (0, _chunkDD37ZF33Mjs.hasKatex)(msg.message) ? await (0, _chunkDD37ZF33Mjs.calculateMathMLDimensions)(msg.message, (0, _chunkDD37ZF33Mjs.getConfig2)()) : (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(shouldWrap ? (0, _chunkI7ZFS43CMjs.utils_default).wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message, noteFont(conf));
    const noteModel = {
        width: shouldWrap ? conf.width : (0, _chunkDD37ZF33Mjs.common_default).getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
        height: 0,
        startx: fromActor.x,
        stopx: 0,
        starty: 0,
    ...
    if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
        noteModel.width = shouldWrap ? (0, _chunkDD37ZF33Mjs.common_default).getMax(conf.width, textDimensions.width) : (0, _chunkDD37ZF33Mjs.common_default).getMax(fromActor.width / 2 + toActor.width / 2, textDimensions.width + 2 * conf.noteMargin);
        noteModel.startx = startx + (fromActor.width + conf.actorMargin) / 2;
    } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
        noteModel.width = shouldWrap ? (0, _chunkDD37ZF33Mjs.common_default).getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : (0, _chunkDD37ZF33Mjs.common_default).getMax(fromActor.width / 2 + toActor.width / 2, textDimensions.width + 2 * conf.noteMargin);
        noteModel.startx = startx - noteModel.width + (fromActor.width - conf.actorMargin) / 2;
    } else if (msg.to === msg.from) {
        textDimensions = (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(shouldWrap ? (0, _chunkI7ZFS43CMjs.utils_default).wrapLabel(msg.message, (0, _chunkDD37ZF33Mjs.common_default).getMax(conf.width, fromActor.width), noteFont(conf)) : msg.message, noteFont(conf));
        noteModel.width = shouldWrap ? (0, _chunkDD37ZF33Mjs.common_default).getMax(conf.width, fromActor.width) : (0, _chunkDD37ZF33Mjs.common_default).getMax(fromActor.width, conf.width, textDimensions.width + 2 * conf.noteMargin);
    ...
    if (shouldWrap) noteModel.message = (0, _chunkI7ZFS43CMjs.utils_default).wrapLabel(msg.message, noteModel.width - 2 * conf.wrapPadding, noteFont(conf));
    (0, _chunkDD37ZF33Mjs.log).debug(`NM:[${noteModel.startx},${noteModel.stopx},${noteModel.starty},${noteModel.stopy}:${noteModel.width},${noteModel.height}=${msg.message}]`);
    return noteModel;
}, "buildNoteModel");
var buildMessageModel = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function(msg, actors, diagObj) {
    if (![
        diagObj.db.LINETYPE.SOLID_OPEN,
        diagObj.db.LINETYPE.DOTTED_OPEN,
        diagObj.db.LINETYPE.SOLID,
    ...
    const adjustValue = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((value)=>{
    ...
    if (msg.wrap && msg.message) msg.message = (0, _chunkI7ZFS43CMjs.utils_default).wrapLabel(msg.message, (0, _chunkDD37ZF33Mjs.common_default).getMax(boundedWidth + 2 * conf.wrapPadding, conf.width), messageFont(conf));
    const msgDims = (0, _chunkI7ZFS43CMjs.utils_default).calculateTextDimensions(msg.message, messageFont(conf));
    return {
        width: (0, _chunkDD37ZF33Mjs.common_default).getMax(msg.wrap ? 0 : msgDims.width + 2 * conf.wrapPadding, boundedWidth + 2 * conf.wrapPadding, conf.width),
        height: 0,
        startx,
        stopx,
        starty: 0,
...
var calculateLoopBounds = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async function(messages, actors, _maxWidthPerActor, diagObj) {
    const loops = {};
    const stack = [];
    let current, noteModel, msgModel;
    for (const msg of messages){
        msg.id = (0, _chunkI7ZFS43CMjs.utils_default).random({
            length: 10
        });
        switch(msg.type){
            case diagObj.db.LINETYPE.LOOP_START:
        ...
        if (isNote) {
            ...
            stack.forEach((stk)=>{
                current = stk;
                current.from = (0, _chunkDD37ZF33Mjs.common_default).getMin(current.from, noteModel.startx);
                current.to = (0, _chunkDD37ZF33Mjs.common_default).getMax(current.to, noteModel.startx + noteModel.width);
                current.width = (0, _chunkDD37ZF33Mjs.common_default).getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
            });
        } else {
            ...
            if (msgModel.startx && msgModel.stopx && stack.length > 0) stack.forEach((stk)=>{
                ...
                if (msgModel.startx === msgModel.stopx) {
                    ...
                    current.from = (0, _chunkDD37ZF33Mjs.common_default).getMin(from.x - msgModel.width / 2, from.x - from.width / 2, current.from);
                    current.to = (0, _chunkDD37ZF33Mjs.common_default).getMax(to.x + msgModel.width / 2, to.x + from.width / 2, current.to);
                    current.width = (0, _chunkDD37ZF33Mjs.common_default).getMax(current.width, Math.abs(current.to - current.from)) - conf.labelBoxWidth;
                } else {
                    current.from = (0, _chunkDD37ZF33Mjs.common_default).getMin(msgModel.startx, current.from);
                    current.to = (0, _chunkDD37ZF33Mjs.common_default).getMax(msgModel.stopx, current.to);
                    current.width = (0, _chunkDD37ZF33Mjs.common_default).getMax(current.width, msgModel.width) - conf.labelBoxWidth;
                }
            });
        }
    }
    bounds.activations = [];
    (0, _chunkDD37ZF33Mjs.log).debug("Loop type widths:", loops);
    return loops;
}, "calculateLoopBounds");
...
var diagram = {
    ...
    init: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(({ wrap })=>{
        sequenceDb_default.setWrap(wrap);
    }, "init")
};

},{"./chunk-YJGJQOYZ.mjs":"21Dvn","./chunk-XZYS6ULZ.mjs":"eQJf7","./chunk-I7ZFS43C.mjs":"huUtc","./chunk-GKOISANM.mjs":"5yZtl","./chunk-DD37ZF33.mjs":"f4pI5","./chunk-HD3LK5B5.mjs":"lpo2u","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}],"21Dvn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}],"eQJf7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./chunk-GKOISANM.mjs":"5yZtl","./chunk-DD37ZF33.mjs":"f4pI5","./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}]},["gkhAa"], null, "parcelRequire6955", {})

//# sourceMappingURL=sequenceDiagram-OCNP7Z2K.6b6aaa1e.js.map
