...
})({"1voql":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "87068cb31ef5c037";
"use strict";
...
},{}],"lP8Hz":[function(require,module,exports,__globalThis) {
...
var DEFAULT_PACKET_CONFIG = (0, _chunkDD37ZF33Mjs.defaultConfig_default).packet;
var getConfig2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
    const config = (0, _chunkI7ZFS43CMjs.cleanAndMerge)({
        ...DEFAULT_PACKET_CONFIG,
        ...(0, _chunkDD37ZF33Mjs.getConfig)().packet
    });
    if (config.showBits) config.paddingY += 10;
    return config;
}, "getConfig");
var getPacket = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>data.packet, "getPacket");
var pushWord = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((word)=>{
    if (word.length > 0) data.packet.push(word);
}, "pushWord");
...
var populate = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((ast)=>{
    (0, _chunkK2ZEYYM2Mjs.populateCommonDb)(ast, db);
    let lastByte = -1;
    let word = [];
    let row = 1;
    ...
    for (let { start, end, label } of ast.blocks){
        ...
        lastByte = end ?? start;
        (0, _chunkDD37ZF33Mjs.log).debug(`Packet block ${start} - ${lastByte} with label ${label}`);
...
var getNextFittingBlock = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((block, row, bitsPerRow)=>{
...
var parser = {
    parse: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(async (input)=>{
        const ast = await (0, _chunkM52XIDDUMjs.parse)("packet", input);
        (0, _chunkDD37ZF33Mjs.log).debug(ast);
        populate(ast);
    }, "parse")
};
// src/diagrams/packet/renderer.ts
var draw = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((_text, id, _version, diagram2)=>{
    ...
    (0, _chunkDD37ZF33Mjs.configureSvgSize)(svg, svgHeight, svgWidth, config.useMaxWidth);
    for (const [word, packet] of words.entries())drawWord(svg, packet, word, config);
    svg.append("text").text(title).attr("x", svgWidth / 2).attr("y", svgHeight - totalRowHeight / 2).attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("class", "packetTitle");
}, "draw");
var drawWord = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((svg, word, rowNumber, { rowHeight, paddingX, paddingY, bitWidth, bitsPerRow, showBits })=>{
...
var styles = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(({ packet } = {})=>{
    const options = (0, _chunkI7ZFS43CMjs.cleanAndMerge)(defaultPacketStyleOptions, packet);
    return `
	.packetByte {
...
},{"./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}]},["1voql"], null, "parcelRequire6955", {})

//# sourceMappingURL=diagram-JJFYOK3T.1ef5c037.js.map
