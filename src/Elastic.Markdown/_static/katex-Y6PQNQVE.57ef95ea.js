...
})({"flHrC":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "70ba94e057ef95ea";
"use strict";
...
},{}],"bOSfd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>katex);
...
var SourceLocation = class _SourceLocation {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "SourceLocation");
   ...
   */ static range(first, second) {
        ...
        else return new _SourceLocation(first.loc.lexer, first.loc.start, second.loc.end);
    }
};
var Token = class _Token {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Token");
...
var ParseError = class _ParseError {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "ParseError");
...
var contains = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function contains2(list, elem) {
    return list.indexOf(elem) !== -1;
}, "contains");
var deflt = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function deflt2(setting, defaultIfUndefined) {
    return setting === void 0 ? defaultIfUndefined : setting;
}, "deflt");
var uppercase = /([A-Z])/g;
var hyphenate = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function hyphenate2(str) {
...
(0, _chunkDLQEHMXDMjs.__name)(escape, "escape");
var getBaseElem = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function getBaseElem2(group) {
    if (group.type === "ordgroup") {
        if (group.body.length === 1) return getBaseElem2(group.body[0]);
        else return group;
    } else if (group.type === "color") {
        if (group.body.length === 1) return getBaseElem2(group.body[0]);
        else return group;
    } else if (group.type === "font") return getBaseElem2(group.body);
    else return group;
}, "getBaseElem");
var isCharacterBox = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function isCharacterBox2(group) {
    var baseElem = getBaseElem(group);
    return baseElem.type === "mathord" || baseElem.type === "textord" || baseElem.type === "atom";
}, "isCharacterBox");
var assert = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function assert2(value) {
    if (!value) throw new Error("Expected non-null, but got " + String(value));
    return value;
}, "assert");
var protocolFromUrl = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function protocolFromUrl2(url) {
...
var SETTINGS_SCHEMA = {
    ...
    errorColor: {
        ...
        cliProcessor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((color)=>"#" + color, "cliProcessor")
    },
    macros: {
        type: "object",
        cli: "-m, --macro <def>",
        ...
        cliDefault: [],
        cliProcessor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((def, defs)=>{
            defs.push(def);
            return defs;
        }, "cliProcessor")
    },
    minRuleThickness: {
        ...
        processor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((t)=>Math.max(0, t), "processor"),
    ...
    maxSize: {
        ...
        processor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((s)=>Math.max(0, s), "processor"),
        cli: "-s, --max-size <n>",
    ...
    maxExpand: {
        ...
        processor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((n)=>Math.max(0, n), "processor"),
        cli: "-e, --max-expand <n>",
        cliProcessor: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((n)=>n === "Infinity" ? Infinity : parseInt(n), "cliProcessor")
    },
    globalGroup: {
        type: "boolean",
        cli: false
...
(0, _chunkDLQEHMXDMjs.__name)(getDefaultValue, "getDefaultValue");
var Settings = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Settings");
    constructor(options){
...
var Style = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Style");
...
(0, _chunkDLQEHMXDMjs.__name)(scriptFromCodepoint, "scriptFromCodepoint");
var allBlocks = [];
...
(0, _chunkDLQEHMXDMjs.__name)(supportedCodepoint, "supportedCodepoint");
var hLinePad = 80;
var sqrtMain = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sqrtMain2(extraVinculum, hLinePad2) {
    return "M95," + (622 + extraVinculum + hLinePad2) + "\nc-2.7,0,-7.17,-2.7,-13.5,-8c-5.8,-5.3,-9.5,-10,-9.5,-14\nc0,-2,0.3,-3.3,1,-4c1.3,-2.7,23.83,-20.7,67.5,-54\nc44.2,-33.3,65.8,-50.3,66.5,-51c1.3,-1.3,3,-2,5,-2c4.7,0,8.7,3.3,12,10\ns173,378,173,378c0.7,0,35.3,-71,104,-213c68.7,-142,137.5,-285,206.5,-429\nc69,-144,104.5,-217.7,106.5,-221\nl" + extraVinculum / 2.075 + " -" + extraVinculum + "\nc5.3,-9.3,12,-14,20,-14\nH400000v" + (40 + extraVinculum) + "H845.2724\ns-225.272,467,-225.272,467s-235,486,-235,486c-2.7,4.7,-9,7,-19,7\nc-6,0,-10,-1,-12,-3s-194,-422,-194,-422s-65,47,-65,47z\nM" + (834 + extraVinculum) + " " + hLinePad2 + "h400000v" + (40 + extraVinculum) + "h-400000z";
}, "sqrtMain");
var sqrtSize1 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sqrtSize12(extraVinculum, hLinePad2) {
    return "M263," + (601 + extraVinculum + hLinePad2) + "c0.7,0,18,39.7,52,119\nc34,79.3,68.167,158.7,102.5,238c34.3,79.3,51.8,119.3,52.5,120\nc340,-704.7,510.7,-1060.3,512,-1067\nl" + extraVinculum / 2.084 + " -" + extraVinculum + "\nc4.7,-7.3,11,-11,19,-11\nH40000v" + (40 + extraVinculum) + "H1012.3\ns-271.3,567,-271.3,567c-38.7,80.7,-84,175,-136,283c-52,108,-89.167,185.3,-111.5,232\nc-22.3,46.7,-33.8,70.3,-34.5,71c-4.7,4.7,-12.3,7,-23,7s-12,-1,-12,-1\ns-109,-253,-109,-253c-72.7,-168,-109.3,-252,-110,-252c-10.7,8,-22,16.7,-34,26\nc-22,17.3,-33.3,26,-34,26s-26,-26,-26,-26s76,-59,76,-59s76,-60,76,-60z\nM" + (1001 + extraVinculum) + " " + hLinePad2 + "h400000v" + (40 + extraVinculum) + "h-400000z";
}, "sqrtSize1");
var sqrtSize2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sqrtSize22(extraVinculum, hLinePad2) {
    return "M983 " + (10 + extraVinculum + hLinePad2) + "\nl" + extraVinculum / 3.13 + " -" + extraVinculum + "\nc4,-6.7,10,-10,18,-10 H400000v" + (40 + extraVinculum) + "\nH1013.1s-83.4,268,-264.1,840c-180.7,572,-277,876.3,-289,913c-4.7,4.7,-12.7,7,-24,7\ns-12,0,-12,0c-1.3,-3.3,-3.7,-11.7,-7,-25c-35.3,-125.3,-106.7,-373.3,-214,-744\nc-10,12,-21,25,-33,39s-32,39,-32,39c-6,-5.3,-15,-14,-27,-26s25,-30,25,-30\nc26.7,-32.7,52,-63,76,-91s52,-60,52,-60s208,722,208,722\nc56,-175.3,126.3,-397.3,211,-666c84.7,-268.7,153.8,-488.2,207.5,-658.5\nc53.7,-170.3,84.5,-266.8,92.5,-289.5z\nM" + (1001 + extraVinculum) + " " + hLinePad2 + "h400000v" + (40 + extraVinculum) + "h-400000z";
}, "sqrtSize2");
var sqrtSize3 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sqrtSize32(extraVinculum, hLinePad2) {
    return "M424," + (2398 + extraVinculum + hLinePad2) + "\nc-1.3,-0.7,-38.5,-172,-111.5,-514c-73,-342,-109.8,-513.3,-110.5,-514\nc0,-2,-10.7,14.3,-32,49c-4.7,7.3,-9.8,15.7,-15.5,25c-5.7,9.3,-9.8,16,-12.5,20\ns-5,7,-5,7c-4,-3.3,-8.3,-7.7,-13,-13s-13,-13,-13,-13s76,-122,76,-122s77,-121,77,-121\ns209,968,209,968c0,-2,84.7,-361.7,254,-1079c169.3,-717.3,254.7,-1077.7,256,-1081\nl" + extraVinculum / 4.223 + " -" + extraVinculum + "c4,-6.7,10,-10,18,-10 H400000\nv" + (40 + extraVinculum) + "H1014.6\ns-87.3,378.7,-272.6,1166c-185.3,787.3,-279.3,1182.3,-282,1185\nc-2,6,-10,9,-24,9\nc-8,0,-12,-0.7,-12,-2z M" + (1001 + extraVinculum) + " " + hLinePad2 + "\nh400000v" + (40 + extraVinculum) + "h-400000z";
}, "sqrtSize3");
var sqrtSize4 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sqrtSize42(extraVinculum, hLinePad2) {
    return "M473," + (2713 + extraVinculum + hLinePad2) + "\nc339.3,-1799.3,509.3,-2700,510,-2702 l" + extraVinculum / 5.298 + " -" + extraVinculum + "\nc3.3,-7.3,9.3,-11,18,-11 H400000v" + (40 + extraVinculum) + "H1017.7\ns-90.5,478,-276.2,1466c-185.7,988,-279.5,1483,-281.5,1485c-2,6,-10,9,-24,9\nc-8,0,-12,-0.7,-12,-2c0,-1.3,-5.3,-32,-16,-92c-50.7,-293.3,-119.7,-693.3,-207,-1200\nc0,-1.3,-5.3,8.7,-16,30c-10.7,21.3,-21.3,42.7,-32,64s-16,33,-16,33s-26,-26,-26,-26\ns76,-153,76,-153s77,-151,77,-151c0.7,0.7,35.7,202,105,604c67.3,400.7,102,602.7,104,\n606zM" + (1001 + extraVinculum) + " " + hLinePad2 + "h400000v" + (40 + extraVinculum) + "H1017.7z";
}, "sqrtSize4");
var phasePath = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function phasePath2(y) {
    var x = y / 2;
    return "M400000 " + y + " H0 L" + x + " 0 l65 45 L145 " + (y - 80) + " H400000z";
}, "phasePath");
var sqrtTall = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sqrtTall2(extraVinculum, hLinePad2, viewBoxHeight) {
    var vertSegment = viewBoxHeight - 54 - hLinePad2 - extraVinculum;
    return "M702 " + (extraVinculum + hLinePad2) + "H400000" + (40 + extraVinculum) + "\nH742v" + vertSegment + "l-4 4-4 4c-.667.7 -2 1.5-4 2.5s-4.167 1.833-6.5 2.5-5.5 1-9.5 1\nh-12l-28-84c-16.667-52-96.667 -294.333-240-727l-212 -643 -85 170\nc-4-3.333-8.333-7.667-13 -13l-13-13l77-155 77-156c66 199.333 139 419.667\n219 661 l218 661zM702 " + hLinePad2 + "H400000v" + (40 + extraVinculum) + "H742z";
}, "sqrtTall");
var sqrtPath = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sqrtPath2(size, extraVinculum, viewBoxHeight) {
...
var innerPath = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function innerPath2(name, height) {
    switch(name){
        case "\u239C":
...
var tallDelim = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function tallDelim2(label, midHeight) {
    switch(label){
        case "lbrack":
...
var DocumentFragment = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "DocumentFragment");
    // HtmlDomNode
   ...
   * MathDomNode's only.
   */ toText() {
        var toText = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((child)=>child.toText(), "toText");
...
(0, _chunkDLQEHMXDMjs.__name)(setFontMetrics, "setFontMetrics");
...
(0, _chunkDLQEHMXDMjs.__name)(getCharacterMetrics, "getCharacterMetrics");
...
(0, _chunkDLQEHMXDMjs.__name)(getGlobalMetrics, "getGlobalMetrics");
var sizeStyleMap = [
...
var sizeAtStyle = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sizeAtStyle2(size, style) {
    return style.size < 2 ? size : sizeStyleMap[size - 1][style.size - 1];
}, "sizeAtStyle");
var Options = class _Options {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Options");
   ...
   */ havingBaseStyle(style) {
        ...
        if (this.size === wantSize && this.textSize === _Options.BASESIZE && this.style === style) return this;
        else return this.extend({
            style,
            size: wantSize
        });
   ...
   */ baseSizingClasses() {
        if (this.size !== _Options.BASESIZE) return [
            "sizing",
            "reset-size" + this.size,
            "size" + _Options.BASESIZE
        ];
        else return [];
    }
    /**
...
var validUnit = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function validUnit2(unit) {
    if (typeof unit !== "string") unit = unit.unit;
    return unit in ptPerUnit || unit in relativeUnit || unit === "ex";
}, "validUnit");
var calculateSize = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function calculateSize2(sizeValue, options) {
    var scale;
...
var makeEm = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeEm2(n) {
    return +n.toFixed(4) + "em";
}, "makeEm");
var createClass = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function createClass2(classes) {
    return classes.filter((cls)=>cls).join(" ");
}, "createClass");
var initNode = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function initNode2(classes, options, style) {
...
var toNode = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function toNode2(tagName) {
...
var toMarkup = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function toMarkup2(tagName) {
    var markup = "<" + tagName;
    if (this.classes.length) markup += ' class="' + utils.escape(createClass(this.classes)) + '"';
    var styles2 = "";
    for(var style in this.style)if (this.style.hasOwnProperty(style)) styles2 += utils.hyphenate(style) + ":" + this.style[style] + ";";
    if (styles2) markup += ' style="' + utils.escape(styles2) + '"';
...
var Span = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Span");
...
var Anchor = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Anchor");
...
var Img = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Img");
...
var SymbolNode = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "SymbolNode");
   ...
   */ toMarkup() {
        ...
        var styles2 = "";
        if (this.italic > 0) styles2 += "margin-right:" + this.italic + "em;";
        for(var style in this.style)if (this.style.hasOwnProperty(style)) styles2 += utils.hyphenate(style) + ":" + this.style[style] + ";";
        if (styles2) {
            needsSpan = true;
...
var SvgNode = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "SvgNode");
...
var PathNode = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "PathNode");
...
var LineNode = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "LineNode");
...
(0, _chunkDLQEHMXDMjs.__name)(assertSymbolDomNode, "assertSymbolDomNode");
function assertSpan(group) {
    if (group instanceof Span) return group;
    else throw new Error("Expected span<HtmlDomNode> but got " + String(group) + ".");
}
(0, _chunkDLQEHMXDMjs.__name)(assertSpan, "assertSpan");
var ATOMS = {
    "bin": 1,
    "close": 1,
    "inner": 1,
...
(0, _chunkDLQEHMXDMjs.__name)(defineSymbol, "defineSymbol");
var math = "math";
var text = "text";
var main = "main";
var ams = "ams";
...
var wideCharacterFont = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function wideCharacterFont2(wideChar2, mode) {
    ...
    } else if (codePoint === 120485 || codePoint === 120486) return [
    ...
    else throw new ParseError("Unsupported character: " + wideChar2);
}, "wideCharacterFont");
var lookupSymbol = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function lookupSymbol2(value, fontName, mode) {
...
var makeSymbol = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeSymbol2(value, fontName, mode, options, classes) {
...
var mathsym = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function mathsym2(value, mode, options, classes) {
...
var boldsymbol = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function boldsymbol2(value, mode, options, classes, type) {
...
var makeOrd = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeOrd2(group, options, type) {
    var mode = group.mode;
    ...
    var wideFontName = "";
    var wideFontClass = "";
    if (text2.charCodeAt(0) === 55349) [wideFontName, wideFontClass] = wideCharacterFont(text2, mode);
    if (wideFontName.length > 0) return makeSymbol(text2, wideFontName, mode, options, classes.concat(wideFontClass));
        ...
        if (lookupSymbol(text2, fontName, mode).metrics) return makeSymbol(text2, fontName, mode, options, classes.concat(fontClasses));
        else if (ligatures.hasOwnProperty(text2) && fontName.slice(0, 10) === "Typewriter") {
            var parts = [];
            for(var i = 0; i < text2.length; i++)parts.push(makeSymbol(text2[i], fontName, mode, options, classes.concat(fontClasses)));
            return makeFragment(parts);
        }
    }
    if (type === "mathord") return makeSymbol(text2, "Math-Italic", mode, options, classes.concat([
        "mathnormal"
    ]));
...
var canCombine = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((prev, next)=>{
...
var tryCombineChars = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((chars)=>{
...
var sizeElementFromChildren = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sizeElementFromChildren2(elem) {
    var height = 0;
    var depth = 0;
    var maxFontSize = 0;
...
var makeSpan$2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeSpan(classes, children, options, style) {
    var span = new Span(classes, children, options, style);
    sizeElementFromChildren(span);
    return span;
}, "makeSpan");
var makeSvgSpan = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((classes, children, options, style)=>new Span(classes, children, options, style), "makeSvgSpan");
var makeLineSpan = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeLineSpan2(className, options, thickness) {
    var line = makeSpan$2([
        className
    ], [], options);
...
var makeAnchor = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeAnchor2(href, classes, children, options) {
    var anchor = new Anchor(href, classes, children, options);
    sizeElementFromChildren(anchor);
    return anchor;
}, "makeAnchor");
var makeFragment = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeFragment2(children) {
    var fragment = new DocumentFragment(children);
    sizeElementFromChildren(fragment);
    return fragment;
}, "makeFragment");
var wrapFragment = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function wrapFragment2(group, options) {
    if (group instanceof DocumentFragment) return makeSpan$2([], [
        group
    ], options);
    return group;
}, "wrapFragment");
var getVListChildrenAndDepth = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function getVListChildrenAndDepth2(params) {
...
var makeVList = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeVList2(params, options) {
...
var makeGlue = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((measurement, options)=>{
    var rule = makeSpan$2([
        "mspace"
    ], [], options);
...
var retrieveTextFontName = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function retrieveTextFontName2(fontFamily, fontWeight, fontShape) {
    var baseFontName = "";
    switch(fontFamily){
        case "amsrm":
            baseFontName = "AMS";
...
var staticSvg = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function staticSvg2(value, options) {
...
function defineFunction(_ref) {
    var { type, names, props, handler, htmlBuilder: htmlBuilder3, mathmlBuilder: mathmlBuilder3 } = _ref;
    var data = {
        type,
    ...
    if (type) {
        if (htmlBuilder3) _htmlGroupBuilders[type] = htmlBuilder3;
        if (mathmlBuilder3) _mathmlGroupBuilders[type] = mathmlBuilder3;
    }
}
(0, _chunkDLQEHMXDMjs.__name)(defineFunction, "defineFunction");
function defineFunctionBuilders(_ref2) {
    var { type, htmlBuilder: htmlBuilder3, mathmlBuilder: mathmlBuilder3 } = _ref2;
    defineFunction({
        type,
        names: [],
        props: {
...
(0, _chunkDLQEHMXDMjs.__name)(defineFunctionBuilders, "defineFunctionBuilders");
var normalizeArgument = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function normalizeArgument2(arg) {
    return arg.type === "ordgroup" && arg.body.length === 1 ? arg.body[0] : arg;
}, "normalizeArgument");
var ordargument = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function ordargument2(arg) {
...
var buildExpression$1 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function buildExpression(expression, options, isRealGroup, surrounding) {
    ...
    traverseNonSpaceNodes(groups, (node2, prev)=>{
        ...
        else if (type === "mbin" && utils.contains(binLeftCanceller, prevType)) node2.classes[0] = "mord";
    }, {
        node: dummyPrev
    }, dummyNext, isRoot);
    traverseNonSpaceNodes(groups, (node2, prev)=>{
...
var traverseNonSpaceNodes = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function traverseNonSpaceNodes2(nodes, callback, prev, next, isRoot) {
...
var checkPartialGroup = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function checkPartialGroup2(node) {
    if (node instanceof DocumentFragment || node instanceof Anchor || node instanceof Span && node.hasClass("enclosing")) return node;
    return null;
}, "checkPartialGroup");
var getOutermostNode = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function getOutermostNode2(node, side) {
    var partialGroup = checkPartialGroup(node);
    if (partialGroup) {
        var children = partialGroup.children;
        if (children.length) {
            if (side === "right") return getOutermostNode2(children[children.length - 1], "right");
            else if (side === "left") return getOutermostNode2(children[0], "left");
        }
    }
    return node;
}, "getOutermostNode");
var getTypeOfDomTree = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function getTypeOfDomTree2(node, side) {
    if (!node) return null;
    if (side) node = getOutermostNode(node, side);
    return DomEnum[node.classes[0]] || null;
}, "getTypeOfDomTree");
var makeNullDelimiter = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeNullDelimiter2(options, classes) {
    var moreClasses = [
        "nulldelimiter"
    ].concat(options.baseSizingClasses());
    return makeSpan$1(classes.concat(moreClasses));
}, "makeNullDelimiter");
var buildGroup$1 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function buildGroup(group, options, baseOptions) {
...
(0, _chunkDLQEHMXDMjs.__name)(buildHTMLUnbreakable, "buildHTMLUnbreakable");
...
(0, _chunkDLQEHMXDMjs.__name)(buildHTML, "buildHTML");
function newDocumentFragment(children) {
    return new DocumentFragment(children);
}
(0, _chunkDLQEHMXDMjs.__name)(newDocumentFragment, "newDocumentFragment");
var MathNode = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "MathNode");
...
var TextNode = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "TextNode");
    constructor(text2){
        this.text = void 0;
        this.text = text2;
    }
...
var SpaceNode = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "SpaceNode");
    /**
...
var makeText = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeText2(text2, mode, options) {
    if (symbols[mode][text2] && symbols[mode][text2].replace && text2.charCodeAt(0) !== 55349 && !(ligatures.hasOwnProperty(text2) && options && (options.fontFamily && options.fontFamily.slice(4, 6) === "tt" || options.font && options.font.slice(4, 6) === "tt"))) text2 = symbols[mode][text2].replace;
    return new mathMLTree.TextNode(text2);
}, "makeText");
var makeRow = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeRow2(body) {
    if (body.length === 1) return body[0];
    else return new mathMLTree.MathNode("mrow", body);
}, "makeRow");
var getVariant = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function getVariant2(group, options) {
    ...
    if (symbols[mode][text2] && symbols[mode][text2].replace) text2 = symbols[mode][text2].replace;
    var fontName = buildCommon.fontMap[font].fontName;
    if (getCharacterMetrics(text2, fontName, mode)) return buildCommon.fontMap[font].variant;
    return null;
}, "getVariant");
var buildExpression2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function buildExpression3(expression, options, isOrdgroup) {
    if (expression.length === 1) {
...
var buildExpressionRow = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function buildExpressionRow2(expression, options, isOrdgroup) {
    return makeRow(buildExpression2(expression, options, isOrdgroup));
}, "buildExpressionRow");
var buildGroup2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function buildGroup3(group, options) {
...
function buildMathML(tree, texExpression, options, isDisplayMode, forMathmlOnly) {
    ...
    var math2 = new mathMLTree.MathNode("math", [
        semantics
    ]);
    math2.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML");
    if (isDisplayMode) math2.setAttribute("display", "block");
...
(0, _chunkDLQEHMXDMjs.__name)(buildMathML, "buildMathML");
var optionsFromSettings = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function optionsFromSettings2(settings) {
    return new Options({
...
var displayWrap = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function displayWrap2(node, settings) {
...
var buildTree = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function buildTree2(tree, expression, settings) {
...
var buildHTMLTree = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function buildHTMLTree2(tree, expression, settings) {
    var options = optionsFromSettings(settings);
    var htmlNode = buildHTML(tree, options);
...
var mathMLnode = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function mathMLnode2(label) {
...
var groupLength = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function groupLength2(arg) {
    if (arg.type === "ordgroup") return arg.body.length;
    else return 1;
}, "groupLength");
var svgSpan = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function svgSpan2(group, options) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(buildSvgSpan_, "buildSvgSpan_");
...
var encloseSpan = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function encloseSpan2(inner2, label, topPad, bottomPad, options) {
    var img;
...
(0, _chunkDLQEHMXDMjs.__name)(assertNodeType, "assertNodeType");
...
(0, _chunkDLQEHMXDMjs.__name)(assertSymbolNodeType, "assertSymbolNodeType");
function checkSymbolNodeType(node) {
    if (node && (node.type === "atom" || NON_ATOMS.hasOwnProperty(node.type))) return node;
    return null;
}
(0, _chunkDLQEHMXDMjs.__name)(checkSymbolNodeType, "checkSymbolNodeType");
var htmlBuilder$a = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((grp, options)=>{
    var base;
    var group;
    var supSubGroup;
    ...
    if (!group.isStretchy) {
        ...
        if (group.label === "\\vec") {
            ...
            accent2.italic = 0;
            width = accent2.width;
            if (accentBelow) clearance += accent2.depth;
        }
...
var mathmlBuilder$9 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    ...
    var node = new mathMLTree.MathNode("mover", [
        buildGroup2(group.base, options),
        accentNode
    ]);
...
defineFunction({
    ...
    handler: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((context, args)=>{
...
defineFunction({
    ...
    handler: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((_ref, args)=>{
    ...
    htmlBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    ...
    mathmlBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
...
var paddedNode = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group)=>{
...
defineFunction({
    ...
    htmlBuilder (group, options) {
        ...
        if (upperGroup.depth > 0.25 || group.label === "\\xleftequilibrium") upperShift -= upperGroup.depth;
        var vlist;
        if (lowerGroup) {
...
(0, _chunkDLQEHMXDMjs.__name)(htmlBuilder$9, "htmlBuilder$9");
function mathmlBuilder$8(group, options) {
    var node;
    var inner2 = buildExpression2(group.body, options);
    if (group.mclass === "minner") node = new mathMLTree.MathNode("mpadded", inner2);
    else if (group.mclass === "mord") {
        if (group.isCharacterBox) {
            node = inner2[0];
            node.type = "mi";
        } else node = new mathMLTree.MathNode("mi", inner2);
    } else {
        if (group.isCharacterBox) {
            node = inner2[0];
            node.type = "mo";
        } else node = new mathMLTree.MathNode("mo", inner2);
...
(0, _chunkDLQEHMXDMjs.__name)(mathmlBuilder$8, "mathmlBuilder$8");
defineFunction({
    type: "mclass",
    names: [
        "\\mathord",
...
var binrelClass = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((arg)=>{
...
var newCell = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
    return {
        type: "styling",
        body: [],
        mode: "math",
...
var isStartOfArrow = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((node)=>{
    return node.type === "textord" && node.text === "@";
}, "isStartOfArrow");
var isLabelEnd = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((node, endChar)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(cdArrow, "cdArrow");
...
(0, _chunkDLQEHMXDMjs.__name)(parseCD, "parseCD");
defineFunction({
    type: "cdlabel",
    names: [
        "\\\\cdleft",
    ...
    mathmlBuilder (group, options) {
        var label = new mathMLTree.MathNode("mrow", [
            buildGroup2(group.label, options)
        ]);
...
defineFunction({
    ...
    mathmlBuilder (group, options) {
        return new mathMLTree.MathNode("mrow", [
            buildGroup2(group.fragment, options)
        ]);
    }
});
defineFunction({
    ...
    handler (_ref, args) {
        ...
        else if (code <= 65535) text2 = String.fromCharCode(code);
        else {
            code -= 65536;
...
var htmlBuilder$8 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    var elements = buildExpression$1(group.body, options.withColor(group.color), false);
    return buildCommon.makeFragment(elements);
}, "htmlBuilder$8");
var mathmlBuilder$7 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
...
var checkControlSequence = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((tok)=>{
    var name = tok.text;
    if (/^(?:[\\{}$&#^_]|EOF)$/.test(name)) throw new ParseError("Expected a control sequence", tok);
    return name;
}, "checkControlSequence");
var getRHS = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((parser)=>{
...
var letCommand = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((parser, name, tok, global)=>{
...
defineFunction({
    ...
    handler (_ref2) {
        ...
        while(parser.gullet.future().text !== "{"){
            ...
            else delimiters2[numArgs].push(tok.text);
        }
...
var getMetrics = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function getMetrics2(symbol, font, mode) {
    var replace = symbols.math[symbol] && symbols.math[symbol].replace;
    var metrics = getCharacterMetrics(replace || symbol, font, mode);
    if (!metrics) throw new Error("Unsupported symbol " + symbol + " and font size " + font + ".");
    return metrics;
}, "getMetrics");
var styleWrap = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function styleWrap2(delim, toStyle, options, classes) {
...
var centerSpan = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function centerSpan2(span, options, style) {
...
var makeSmallDelim = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeSmallDelim2(delim, style, center, options, mode, classes) {
...
var mathrmSize = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function mathrmSize2(value, size, mode, options) {
    return buildCommon.makeSymbol(value, "Size" + size + "-Regular", mode, options);
}, "mathrmSize");
var makeLargeDelim = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeLargeDelim2(delim, size, center, options, mode, classes) {
...
var makeGlyphSpan = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeGlyphSpan2(symbol, font, mode) {
    var sizeClass;
...
var makeInner = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeInner2(ch, height, options) {
...
var makeStackedDelim = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeStackedDelim2(delim, heightTotal, center, options, mode, classes) {
    var top;
    var middle;
    var repeat;
    var bottom;
...
var vbPad = 80;
var emPad = 0.08;
var sqrtSvg = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sqrtSvg2(sqrtName, height, viewBoxHeight, extraVinculum, options) {
...
var makeSqrtImage = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeSqrtImage2(height, options) {
...
var makeSizedDelim = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeSizedDelim2(delim, size, options, mode, classes) {
...
var delimTypeToFont = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function delimTypeToFont2(type) {
...
var traverseSequence = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function traverseSequence2(delim, height, sequence, options) {
...
var makeCustomSizedDelim = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeCustomSizedDelim2(delim, height, center, options, mode, classes) {
    if (delim === "<" || delim === "\\lt" || delim === "\u27E8") delim = "\\langle";
    else if (delim === ">" || delim === "\\gt" || delim === "\u27E9") delim = "\\rangle";
    var sequence;
...
var makeLeftRightDelim = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function makeLeftRightDelim2(delim, height, depth, options, mode, classes) {
...
(0, _chunkDLQEHMXDMjs.__name)(checkDelimiter, "checkDelimiter");
defineFunction({
    type: "delimsizing",
    names: [
        "\\bigl",
    ...
    htmlBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
        if (group.delim === ".") return buildCommon.makeSpan([
            group.mclass
        ]);
    ...
    mathmlBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group)=>{
        var children = [];
...
(0, _chunkDLQEHMXDMjs.__name)(assertParsed, "assertParsed");
defineFunction({
...
defineFunction({
    ...
    htmlBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
        ...
        var innerDepth = 0;
        var hadMiddle = false;
        for(var i = 0; i < inner2.length; i++)if (inner2[i].isMiddle) hadMiddle = true;
        else {
        ...
        var leftDelim;
        if (group.left === ".") leftDelim = makeNullDelimiter(options, [
            "mopen"
        ]);
        else leftDelim = delimiter.leftRightDelim(group.left, innerHeight, innerDepth, options, group.mode, [
            "mopen"
        ]);
        inner2.unshift(leftDelim);
        if (hadMiddle) for(var _i = 1; _i < inner2.length; _i++){
            var middleDelim = inner2[_i];
            var isMiddle = middleDelim.isMiddle;
            if (isMiddle) inner2[_i] = delimiter.leftRightDelim(isMiddle.delim, innerHeight, innerDepth, isMiddle.options, group.mode, []);
        }
        var rightDelim;
...
var htmlBuilder$7 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    ...
    if (label === "sout") {
        ...
        if (/cancel/.test(label)) {
            if (!isSingleChar) inner2.classes.push("cancel-pad");
        } else if (label === "angl") inner2.classes.push("anglpad");
        else inner2.classes.push("boxpad");
        var topPad = 0;
        var bottomPad = 0;
        var ruleThickness = 0;
        if (/box/.test(label)) {
    ...
    if (/cancel/.test(label) && !isSingleChar) return buildCommon.makeSpan([
        "mord",
        "cancel-lap"
    ], [
        vlist
...
var mathmlBuilder$6 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    var fboxsep = 0;
    var node = new mathMLTree.MathNode(group.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [
        buildGroup2(group.body, options)
    ]);
    switch(group.label){
        case "\\cancel":
...
(0, _chunkDLQEHMXDMjs.__name)(defineEnvironment, "defineEnvironment");
var _macros = {};
function defineMacro(name, body) {
    _macros[name] = body;
}
(0, _chunkDLQEHMXDMjs.__name)(defineMacro, "defineMacro");
...
(0, _chunkDLQEHMXDMjs.__name)(getHLines, "getHLines");
var validateAmsEnvironmentContext = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((context)=>{
...
(0, _chunkDLQEHMXDMjs.__name)(getAutoTag, "getAutoTag");
function parseArray(parser, _ref, style) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(beginRow, "beginRow");
    function endRow() {
        if (tags) {
    ...
    (0, _chunkDLQEHMXDMjs.__name)(endRow, "endRow");
    beginRow();
...
(0, _chunkDLQEHMXDMjs.__name)(parseArray, "parseArray");
function dCellStyle(envName) {
    if (envName.slice(0, 1) === "d") return "display";
    else return "text";
}
(0, _chunkDLQEHMXDMjs.__name)(dCellStyle, "dCellStyle");
var htmlBuilder$6 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function htmlBuilder(group, options) {
    var r;
    var c;
    ...
    (0, _chunkDLQEHMXDMjs.__name)(setHLinePos, "setHLinePos");
    ...
    var colDescrNum;
    var tagSpans = [];
    if (group.tags && group.tags.some((tag2)=>tag2)) for(r = 0; r < nr; ++r){
        var rw = body[r];
        var shift = rw.pos - offset;
        var tag = group.tags[r];
        var tagSpan = void 0;
        if (tag === true) tagSpan = buildCommon.makeSpan([
            "eqn-num"
        ], [], options);
...
var mathmlBuilder$5 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function mathmlBuilder(group, options) {
    var tbl = [];
    ...
    if (group.colSeparationType === "align") {
        ...
        var spacing2 = "";
        for(var _i2 = 1; _i2 < _cols.length; _i2++)spacing2 += _i2 % 2 ? "0em " : "1em ";
...
var alignedHandler = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function alignedHandler2(context, args) {
...
var htmlBuilder$5 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    var font = group.font;
    var newOptions = options.withFont(font);
    return buildGroup$1(group.body, newOptions);
}, "htmlBuilder$5");
var mathmlBuilder$4 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    var font = group.font;
    var newOptions = options.withFont(font);
...
defineFunction({
    ...
    handler: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((_ref2, args)=>{
        var { parser } = _ref2;
        var body = args[0];
...
defineFunction({
    ...
    handler: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((_ref3, args)=>{
...
var adjustStyle = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((size, originalStyle)=>{
...
var htmlBuilder$4 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
...
var mathmlBuilder$3 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    var node = new mathMLTree.MathNode("mfrac", [
        buildGroup2(group.numer, options),
        buildGroup2(group.denom, options)
    ]);
...
var delimFromValue = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function delimFromValue2(delimString) {
    var delim = null;
...
defineFunction({
    ...
    handler: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((_ref6, args)=>{
...
var htmlBuilder$3 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((grp, options)=>{
    var style = options.style;
    var supSubGroup;
    var group;
    if (grp.type === "supsub") {
...
var mathmlBuilder$2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    var accentNode = stretchy.mathMLnode(group.label);
...
defineFunction({
    ...
    mathmlBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
        ...
        if (!(math2 instanceof MathNode)) math2 = new MathNode("mrow", [
            math2
        ]);
...
var sizeData = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function sizeData2(str) {
...
defineFunction({
    ...
    handler: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((_ref, args, optArgs)=>{
        var { parser } = _ref;
        var width = {
            number: 0,
            unit: "em"
...
defineFunction({
    ...
    htmlBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
        ...
        } else inner2 = buildCommon.makeSpan([
            "inner"
        ], [
            buildGroup$1(group.body, options)
        ]);
...
var chooseMathStyle = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
...
var assembleSupSub = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((base, supGroup, subGroup, options, style, slant, baseShift)=>{
...
var htmlBuilder$2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((grp, options)=>{
    var supGroup;
    var subGroup;
    var hasLimits = false;
    var group;
    ...
    var style = options.style;
    var large = false;
    if (style.size === Style$1.DISPLAY.size && group.symbol && !utils.contains(noSuccessor, group.name)) large = true;
    var base;
    if (group.symbol) {
...
var mathmlBuilder$1 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    var node;
    if (group.symbol) {
    ...
    } else if (group.body) node = new MathNode("mo", buildExpression2(group.body, options));
    else {
...
var htmlBuilder$1 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((grp, options)=>{
    var supGroup;
    var subGroup;
    var hasLimits = false;
    var group;
...
var mathmlBuilder2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
...
defineFunction({
    ...
    htmlBuilder: /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
        var inner2 = buildCommon.makeSpan([
            "inner"
        ], [
            buildGroup$1(group.body, options.withPhantom())
        ]);
...
function sizingGroup(value, options, baseOptions) {
    ...
    for(var i = 0; i < inner2.length; i++){
        ...
        if (pos < 0) Array.prototype.push.apply(inner2[i].classes, options.sizingClasses(baseOptions));
        else if (inner2[i].classes[pos + 1] === "reset-size" + options.size) inner2[i].classes[pos + 1] = "reset-size" + baseOptions.size;
        inner2[i].height *= multiplier;
        inner2[i].depth *= multiplier;
    }
    return buildCommon.makeFragment(inner2);
}
(0, _chunkDLQEHMXDMjs.__name)(sizingGroup, "sizingGroup");
var sizeFuncs = [
    "\\tiny",
    "\\sixptsize",
    "\\scriptsize",
...
var htmlBuilder2 = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
...
defineFunction({
    ...
    htmlBuilder (group, options) {
        ...
        if (inner2.height === 0) inner2.height = options.fontMetrics().xHeight;
        ...
        if (delimDepth > inner2.height + inner2.depth + lineClearance) lineClearance = (lineClearance + delimDepth - inner2.height - inner2.depth) / 2;
    ...
    mathmlBuilder (group, options) {
        ...
        return index ? new mathMLTree.MathNode("mroot", [
            buildGroup2(body, options),
            buildGroup2(index, options)
...
var htmlBuilderDelegate = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function htmlBuilderDelegate2(group, options) {
    var base = group.base;
    if (!base) return null;
...
defineFunctionBuilders({
    ...
    htmlBuilder (group, options) {
        ...
        if (valueSup) {
            ...
            if (!isCharacterBox3) supShift = base.height - newOptions.fontMetrics().supDrop * newOptions.sizeMultiplier / options.sizeMultiplier;
        }
        if (valueSub) {
            var _newOptions = options.havingStyle(options.style.sub());
            subm = buildGroup$1(valueSub, _newOptions, options);
            if (!isCharacterBox3) subShift = base.depth + _newOptions.fontMetrics().subDrop * _newOptions.sizeMultiplier / options.sizeMultiplier;
        }
        var minSupShift;
    ...
    mathmlBuilder (group, options) {
        ...
        if (group.sub) children.push(buildGroup2(group.sub, options));
        if (group.sup) children.push(buildGroup2(group.sup, options));
        var nodeType;
...
defineFunctionBuilders({
    ...
    htmlBuilder (group, options) {
        ...
        } else if (cssSpace.hasOwnProperty(group.text)) return buildCommon.makeSpan([
            "mspace",
            cssSpace[group.text]
        ], [], options);
...
var pad = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(()=>{
...
var optionsWithFont = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group, options)=>{
    var font = group.font;
...
var makeVerb = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((group)=>group.body.replace(/ /g, group.star ? "\u2423" : "\xA0"), "makeVerb");
...
var Namespace = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "Namespace");
    /**
...
var newcommand = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((context, existsOK, nonexistsOK)=>{
...
var braketHelper = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((one)=>(context)=>{
        ...
        var midMacro = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)((double)=>(context2)=>{
                if (one) {
                    context2.macros.set("|", oldMiddle);
                    if (middleDouble.length) context2.macros.set("\\|", oldMiddleDouble);
                }
                var doubled = double;
...
var MacroExpander = class {
    static #_ = (0, _chunkDLQEHMXDMjs.__name)(this, "MacroExpander");
   ...
   */ consumeArgs(numArgs, delimiters2) {
        if (delimiters2) {
            if (delimiters2.length !== numArgs + 1) throw new ParseError("The length of delimiters doesn't match the number of args!");
        ...
        var args = [];
        for(var _i = 0; _i < numArgs; _i++)args.push(this.consumeArg(delimiters2 && delimiters2[_i + 1]).tokens);
        return args;
    }
    /**
...
var Parser = class _Parser {
   ...
   */ expect(text2, consume) {
        ...
        if (this.fetch().text !== text2) throw new ParseError("Expected '" + text2 + "', got '" + this.fetch().text + "'", this.fetch());
   ...
   */ parseExpression(breakOnInfix, breakOnTokenText) {
        ...
        while(true){
            ...
            var lex = this.fetch();
            if (_Parser.endOfExpression.indexOf(lex.text) !== -1) break;
   ...
   */ parseGroup(name, breakOnTokenText) {
        ...
        if (text2 === "{" || text2 === "\\begingroup") {
            ...
            if (result == null && text2[0] === "\\" && !implicitCommands.hasOwnProperty(text2)) {
                if (this.settings.throwOnError) throw new ParseError("Undefined control sequence: " + text2, firstToken);
   ...
   */ parseSymbol() {
        ...
        if (unicodeSymbols.hasOwnProperty(text2[0]) && !symbols[this.mode][text2[0]]) {
            if (this.settings.strict && this.mode === "math") this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + text2[0] + '" used in math mode', nucleus);
        ...
        if (match) {
            ...
            if (text2 === "i") text2 = "\u0131";
            else if (text2 === "j") text2 = "\u0237";
        }
        var symbol;
        if (symbols[this.mode][text2]) {
            if (this.settings.strict && this.mode === "math" && extraLatin.indexOf(text2) >= 0) this.settings.reportNonstrict("unicodeTextInMathMode", 'Latin-1/Unicode text character "' + text2[0] + '" used in math mode', nucleus);
            ...
            if (this.settings.strict) {
                if (!supportedCodepoint(text2.charCodeAt(0))) this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + text2[0] + '"' + (" (" + text2.charCodeAt(0) + ")"), nucleus);
                else if (this.mode === "math") this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + text2[0] + '" used in math mode', nucleus);
            }
            symbol = {
                type: "textord",
                mode: "text",
        ...
        if (match) for(var i = 0; i < match[0].length; i++){
            ...
            if (!unicodeAccents[accent2]) throw new ParseError("Unknown accent ' " + accent2 + "'", nucleus);
            var command = unicodeAccents[accent2][this.mode] || unicodeAccents[accent2].text;
            if (!command) throw new ParseError("Accent " + accent2 + " unsupported in " + this.mode + " mode", nucleus);
            symbol = {
                type: "accent",
                mode: this.mode,
                loc: SourceLocation.range(nucleus),
...
var parseTree = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function parseTree2(toParse, settings) {
...
var render = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function render2(expression, baseNode, options) {
...
if (typeof document !== "undefined") {
    if (document.compatMode !== "CSS1Compat") {
        ...
        render = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function render3() {
            throw new ParseError("KaTeX doesn't work in quirks mode.");
        }, "render");
    }
}
var renderToString = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function renderToString2(expression, options) {
    var markup = renderToDomTree(expression, options).toMarkup();
    return markup;
}, "renderToString");
var generateParseTree = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function generateParseTree2(expression, options) {
    var settings = new Settings(options);
    return parseTree(expression, settings);
}, "generateParseTree");
var renderError = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function renderError2(error, expression, options) {
...
var renderToDomTree = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function renderToDomTree2(expression, options) {
    var settings = new Settings(options);
    try {
...
var renderToHTMLTree = /* @__PURE__ */ (0, _chunkDLQEHMXDMjs.__name)(function renderToHTMLTree2(expression, options) {
    var settings = new Settings(options);
    try {
        var tree = parseTree(expression, settings);
...
},{"./chunk-DLQEHMXD.mjs":"h5YRf","@parcel/transformer-js/src/esmodule-helpers.js":"1cdyk"}]},["flHrC"], null, "parcelRequire6955", {})

//# sourceMappingURL=katex-Y6PQNQVE.57ef95ea.js.map
