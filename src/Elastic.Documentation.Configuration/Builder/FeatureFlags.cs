...
{
	private readonly Dictionary<string, bool> _featureFlags = new(initFeatureFlags, StringComparer.OrdinalIgnoreCase);
	...
	public bool NavV2Enabled
	{
		get => IsEnabled("nav-v2");
		set => _featureFlags["nav-v2"] = value;
	}
