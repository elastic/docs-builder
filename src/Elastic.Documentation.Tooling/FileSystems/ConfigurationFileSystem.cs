...
/// </summary>
public class ConfigurationFileSystem(IFileSystem? inner = null) : ScopedFileSystem(
	...
	new ScopedFileSystemOptions([System.IO.Path.Join(Paths.WorkingDirectoryRoot.FullName, "config"), Paths.ApplicationData.FullName])
	{
