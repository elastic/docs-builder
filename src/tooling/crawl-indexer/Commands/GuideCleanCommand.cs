...
/// <summary>
/// Clean up old guide indices and related resources from Elasticsearch.
/// </summary>
public class GuideCleanCommand(
	ILoggerFactory loggerFactory,
	IConfigurationContext configurationContext
)
{
	private static readonly string[] GuideIndexPrefixes = ["docs-"];

	/// <summary>
	/// Remove old guide indices, keeping the most recent ones.
	/// </summary>
	...
	{
		SpectreConsoleTheme.WriteHeader("guide clean");
		...
		var prefixes = GuideIndexPrefixes
			.SelectMany(p => new[]
			{
