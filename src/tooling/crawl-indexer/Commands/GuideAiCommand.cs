...
/// <summary>
/// Run AI enrichment on existing guide indices without re-crawling.
/// </summary>
public class GuideAiCommand(
...
{
	/// <summary>
	/// Run AI enrichment against the current guide semantic index.
	/// </summary>
	...
	{
		SpectreConsoleTheme.WriteHeader("guide ai");
