...
/// <summary>
/// Utility class for parsing bundle input format: "bundle-file-path|repo|link-visibility"
...
public static class BundleInputParser
{
	...
	/// Format: "bundle-file-path|repo|link-visibility" (only bundle-file-path is required)
	/// Uses pipe (|) as delimiter since ConsoleAppFramework auto-splits string[] by comma.
	...
	/// Each input is in format: "bundle-file-path|repo|link-visibility" (only bundle-file-path is required)
	/// Uses pipe (|) as delimiter since ConsoleAppFramework auto-splits string[] by comma.
