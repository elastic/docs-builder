...
public static class CurlSourceFormatter
{
	...
	private static bool IsMethodFlag(string flag) =>
		flag is "-X" or "--request";

	private static bool IsUrlFlag(string flag) =>
		flag is "--url";

	private static bool IsDataFlag(string flag) =>
		flag is "-d" or "--data" or "--data-raw" or "--data-binary" or "--data-urlencode";
