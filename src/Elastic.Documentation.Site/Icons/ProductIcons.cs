...
public static class ProductIcons
{
	private static readonly FrozenDictionary<string, string> Icons = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
	{
		...
		["vectordb"] =
			"""
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true">
				<path fill="#02BCB7" d="M16.8755 9.95931C19.4802 5.08956 25.5395 3.25332 30.4092 5.85821L21.5464 22.4271C21.4158 22.0707 21.2569 21.7195 21.0679 21.3768L15.8379 11.8978L16.8755 9.95931Z"/>
				<path fill="#FEC514" d="M4.08447 6.12205C6.50225 4.7881 9.5439 5.6667 10.8779 8.08445L14.4317 14.5259L10.0913 22.6416C9.25645 24.2024 9.3346 26.0073 10.1392 27.4453C10.1336 27.4353 10.1276 27.4256 10.1221 27.4155L2.12206 12.9155C0.788096 10.4977 1.66669 7.45605 4.08447 6.12205Z"/>
				<path fill="#1C1E23" d="M18.8783 22.5844C20.2035 24.9865 19.3442 28.0032 16.9623 29.3506C16.9354 29.3658 16.9084 29.3808 16.8812 29.3955C16.7071 29.4898 16.5296 29.5717 16.35 29.6435C15.7257 29.8918 15.0543 30.0143 14.3763 29.998C12.6721 29.9542 11.0357 29.04 10.142 27.4492C9.33529 26.0105 9.25604 24.2039 10.0917 22.6416L14.432 14.5259L18.8783 22.5844Z"/>
			</svg>
			"""
